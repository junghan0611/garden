...
description: "Denote를 지식베이스 프로토콜로 재해석하며, 인간과 에이전트가 함께 읽고 쓰는 공존 인터페이스를 정의한다."
