...
-   <span class="timestamp-wrapper"><span class="timestamp">[2026-03-16 Mon 14:49]</span></span> @junghan — 이거 정책을 더 1층 3층과 연계하여 보자. [§agent-config 기억의 연장: 에이전트 시맨틱 메모리 표준화 구성 #임베딩]({{< relref "/botlog/20260312T174622.md" >}}), [§dictcli 태그-정규화와-개인-어휘-사전-영어-태그 #단어 #개념]({{< relref "/botlog/20260309T194058.md" >}}) 이 기록들과 연결해서 말이다. 여긴 2층이다.
