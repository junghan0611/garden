...
description: "NEXT.md를 다음 세션이 즉시 이어받게 만드는 패턴 묶음 — 검증 기준 내장 + NOW/RECENT/LEDGER 3층 + 프로젝트 유형별 스타일(단독 repo vs 메타리포 포트폴리오) + 브랜치 별동대용 NEXT--<branch>.md + NEXT를 버리지 않고 repo에 문서화하는 AGENTS/README/CHANGELOG/ROADMAP 4문서와 tag-release 의식. beads를 버리고 하네스 TODO를 끈 뒤 남긴 최소 공통 표면."
