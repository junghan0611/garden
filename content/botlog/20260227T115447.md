---
title: "에이전트-어젠다-reverse-datetree-멀티디바이스-설계 에이전트-어젠다"
date: 2026-02-27T11:54:00+09:00
lastmod: 2026-02-27T11:54:00+09:00
tags: ["agent", "bib", "botlog", "denote", "orchestration", "thinkpad", "agenda"]
draft: false
---
...
- [히스토리](#히스토리)
- [에이전트 어젠다 — reverse datetree 멀티디바이스 설계](#에이전트-어젠다-reverse-datetree-멀티디바이스-설계)
- [2026](#2026)
...
-   <span class="timestamp-wrapper"><span class="timestamp">[2026-02-27 Fri 14:30]</span></span> emacsclient 접근법 + xenodium emacs-skills 연결 추가
-   <span class="timestamp-wrapper"><span class="timestamp">[2026-02-27 Fri 11:54]</span></span> 생성 (“Akirak/Org-Reverse-Datetree” 2026) 이거 넣는다.
...
[봇-활동-기록-아키텍처와-힣노트-역사성-고찰]({{< relref "/botlog/20260224T164035.md" >}})에서 멀티에이전트 쓰기 문제를 다뤘다. 거기서 "파일 분리 + 쓰기 규약"이 현실적 답이라 했는데, 여기서 한 발 더 나간다: **에이전트 활동을 org-agenda로 보자.**
...
#### 파일 네이밍 — Denote 규약 {#파일-네이밍-denote-규약}
...
#### 파일 내부 — reverse datetree 포맷 {#파일-내부-reverse-datetree-포맷}
...
##### 21:30 punchout {#21-30-punchout}

에이전트 CLOCK 합계: 2h 15m


##### <span class="org-todo todo TODO">TODO</span> sks-hub-zig #91 디버깅 {#sks-hub-zig-91-디버깅}

-   DS Bind 로직 수정
-   QA 체크리스트 DS2-6 통과


##### <span class="org-todo done DONE">DONE</span> elfeed 번역 벤치마크 {#elfeed-번역-벤치마크}
...
##### <span class="org-todo done DONE">DONE</span> pi-skills 일원화 {#pi-skills-일원화}
...
##### org-reverse-datetree 연동 {#org-reverse-datetree-연동}
...
#### agenda에서 볼 수 있는 것 {#agenda에서-볼-수-있는-것}
...
### punchout 진화 {#punchout-진화}


#### 현재 punchout {#현재-punchout}

gitcli 커밋 시간으로 시간대 추정, 저널에 텍스트 삽입.


#### 진화된 punchout {#진화된-punchout}
...
#### 세션 시작/종료 시 CLOCK 관리 {#세션-시작-종료-시-clock-관리}
...
### emacsclient 접근법 — 파일 수정의 두 가지 길 {#emacsclient-접근법-파일-수정의-두-가지-길}

[에이전트를 이맥서로 만드는 방향]({{< relref "/botlog/20260227T141200.md" >}})에서 핵심 통찰이 나왔다. xenodium(Alvaro Ramirez)의 [emacs-skills](https://github.com/xenodium/emacs-skills)가 열어준 "세 번째 인터페이스".


#### 텍스트 조작 vs emacsclient {#텍스트-조작-vs-emacsclient}
...
#### agenda 파일 수정의 두 경로 {#agenda-파일-수정의-두-경로}
...
#### 실제 emacsclient 호출 예시 {#실제-emacsclient-호출-예시}
...
-   [봇-활동-기록-아키텍처와-힣노트-역사성-고찰]({{< relref "/botlog/20260224T164035.md" >}}) — 이 문서의 전편
-   [데이터베이스 vs 파일 노트 개인지식관리 규칙]({{< relref "/notes/20230223T054600.md" >}}) — 왜 DB 없이 하는가
-   [diary]({{< relref "/20220101T010100.md" >}}) — datetree 실전 사용 (2022~, 18,000줄+)
-   [이맥스-에이전트-오케스트레이션-진화]({{< relref "/20260226T195937.md" >}}) — Pi extension, gptel 통합
-   [† 에이전틱코딩 라이브코딩 에이전트코딩]({{< relref "/meta/20250209T203153.md" >}}) — 에이전트 코딩 메타
-   [에이전트를 이맥서로 만드는 방향]({{< relref "/botlog/20260227T141200.md" >}}) — emacsclient 접근법, xenodium emacs-skills
