---
title: "§gogcli §notes 디지털 가든 Search Console 분석 보고서"
description: "Search Console 지표를 통해 디지털 가든이 외부 보편 AI(Gemini 등)와 제대로 결속되어 있는지, 컨텍스트 파이프라인의 상태를 확인하는 생존 신호(Sensory signal) 관측 기록이다."
date: 2026-04-13T16:45:00+09:00
lastmod: 2026-05-12T16:53:00+09:00
tags: ["aeo", "botlog", "digitalgarden", "gogcli", "metrics", "searchconsole", "seo"]
draft: false
---
...
-   <span class="timestamp-wrapper"><span class="timestamp">[2026-05-12 Tue 16:48]</span></span> <span class="org-mention">@junghan</span> — 한달 후 대충 달았다.
-   <span class="timestamp-wrapper"><span class="timestamp">[2026-04-15 Wed 10:36]</span></span> <span class="org-mention">@junghan</span> — 제미나이 가이드 추가
-   <span class="timestamp-wrapper"><span class="timestamp">[2026-04-13 Mon 16:45]</span></span> 생성 — Google Search Console CLI 분석 결과 기록
...
## <span class="timestamp-wrapper"><span class="timestamp">[2026-04-13 Mon]</span></span> Search Console 분석 결과 {#search-console-분석-결과}

최근 `gog sc` 명령어를 활용하여 디지털 가든(notes.junghanacs.com)의 구글 색인 및 노출 상태를 점검하였습니다.


### 1. 현재 가든 상태 요약 {#1-dot-현재-가든-상태-요약}
...
### 2. 색인 누락 원인 분석 {#2-dot-색인-누락-원인-분석}
...
### 3. 검색 노출 개선 방안(SEO 제안) {#3-dot-검색-노출-개선-방안--seo-제안}
...
## <span class="timestamp-wrapper"><span class="timestamp">[2026-04-15 Wed]</span></span> 가든 대규모 메타데이터 배포 이후 Search Console 관측 시나리오 {#가든-대규모-메타데이터-배포-이후-search-console-관측-시나리오}


### 메타데이터 일괄 배포 개요 {#메타데이터-일괄-배포-개요}

-   **배포 일시:** 2026년 4월 14일 (수요일 새벽)
-   **대상:** 디지털 가든 내 2,107개 파일
-   **작업 내용:** 메타 `description` 속성 및 `[!abstract]` 블록 일괄 추가
-   **연결 노트:** [†지식그래프]({{< relref "/meta/20240531T202141.md" >}})


### gogcli sc 기반 3대 핵심 관측 지표 {#gogcli-sc-기반-3대-핵심-관측-지표}

지피티가 제안한 6개의 관측 지표 중 구글 서치콘솔(`gogcli sc`)로 측정 및 추적 가능한 핵심 지표를 선별하여 다음과 같은 쿼리 시나리오를 수립한다.


#### 1. 요약 블록 효율 (Summary Block Efficiency) {#1-dot-요약-블록-효율--summary-block-efficiency}
...
#### 2. 롱테일 표면적 (Long-tail Surface Area) {#2-dot-롱테일-표면적--long-tail-surface-area}
...
#### 3. 핵심층 대 레거시층 비율 (Core vs Legacy Ratio) {#3-dot-핵심층-대-레거시층-비율--core-vs-legacy-ratio}
...
### 크롤러 반응 및 지표 변화 타임라인 (Timeline) {#크롤러-반응-및-지표-변화-타임라인--timeline}


#### D+1 (2026-04-15) : 크롤링 감지 및 색인 대기 {#d-plus-1--2026-04-15--크롤링-감지-및-색인-대기}
...
#### D+7 (2026-04-21) : 스니펫 반영 및 노출(Impression) 상승 시작 {#d-plus-7--2026-04-21--스니펫-반영-및-노출--impression--상승-시작}
...
#### D+28 (2026-05-12) : 생태계 안정화 및 요약 블록 효율 입증 {#d-plus-28--2026-05-12--생태계-안정화-및-요약-블록-효율-입증}
...
## <span class="timestamp-wrapper"><span class="timestamp">[2026-05-12 Tue]</span></span> 1개월 후기: 구글 인덱싱과 제미나이 컨텍스트 확보 {#1개월-후기-구글-인덱싱과-제미나이-컨텍스트-확보}
