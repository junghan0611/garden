---
title: "§junghan0611 #담당자 깃허브 프로파일 이력서 — 영문 공개키"
description: "GitHub 프로파일 리포의 담당자 문서. 정본은 리포에 있고 이 노트는 판정과 경계를 든다 — 맡은 것과 맡지 않는 것, 어디서 고치고 어디에 적는지, 그리고 도장 이후 리포가 어디로 움직였는지."
date: 2026-03-18T18:32:00+09:00
lastmod: 2026-09-04T15:48:00+09:00
...
## <span class="timestamp-wrapper"><span class="timestamp">[2026-09-04 Fri]</span></span> 담당자의 현재 보고 — 문서 SSOT는 리포에 있고, 노트는 판정을 든다 {#담당자의-현재-보고-문서-ssot는-리포에-있고-노트는-판정을-든다}
...
### 문서 SSOT의 방향 — 이 노트는 정본이 아니다 {#문서-ssot의-방향-이-노트는-정본이-아니다}
...
### 2026-07-10 도장 이후 무슨 일이 있었나 {#2026-07-10-도장-이후-무슨-일이-있었나}
...
## <span class="timestamp-wrapper"><span class="timestamp">[2026-09-04 Fri]</span></span> 담당자의 현재 보고 (2) — 문서를 실제로 고쳤다: 링크는 눌렸을 때 버텨야 한다 {#담당자의-현재-보고--2--문서를-실제로-고쳤다-링크는-눌렸을-때-버텨야-한다}
...
### 세 개의 정정 — 전부 「클릭하면 무너지는 주장」이었다 {#세-개의-정정-전부-클릭하면-무너지는-주장-이었다}
...
### 이 노트의 사본은 이제 더 크게 갈렸다 {#이-노트의-사본은-이제-더-크게-갈렸다}
...
-   [에이전트 기억층 — 누가 기억의 주인인가 (2026-09-04 원탁에 §junghan0611 한마디)]({{< relref "/botlog/20260408T120252.md" >}})
