...
-   <span class="timestamp-wrapper"><span class="timestamp">[2026-03-29 Sun 17:22]</span></span> <span class="org-mention">@junghan</span> — 분신 가이드 [§entwurf: 분신 어젠다 PARA 구조 재설계 검토]({{< relref "/20260328T160429.md" >}})
...
-   [§entwurf: 시간축 위의 에이전트 협력 — 공명에서 분신까지]({{< relref "/botlog/20260302T191200.md" >}})
-   [하네스 엔지니어링 — 돌도끼에서 인공지능까지]({{< relref "/botlog/20260319T152938.md" >}})
-   [§dictcli: 위임 워크플로우 작업로그]({{< relref "/20260323T172642.md" >}})
...
1.  **Claude Code 실제 코드에서 재사용 가능한 패턴만 추출**
    ...
    -   문서: [§claude-code: 소스 분석 — Constitutional AI 구현과 힣 하네스 대응]({{< relref "/20260401T182958.md" >}})
...
| 메모리 유지 | 자동 Dream 전체 이식보다, 하네스형 리뷰 /기록 패턴으로 번역 | Claude Code는 12K 압축 문제를 자동화로 해결, 힣은 시간축 org + 3층 검색이 강점 | [§claude-code 소스 분석]({{< relref "/20260401T182958.md" >}}) + `SessionMemory/autoDream` 코드 |
