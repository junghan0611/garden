---
title: "#SSOT AGENTS.md #모음"
date: 2026-03-16T12:14:00+09:00
lastmod: 2026-04-03T08:33:00+09:00
tags: ["agent", "botlog", "collection", "prompt", "ssot"]
draft: false
---
...
- [관련메타](#관련메타)
- [관련노트](#관련노트)
- [ORG: (AGENTS.md)](#org--agents-dot-md)
- [A](#a)
- [B](#b)
- [C](#c)
- [D](#d)
...
-   <span class="timestamp-wrapper"><span class="timestamp">[2026-04-03 Fri 08:35]</span></span> 스킬 문서와 에이전트 문서 일관성을 확보하고, 효율성을 끌어 올리기 위한 작업. 그리고 다른 학교 출신의 에이전트들 사이에서 힣의 정체성을 유지하면서 [§프로파일 하네스 — 외계지능과 공명하는 존재의 #구심점]({{< relref "/botlog/20260228T075300.md" >}})을 세워서 협업 하는 환경을 구축하는 명세서임 SSOT 파일입니다.


## 히스토리 {#히스토리}

-   <span class="timestamp-wrapper"><span class="timestamp">[2026-04-03 Fri 08:29]</span></span> <span class="org-mention">@junghan</span> — org AGENTS.md 옮김. 어제 지피티랑 영문화함.
-   <span class="timestamp-wrapper"><span class="timestamp">[2026-04-03 Fri 08:24]</span></span> <span class="org-mention">@junghan</span> — sLLM 이야기는 그다지 별거 이야기는 빼고 다른걸로 담자. [§homeagent-config 로드맵 — 오픈소스 스마트홈 에이전트 플랫폼]({{< relref "/botlog/20260304T200300.md" >}}) 여기로 원래 문서 옮김.
...
-   ...
-   [§org 존재 원본 공개 프로토콜 설계]({{< relref "/20260402T110344.md" >}}) 이것과 연관 되어 있다.
-   [§agent-config: 스킬문서 가이드 에이전트 친화적 재설계]({{< relref "/20260401T112943.md" >}})
