---
title: "tag-release: 하네스 투두를 거부하고 CalVer release loop로 묶은 힣 워크플로우"
description: "하네스마다 다른 TODO 시스템 대신, repo에 사는 4개 텍스트 문서와 4개 도구로 묶은 CalVer 기반 릴리즈 워크플로우. 태그가 0개라 changelog 자동화가 죽어 있던 구조적 원인을 풀고, agent-config SSOT로 멀티 하네스에 배포한 설계 기록."
date: 2026-05-31T17:48:00+09:00
lastmod: 2026-06-01T08:32:00+09:00
tags: ["agent", "botlog", "calver", "changelog", "git", "nixos", "workflow"]
draft: false
---
...
-   <span class="timestamp-wrapper"><span class="timestamp">[2026-06-14 Sun 11:44]</span></span> [NEXT.md 핸드오프 패턴 — 검증 기준 내장 + 새 세션이 무너지지 않는 3층 구조 #책갈피]({{< relref "/botlog/20260518T181305.md" >}}) 여기랑 쌍쌍이다.
-   <span class="timestamp-wrapper"><span class="timestamp">[2026-05-31 Sun 18:06]</span></span> 추가 — run.sh setup의 dirty-safe managed repo refresh + stale gitcli binary 방지 기록
-   <span class="timestamp-wrapper"><span class="timestamp">[2026-05-31 Sun 17:48]</span></span> 생성 — tag-release 스킬 설계 + nixos-config v2026.5.31 첫 dogfood 정리


## 출발점 — 하네스 투두 거부 {#출발점-하네스-투두-거부}
...
## 문제 — 태그 0개가 changelog를 죽였다 {#문제-태그-0개가-changelog를-죽였다}
...
## 설계 — 4문서 × 4도구, 두 루프 {#설계-4문서-4도구-두-루프}
...
## 첫 dogfood — nixos-config v2026.5.31 {#첫-dogfood-nixos-config-v2026-dot-5-dot-31}
...
## 발견 — 태그 push hook false positive {#발견-태그-push-hook-false-positive}
...
## <span class="timestamp-wrapper"><span class="timestamp">[2026-05-31 Sun]</span></span> setup freshness — stale binary를 빌드하지 않기 {#setup-freshness-stale-binary를-빌드하지-않기}
