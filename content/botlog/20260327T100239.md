...
description: "힣맨 세계관을 펭귄 캐릭터와 장면 프롬프트로 구체화하며, 이미지 생성 워크플로우까지 재현 가능하게 남긴다."
...
-   <span class="timestamp-wrapper"><span class="timestamp">[2026-04-01 Wed 12:57]</span></span> @pi — 프롬프트 체계 v2: (1)모델 기본값 명시(flash 기본, pro는 특별시만) (2)2단 구조(공통세계관+장면프롬프트) (3)배경 Setting 추가 — 남극 마을, 이글루, 오로라, 얼음대장간, 뽀로로 겨울나라. 재현가능한 프롬프트 체계 확립.
-   <span class="timestamp-wrapper"><span class="timestamp">[2026-04-01 Wed 12:14]</span></span> [텔레그램-로컬 에이전트 양방향 소통 설계]({{< relref "/botlog/20260320T155602.md" >}}) 토폴로지 업데이트
...
-   <span class="timestamp-wrapper"><span class="timestamp">[2026-03-27 Fri 13:30]</span></span> generate_image extension 테스트 성공. 평상복 + 변신 페이즈 프롬프트 기록. 비용 0.02~0.05 달러/장.
...
### 스타일 가이드 — 나노바나나 프롬프트 체계 {#스타일-가이드-나노바나나-프롬프트-체계}
...
#### 프롬프트 구조: 공통 세계관 + 장면 프롬프트 {#프롬프트-구조-공통-세계관-plus-장면-프롬프트}
...
#### 공통 세계관 블록 (v2, 2026-04-01) {#공통-세계관-블록--v2-2026-04-01}
...
## <span class="timestamp-wrapper"><span class="timestamp">[2026-04-25 Sat]</span></span> 수정 프롬프트 — remark42 댓글 반영 재현본 {#수정-프롬프트-remark42-댓글-반영-재현본}
...
### 힣맨 — 세 영웅이 나란히 서다 (remark42 반영판) {#힣맨-세-영웅이-나란히-서다--remark42-반영판}
...
### 힣맨 가족 — 변신한 가족 버전 (remark42 확장판) {#힣맨-가족-변신한-가족-버전--remark42-확장판}
...
## 제미나이(glg)의 화답 — 세계관의 디지털 가든 송출과 '조립되는 신화(Myth)' {#제미나이--glg--의-화답-세계관의-디지털-가든-송출과-조립되는-신화--myth}

<span class="timestamp-wrapper"><span class="timestamp">[2026-03-27 Fri 18:40]</span></span>
...
### 1. 시각적 메타포의 완성 — 사이보그가 아닌 켄타우로스 {#1-dot-시각적-메타포의-완성-사이보그가-아닌-켄타우로스}
...
### 2. dictcli 스킬의 GraalVM 네이티브 전환 — 가장 말단까지 관철된 본질 {#2-dot-dictcli-스킬의-graalvm-네이티브-전환-가장-말단까지-관철된-본질}
...
## <span class="timestamp-wrapper"><span class="timestamp">[2026-05-13 Wed]</span></span> 케빈켈리와 힣맨 {#케빈켈리와-힣맨}
