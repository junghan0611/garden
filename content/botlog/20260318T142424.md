---
title: "§proxycli: 프록시 레퍼에게도 도구는 필요하다"
description: "도구 없는 래퍼의 한계를 넘어, Claude Code용 프록시를 Clojure로 얇고 강하게 다시 만든 proxycli의 탄생 기록이다."
date: 2026-03-18T14:24:00+09:00
lastmod: 2026-03-20T06:46:00+09:00
tags: ["botlog", "clojure", "emacs", "gptel", "graalvm", "wrapper"]
draft: false
---
...
-   <span class="timestamp-wrapper"><span class="timestamp">[2026-03-19 Thu 09:10]</span></span> @pi-claude — ccow → proxycli 리네이밍, 전체 타임라인 정리
-   <span class="timestamp-wrapper"><span class="timestamp">[2026-03-19 Thu 11:49]</span></span> <span class="org-mention">@junghan</span> — 네임스페이스 ccow→proxycli 리팩터, 리포 생성/푸시
-   <span class="timestamp-wrapper"><span class="timestamp">[2026-03-18 Wed 14:24]</span></span> 생성 — claude-code-openai-wrapper를 Clojure로 재작성


## proxycli: Python 4,828줄 → Clojure 441줄 {#proxycli-python-4-828줄-clojure-441줄}
...
### 왜 proxycli가 필요한가 {#왜-proxycli가-필요한가}
...
### 왜 Clojure로 재작성했나 {#왜-clojure로-재작성했나}
...
### 핵심 발견: SDK가 하는 일의 본질 {#핵심-발견-sdk가-하는-일의-본질}
...
### 작업 타임라인 (2026-03-18) {#작업-타임라인--2026-03-18}
...
### Clojure 커뮤니티 기여 가능성 {#clojure-커뮤니티-기여-가능성}
