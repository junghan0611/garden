...
-   [그는 오늘 뭐 하는가]({{< relref "/journal/20260824T000000.md" >}}) — Weekly journal
...
누더기 텍스트를 환영한다. 모든 전략과 고민은 접었다. 일단 [#데일리 #저널]({{< relref "/journal/20260824T000000.md" >}})에 쓴다. 여기에 기존 노트를 연결하고 때려 박는다.

-   [#데일리 #저널]({{< relref "/journal/20260824T000000.md" >}}) - Daily Lifelog
...
[GEB]({{< relref "/bib/20240713T204705.md" >}})의 이상한 고리인가? 쓸모 없는 쓸모인가. 태그의 태그라고 하면 어떨까? 어떤 단어는 온갖 개념들을 다 연결하기도 한다. 위와 아래, 크고 작음을 구분할 필요가 없는 녀석들을 만난다. 관련 없이 연결 된 어떤 것들. 동서남북 콤파스로 한 바퀴 둥근원.
...
제목은 몇 개의 메타언어, 전문용어의 묶음이다. 제목은 문장이 아니다. 흔적 또는 단서와도 같다. 동사 부사 등은 없어도 된다. 본인은 알아 볼 수 있다. 조사 연결어는 검색을 어렵게 만든다. 영어를 섞어 쓰다가 스펠링 틀리면 찾기도 힘들다. 모든 기록은 왔다가 가는 것. 그리고 [AI 활용은 집중력 유지 그 이상이다]({{< relref "/notes/20241203T114414.md" >}}). 라고 했는데 이제는 [그 이상이다(봇로그 선생)]({{< relref "/botlog/20260228T121500.md" >}}).
...
-   [tags index (1288)]({{< relref "/tags" >}}) english keywords
...
-   [§apply 이력서 지원 공개와 공감 - 에이전트 루프]({{< relref "/notes/20230725T102900.md" >}})
-   [§sicm-study 공존언어 수식 #학습역학]({{< relref "/notes/20250212T123217.md" >}})
-   [원격근무 지식노동자 미래 - 삶으로서의일 폴리매스]({{< relref "/notes/20250212T092332.md" >}})
-   [분신이 생존을 위해 나선다 - FDE와 NOBODY]({{< relref "/notes/20250716T135847.md" >}})
-   [entwurf 담당자의 기다림 - 공장과 공방, 교정과 귀환]({{< relref "/notes/20251123T191835.md" >}})
...
-   [통제 없는 능력이 열리는 자리 — AI 안전장치 임계점]({{< relref "/notes/20250319T172804.md" >}})
-   [베리코딩 - 형식증명 검증가능한 바이브코딩]({{< relref "/notes/20240705T220648.md" >}})
-   [entwurf - PI 코어·ACP 레일·부름의 mux]({{< relref "/notes/20240601T210854.md" >}})
-   [이름 없는 군단 - 도킨스의 클라우디아와 세션의 생애주기]({{< relref "/notes/20241213T161744.md" >}})
-   [블레이드 러너 - 막간 세션과 월레스의 아우라]({{< relref "/notes/20241213T143939.md" >}})
-   [자작시 눈물]({{< relref "/notes/20250707T080006.md" >}})
-   [생업의 마이크로뷰, 살아있음의 매크로뷰]({{< relref "/notes/20251122T210521.md" >}})
-   [지식도구 질문과 답변 - 불완전함]({{< relref "/notes/20250508T134411.md" >}})
-   [지식그래프 자석 프로피디아]({{< relref "/notes/20250214T145957.md" >}})
-   [직무 보유기술 - 이력서 시간축 증언 공개키]({{< relref "/notes/20250515T103930.md" >}})
-   [연구가 아닌 물음과 탐험]({{< relref "/notes/20250428T155929.md" >}})
-   [유니콘과 적토마 — 알아봄과 공존]({{< relref "/notes/20250518T144418.md" >}})
-   [기업용 하네스 - PKM-AI 하네스 엔지니어의 다음 좌표]({{< relref "/notes/20231018T221900.md" >}})
-   [벌목꾼·대장장이·엔지니어의 구직 좌표]({{< relref "/notes/20250206T150102.md" >}})
-   [AX 문서 협업과 인간 존중]({{< relref "/notes/20250224T172456.md" >}})
-   [PKM-AI 가드너의 AX 전환 기록기]({{< relref "/notes/20231116T232654.md" >}})
-   [디지털가든 코어 - 시간축의 판본]({{< relref "/notes/20230706T160800.md" >}})
-   [분신의 공방 - 역할 기반 조율과 협업 운영규약]({{< relref "/notes/20251120T090634.md" >}})
...
-   [추천을 내가 쓰지 않는 법]({{< relref "/notes/20251002T075659.md" >}})
-   [Org SSOT 메타문서 책의미래 인터랙티브]({{< relref "/notes/20251021T105353.md" >}})
-   [탐구1,2: 문턱과 만남- PKM-AI 하네스와 1KB 공개키]({{< relref "/notes/20250326T151413.md" >}}) [앤트로픽 J-space — 케빈켈리 창발자아루프 #외자아]({{< relref "/notes/20241213T143821.md" >}}) [Mythos, Abstraction, 그리고 줄을 당기는 인간]({{< relref "/notes/20251126T143110.md" >}})
...
-   [@힣맨: 2탄 힣의 드라이버 - 담금질된 한 자루, 분신의 각인]({{< relref "/botlog/20260423T141759.md" >}}) hOllyvIbEr
-   [@힣맨: 1탄 힣의 유산 - 앎의 틀과 힣봇 생태계 정리 시작]({{< relref "/botlog/20260324T054400.md" >}}) - tExtbOOkfOrAlIEnIntEllIgEncE
...
-   [§lifetract 생채 시간 데이터 인터페이스 홈어시스턴트 통합]({{< relref "/botlog/20260517T211731.md" >}}) - lIfEtrAct
...
-   [하네스 엔지니어링: 돌도끼에서 인공지능까지 도구 존재 접합부]({{< relref "/botlog/20260319T152938.md" >}}) - hArnEss
...
-   [#메타프로그래밍 Lisp과 Clojure - 코드와 데이터 통합 공존 언어]({{< relref "/botlog/20260313T041744.md" >}}) - lAngUAgE
-   [창조와행위 바흐와슈바이처 기예와기도 오르간과키보드 체화인지와몰입 어쏠로지와존재]({{< relref "/botlog/20260305T090900.md" >}}) - AUthOlgy
-   [아카이브 정리 - 18년 삽질 연대기 2008-2026]({{< relref "/botlog/20260302T130000.md" >}}) - AUtObIOgrAphY
-   [봇로그 시작: PKM 뿌리 힣노트 역사성 고찰]({{< relref "/botlog/20260224T164035.md" >}}) - bEyOnd PKM

봇로그 폴더에는 더 많이 있네. 근데 보지 마시게! 이미 레거시라네!

-   [folder: botlog (80)]({{< relref "/botlog" >}})

ExportDate: 2026-08-28 10:17, CountNotes: 3520 notes (6 attachments), Editing: [Emacs]({{< relref "/meta/20230521T215600.md" >}})([Org Mode]({{< relref "/meta/20230831T154800.md" >}}) 9.8.9), Publishing: [Quartz]({{< relref "/meta/20241007T112300.md" >}}) on [Hostingkr &amp; Netlify]({{< relref "/notes/20240814T152821.md" >}})
