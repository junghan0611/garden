...
## #일반노트: 한글제목 임시노트 {#일반노트-한글제목-임시노트}

노트는 결국 개념어, 용어의 묶음이다. 제목은 문장이 아니다. 흔적 또는 단서와도 같다. 제목에는 동사가 없어도 본인은 알아 볼 수 있다. 조사 연결어 등은 검색하기 어렵게 만든다. 애매하게 여긴 영어를 섞어쓰면 복잡해진다. 디지털가든에 모든 기록은 임시노트다. 블로그 글도 아니다. 그냥 메모들이다. [제텔카스텐]({{< relref "/meta/20230926T135400.md" >}}) 기준으로 보자면 플리팅노트이다. 그의 경우, [홈페이지](https://junghanacs.com/)에 Docs, Blog 메뉴가 있다.
