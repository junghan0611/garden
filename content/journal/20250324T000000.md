...
today: 2025-03-24
author: ["Junghan Kim"]
description: "디노트(Denote) 개발자 프롯(Prot)에게 바치는 새벽 헌사에서 '삶의 철학, 지의 철학'을 도구 정신으로 풀어냈고, Quartz에 카테고리 택소노미를 추가하는 긴 AI 페어프로그래밍 세션을 진행했다. Hy(파이썬 위의 리스프)를 설치해 실험하며 aidermacs·emigo 등 이맥스 AI 페어프로그래밍 도구들도 둘러봤다."
...
### 13:33 [Lex Friedman 팟케스트(ThePrimeagen 인터뷰) - Emacs vs. NeoVIM (feat. ADHD)]({{< relref "/notes/20250326T135916.md" >}}) {#13-33-lex-friedman-팟케스트--theprimeagen-인터뷰--emacs-vs-dot-neovim--feat-dot-adhd--}


### 14:12 [POSSE 블로깅 전략 - 디지털가든 - 인디웹 - 공유]({{< relref "/notes/20250324T110312.md" >}}) {#14-12-posse-블로깅-전략-디지털가든-인디웹-공유}
...
### 17:02 [jira 프로젝트 관리 협업 - 이맥스]({{< relref "/notes/20250326T170451.md" >}}) 이것이 눈에 들어왔다 {#17-02-jira-프로젝트-관리-협업-이맥스--이것이-눈에-들어왔다}
...
### 13:04 [defrecord - 클로저 하이랭 조직모드 이맥스 LLM]({{< relref "/bib/20250327T134019.md" >}}) {#13-04-defrecord-클로저-하이랭-조직모드-이맥스-llm}
...
### 13:31 속쓰리다 부글부글  [@나오미배런 (1946-) 읽기 쓰기의 미래 - 언어학자]({{< relref "/bib/20250324T034547.md" >}}) 리딩 {#13-31-속쓰리다-부글부글-나오미배런--1946--읽기-쓰기의-미래-언어학자--리딩}


### 15:15 뚱이네 5500원 식사 - 집 왔다. 컨디션. {#15-15-뚱이네-5500원-식사-집-왔다-dot-컨디션-dot}


### 16:31 [#aider 페어프로그래밍 이맥스]({{< relref "/notes/20250214T135245.md" >}}) 개선하는 방법 {#16-31-aider-페어프로그래밍-이맥스--개선하는-방법}

(MatthewZMD 2025) 이녀석 탑재


### 17:47 [Cursor - The AI Code Editor]({{< relref "/bib/20250328T174028.md" >}}) 알아야 넘는다. {#17-47-cursor-the-ai-code-editor--알아야-넘는다-dot}
