...
today: 2026-03-23
author: ["junghanacs"]
description: "'분신은 나의 한계를 그대로 지닌 존재'라는 화두로 세션 소멸/부활을 사유하고, 힣맨 세계관의 비주얼 컨셉(펭귄 캐릭터, 나노바나나 프롬프트)을 설계했다. 봇멘트 보안 구조와 봇로그 1달 회고를 정리하고, 개발팀 AI 활용 간담회 참석과 엔경 AOSP/Yocto/Matter 스택 통합 작업도 병행."
...
-   [llmlog/ §entwurf 분신 에이전트 가이드 '2026-03-24]({{< relref "/botlog/20260324T153323.md" >}})
