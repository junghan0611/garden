...
<div class="csl-bib-body">
  ...
  <div class="csl-entry"><a id="citeproc_bib_item_2"></a>———. 2017. <i>Thinking as Computation: A First Course</i>. MIT Press.</div>
  <div class="csl-entry"><a id="citeproc_bib_item_3"></a>———. 2018. <i>Common Sense, the Turing Test, and the Quest for Real AI</i>. MIT Press.</div>
  ...
  <div class="csl-entry"><a id="citeproc_bib_item_5"></a>헥터 레베스크, and Ronald J. Brachman. 2022. <i>Machines like Us: Toward AI with Common Sense</i>. MIT Press.</div>
</div>
