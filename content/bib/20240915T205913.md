...
-   <span class="timestamp-wrapper"><span class="timestamp">[2025-05-28 Wed 15:03] </span></span> [#결제 #가격 #비용 #청구]({{< relref "/meta/20250321T100126.md" >}}) 했다. 스코드 이맥스 공통 인터페이스로 중심을 잡기에는 코파일럿 뿐이다. 개발에 집중하려면 그렇다.
...
-   <span class="timestamp-wrapper"><span class="timestamp">[2024-10-18 Fri 16:50] </span></span> [#깃허브 #코파일럿 #채팅 #이맥스: chep/copilot-chat.el]({{< relref "/notes/20241019T193836.md" >}})

-   [#쥐피텔 #깃허브 모델 - 코파일럿 비교]({{< relref "/notes/20240830T161957.md" >}})
