---
title: "#프로그래밍 #언어 #함수형: ¤Janet"
description: "Janet은 함수형과 명령형을 아우르며 임베디드와 스크립트 작업에 어울리는 가벼운 프로그래밍 언어다."
date: 2024-08-06T15:44:00+09:00
lastmod: 2025-04-18T00:00:00+09:00
tags: ["clang", "functional", "imperative", "programming", "language", "scripts", "garbage", "collector"]
categories: ["MetaWord"]
draft: false
---
...
<div class="csl-bib-body">
  <div class="csl-entry"><a id="citeproc_bib_item_1"></a>“The Janet Programming Language.” n.d. Accessed May 10, 2025. <a href="https://janet-lang.org/">https://janet-lang.org/</a>.</div>
</div>


## 관련메타 {#관련메타}

-   [†#함수 #기능]({{< relref "/meta/20231114T064609.md" >}})
...
-   <span class="timestamp-wrapper"><span class="timestamp">[2025-06-14 Sat 21:08]</span></span> Created!


## The Janet Programming Language {#the-janet-programming-language}

(<a href="#citeproc_bib_item_1">“The Janet Programming Language” n.d.</a>)
...
### [2025-06-09]({{< relref "/journal/20250609T000000.md" >}}) {#2025-06-09}


#### @user janet 를 C코드로 변환할 수있는가? {#user-janet-를-c코드로-변환할-수있는가}
...
##### 예시: 간단한 Janet 함수를 C로 변환 {#예시-간단한-janet-함수를-c로-변환}
