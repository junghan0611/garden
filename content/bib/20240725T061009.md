...
<style>.csl-entry{text-indent: -1.5em; margin-left: 1.5em;}</style><div class="csl-bib-body">
  ...
  <div class="csl-entry"><a id="citeproc_bib_item_2"></a>짐 웨버, &#38; Barrasa Jesus. (2023). <i>지식그래프 구축 - 실무자 가이드</i> (1st edition). O’Reilly Media.</div>
  <div class="csl-entry"><a id="citeproc_bib_item_3"></a>Jim Webber. (2024). <i>짐웨버 neo4j 그래프데이터베이스</i>. World Wide Webber. <a href="https://jimwebber.org/">https://jimwebber.org/</a></div>
</div>
...
(<a href="#citeproc_bib_item_2">짐 웨버 &#38; Barrasa Jesus, 2023</a>)
