...
(<a href="#citeproc_bib_item_2">Allemang et al., 2020</a>)
...
<style>.csl-entry{text-indent: -1.5em; margin-left: 1.5em;}</style><div class="csl-bib-body">
  ...
  <div class="csl-entry"><a id="citeproc_bib_item_2"></a>Allemang, D., Hendler, J., &#38; Gandon, F. (2020). <i>Semantic web for the working ontologist: Effective modeling for linked data, rdfs, and owl</i> (3rd edition). ACM Books.</div>
</div>
