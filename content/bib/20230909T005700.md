...
## (해럴드 에이블슨, 제럴드 제이 서스먼, and 줄리 서스먼 2016) "SICP 컴퓨터 프로그램의 구조와 해석" 해럴드 애빌슨 and 제럴드 제이 서스먼 and 줄리 서스먼 2016 이광근 {#해럴드-에이블슨-제럴드-제이-서스먼-and-줄리-서스먼-2016--sicp-컴퓨터-프로그램의-구조와-해석-해럴드-애빌슨-and-제럴드-제이-서스먼-and-줄리-서스먼-2016-이광근}
...
(“\#Sicp \#Sicpjs Source-Academy/Sicp Wiki” n.d., n.d.)
...
## <span class="org-todo done DONT">DONT</span> CANCELLED SICP Clojure {#cancelled-sicp-clojure}
