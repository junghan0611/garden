---
title: "@에셔: #MC에셔 #불가능구조 #테셀레이션 #무한 판화가"
description: "M.C. Escher - 수학적 영감의 판화 예술"
date: 2026-03-18T09:00:00+09:00
lastmod: 2026-03-18T09:00:00+09:00
tags: ["arts", "bib", "escher", "impossible", "mathematics", "tessellation"]
...
## 작가: M.C. Escher - 수학과 예술의 경계 {#작가-m-dot-c-dot-escher-수학과-예술의-경계}
...
-   GEB([괴델-에셔-바흐]({{< relref "/bib/20240713T204705.md" >}}))에서 호프스태터가 에셔를 선택한 이유: "이상한 고리(strange loop)"의 시각적 구현자.
...
### 테셀레이션 시리즈 (Metamorphosis / Regular Division) {#테셀레이션-시리즈--metamorphosis-regular-division}
...
### 불가능 구조 (Impossible Structures) {#불가능-구조--impossible-structures}
...
### 자기참조 / 이상한 고리 (Self-Reference / Strange Loop) {#자기참조-이상한-고리--self-reference-strange-loop}
...
### 콕세터(H.S.M. Coxeter)와의 교류 {#콕세터--h-dot-s-dot-m-dot-coxeter--와의-교류}
...
### 펜로즈(Roger Penrose)와의 연결 {#펜로즈--roger-penrose--와의-연결}
...
### 대칭군(Symmetry Groups) {#대칭군--symmetry-groups}
...
-   [괴델-에셔-바흐 (GEB) - 호프스태터]({{< relref "/bib/20240713T204705.md" >}})
-   [쿠르트 괴델 - 불완전성 정리]({{< relref "/bib/20250429T082901.md" >}})
-   [존 배로 - 수학과 무한]({{< relref "/bib/20240314T120534.md" >}})
