---
title: "@모리스헐리히 멀티프로세서 프로그래밍"
description: "『멀티프로세서 프로그래밍』은 락, 원자성, 락프리 자료구조를 다루는 병행성 이론의 정석이다."
date: 2025-04-02T11:54:00+09:00
lastmod: 2025-04-02T11:54:00+09:00
tags: ["algorithm", "artof", "bib", "lockfree", "multiplecursors", "programming"]
categories: ["Noname"]
draft: false
---
...
<div class="csl-bib-body">
  <div class="csl-entry"><a id="citeproc_bib_item_1"></a>모리스 헐리히, and 니르 샤비트. 2020. <i>멀티프로세서 프로그래밍</i>. <a href="https://www.yes24.com/product/goods/3461480">https://www.yes24.com/product/goods/3461480</a>.</div>
</div>


## History {#history}

-   <span class="timestamp-wrapper"><span class="timestamp">[2025-04-02 Wed 11:54]</span></span>
...
## 멀티프로세서 프로그래밍 {#멀티프로세서-프로그래밍}

(<a href="#citeproc_bib_item_1">모리스 헐리히 and 니르 샤비트 2020</a>)
...
#### Foundations of Shared Memory {#foundations-of-shared-memory}
...
#### The Relative Power of Primitive Synchronization Operations {#the-relative-power-of-primitive-synchronization-operations}
...
#### Universality of Consensus {#universality-of-consensus}
...
### II. Practice {#ii-dot-practice}


#### Spin Locks and Contention {#spin-locks-and-contention}
...
#### Monitors and Blocking Synchronization {#monitors-and-blocking-synchronization}
...
#### Linked Lists: The Role of Locking {#linked-lists-the-role-of-locking}
...
#### Concurrent Queues and the ABA Problem {#concurrent-queues-and-the-aba-problem}
...
#### Concurrent Stacks and Elimination {#concurrent-stacks-and-elimination}
...
#### Counting, Sorting, and Distributed Coordination {#counting-sorting-and-distributed-coordination}
...
#### Concurrent Hashing and Natural Parallelism {#concurrent-hashing-and-natural-parallelism}
...
#### Skiplists and Balanced Search {#skiplists-and-balanced-search}
...
#### Futures, Scheduling, and Work Distribution {#futures-scheduling-and-work-distribution}
...
##### 18.1. Introduction {#18-dot-1-dot-introduction}
...
##### 18.2. Transactions and Atomicity {#18-dot-2-dot-transactions-and-atomicity}


##### 18.3. Software Transactional Memory {#h-9528fbc5-590c-43af-963c-3af15229bd79}
...
##### 18.4. Hardware Transactional Memory {#18-dot-4-dot-hardware-transactional-memory}

18.4.1. Cache Coherence 18.4.2. Transactional Cache Coherence 18.4.3. Enhancements 18.5. Chapter Notes 18.6. Exercises


### III. Appendix {#iii-dot-appendix}


### Software Basics {#software-basics}


#### A.1. Introduction {#a-dot-1-dot-introduction}


#### A.2. Java {#a-dot-2-dot-java}
...
#### A.4. Pthreads {#a-dot-4-dot-pthreads}
