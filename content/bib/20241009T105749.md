...
<style>.csl-entry{text-indent: -1.5em; margin-left: 1.5em;}</style><div class="csl-bib-body">
  <div class="csl-entry"><a id="citeproc_bib_item_1"></a>Herrlin, J. (2022). <i>Learn the awk programming language with emacs org-drill \#awk</i> [Computer software]. <a href="https://github.com/jherrlin/learn-awk">https://github.com/jherrlin/learn-awk</a> (2020)</div>
</div>
