---
title: "@AdityaAthalye #이맥스 #클로저 EvalApply"
description: "Aditya Athalye는 클로저와 이맥스, org-mode를 엮어 사유와 코딩이 한 흐름이 되는 워크플로를 탐구한다."
date: 2023-06-22T20:30:00+09:00
lastmod: 2025-02-18T00:00:00+09:00
tags: ["bib", "clojure", "orgmode", "person", "whyiuse", "workflow"]
...
<div class="csl-bib-body">
  <div class="csl-entry"><a id="citeproc_bib_item_1"></a>“Adityaathalye/Clojure-Multiproject-Example Clojure Multi-Project Example Layout and Tool Use.” 2025. <a href="https://github.com/adityaathalye/clojure-multiproject-example">https://github.com/adityaathalye/clojure-multiproject-example</a>.</div>
  <div class="csl-entry"><a id="citeproc_bib_item_2"></a>Athalye, Aditya. 2023a. “Emerging from Dotemacs Bankruptcy the Hard Way: Integrating the IDE (Feat. Clojure(Script)).” 2023. <a href="https://www.evalapply.org/posts/emerging-from-dotemacs-bankruptcy-ide-experience/index.html">https://www.evalapply.org/posts/emerging-from-dotemacs-bankruptcy-ide-experience/index.html</a>.</div>
  <div class="csl-entry"><a id="citeproc_bib_item_3"></a>———. 2023b. “Why and How I Use ‘Org Mode’ for My Writing and More.” 2023. <a href="https://www.evalapply.org/posts/why-and-how-i-use-org-mode/index.html">https://www.evalapply.org/posts/why-and-how-i-use-org-mode/index.html</a>.</div>
  <div class="csl-entry"><a id="citeproc_bib_item_4"></a>———. n.d.-a. “Clojuring the Web Application Stack: Meditation One.” Accessed February 7, 2025. <a href="https://www.evalapply.org/posts/clojure-web-app-from-scratch/index.html">https://www.evalapply.org/posts/clojure-web-app-from-scratch/index.html</a>.</div>
  <div class="csl-entry"><a id="citeproc_bib_item_5"></a>———. n.d.-b. “Evalapply Blog Tagged #Clojure.” Accessed February 6, 2025. <a href="https://www.evalapply.org/tags/clojure/index.html">https://www.evalapply.org/tags/clojure/index.html</a>.</div>
</div>


## 관련노트 {#관련노트}

-   [#내가쓰는이유방법: 조직모드]({{< relref "/notes/20240820T124819.md" >}}) 여기에 해당한다


## Aditya Athalye {#aditya-athalye}

-   [contacts::Athalye, Aditya - evalapply.org - adityaathalye]({{< relref "/meta/20230303T030300.md#h-0f8cce06-c16c-4c5b-a050-db71781e5297" >}})
...
{{< figure src="/images/20230911_100053_screenshot.png" caption="<span class=\"figure-number\">Figure 1: </span>about" width="100%" >}}


## Tags: clojure {#tags-clojure}

(<a href="#citeproc_bib_item_5">Athalye n.d.-b</a>)


## Clojuring the web application stack: Meditation One {#clojuring-the-web-application-stack-meditation-one}

(<a href="#citeproc_bib_item_4">Athalye n.d.-a</a>)
...
### adityaathalye/clojure-multiproject-example Clojure Multi-Project Example Layout and Tool Use {#adityaathalye-clojure-multiproject-example-clojure-multi-project-example-layout-and-tool-use}

(<a href="#citeproc_bib_item_1">“Adityaathalye/Clojure-Multiproject-Example Clojure Multi-Project Example Layout and Tool Use” 2025</a>)

-   A grug-brained stab at layout and tooling to conveniently develop many Clojure projects in a single source repo.


## Emerging from dotemacs bankruptcy the hard way: integrating the IDE (feat. Clojure(Script)) {#emerging-from-dotemacs-bankruptcy-the-hard-way-integrating-the-ide--feat-dot-clojurescript}

(<a href="#citeproc_bib_item_2">Athalye 2023a</a>)
...
## Why and How I use "Org Mode" for my writing and more {#why-and-how-i-use-org-mode-for-my-writing-and-more}

(<a href="#citeproc_bib_item_3">Athalye 2023b</a>)
...
{{< figure src="/images/20230622-2035-screenshot.png" >}}
