...
<style>.csl-entry{text-indent: -1.5em; margin-left: 1.5em;}</style><div class="csl-bib-body">
  <div class="csl-entry">Athalye, A. (n.d.--a). <i>Clojuring the web application stack: Meditation one</i>. Retrieved February 7, 2025, from <a href="https://www.evalapply.org/posts/clojure-web-app-from-scratch/index.html">https://www.evalapply.org/posts/clojure-web-app-from-scratch/index.html</a></div>
  <div class="csl-entry">Athalye, A. (n.d.--b). <i>Evalapply blog tagged \#clojure</i>. Retrieved February 6, 2025, from <a href="https://www.evalapply.org/tags/clojure/index.html">https://www.evalapply.org/tags/clojure/index.html</a></div>
  <div class="csl-entry">Athalye, A. (2023a). <i>Emerging from dotemacs bankruptcy the hard way: integrating the ide (feat. clojure(script))</i>. <a href="https://www.evalapply.org/posts/emerging-from-dotemacs-bankruptcy-ide-experience/index.html">https://www.evalapply.org/posts/emerging-from-dotemacs-bankruptcy-ide-experience/index.html</a></div>
  <div class="csl-entry">Athalye, A. (2023b). <i>Why and how i use “org mode” for my writing and more</i>. <a href="https://www.evalapply.org/posts/why-and-how-i-use-org-mode/index.html">https://www.evalapply.org/posts/why-and-how-i-use-org-mode/index.html</a></div>
  <div class="csl-entry">Athalye, A. (2025). <i>Adityaathalye/clojure-multiproject-example clojure multi-project example layout and tool use</i> [Computer software]. <a href="https://github.com/adityaathalye/clojure-multiproject-example">https://github.com/adityaathalye/clojure-multiproject-example</a> (2025)</div>
</div>
