---
title: "@웨스맥키니 파이썬 데이터과학 판다스"
date: 2024-05-24T15:12:00+09:00
lastmod: 2025-02-14T00:00:00+09:00
tags: ["bib", "datascience", "pandas", "python", "quarto"]
...
<style>.csl-entry{text-indent: -1.5em; margin-left: 1.5em;}</style><div class="csl-bib-body">
  <div class="csl-entry"><a id="citeproc_bib_item_1"></a>웨스 맥키니. (2023). <i>파이썬 라이브러리를 활용한 데이터 분석 - 영화 평점, 이름 통계, 선거 데이터 등 실사례 사용</i> (김영근, Tran.). 경기도사이버, 삼성전자. <a href="https://www.yes24.com/Product/Goods/118523424">https://www.yes24.com/Product/Goods/118523424</a></div>
  <div class="csl-entry"><a id="citeproc_bib_item_2"></a>Han, J. (2025). <i>Junghan0611/pydata-book</i> [Computer software]. <a href="https://github.com/junghan0611/pydata-book">https://github.com/junghan0611/pydata-book</a> (2025)</div>
  <div class="csl-entry"><a id="citeproc_bib_item_3"></a><i>Python for data analysis, 3e pydata-book-zh-cn</i>. (n.d.). Retrieved February 23, 2025, from <a href="https://zhengtiger.github.io/pydata-book-zh-cn/">https://zhengtiger.github.io/pydata-book-zh-cn/</a></div>
</div>


## Related-Notes {#related-notes}

-   [@조엘그루스 파이썬 밑바닥부터 데이터과학 수학 통계]({{< relref "/bib/20240603T132845.md" >}})


## 파이썬 라이브러리를 활용한 데이터 분석 {#파이썬-라이브러리를-활용한-데이터-분석}

(<a href="#citeproc_bib_item_1">웨스 맥키니, 2023</a>)
...
#### hadley/r4ds: R for data science: a book using Quarto r언어 {#hadley-r4ds-r-for-data-science-a-book-using-quarto-r언어}


### 코드: pydata-book {#코드-pydata-book}
...
#### <span class="org-todo todo TODO">TODO</span> 2.2 IPython 기초 {#2-dot-2-ipython-기초}
...
## Python for Data Analysis, 3E pydata-book-zh-cn {#python-for-data-analysis-3e-pydata-book-zh-cn}

(<a href="#citeproc_bib_item_3"><i>Python for Data Analysis, 3e Pydata-Book-Zh-Cn</i>, n.d.</a>)

잘 빌드 된다. 콰르토로 표기 된다. 이 책을 콰르토로 한글판을 만들 수도 있다.

Python for Data Analysis, 3E pydata-book-zh-cn

```shell
git clone git@github.com:ZhengTiger/pydata-book-zh-cn.git --depth 1
```

```text
  ~/git/clone on ☁️  gtgkjh@gmail.com
➜ git clone git@github.com:ZhengTiger/pydata-book-zh-cn.git
'pydata-book-zh-cn'에 복제합니다...
