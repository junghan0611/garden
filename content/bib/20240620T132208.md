---
title: "@마크왓슨 AI Clojure Lisp Programming 클로저"
description: "클로저와 리스프 계열 언어로 인공지능 프로그래밍을 익히려는 흐름을 마크 왓슨의 자료를 중심으로 모은다."
date: 2024-06-20T13:22:00+09:00
lastmod: 2025-02-02T09:54:00+09:00
tags: ["aiprogramming", "bib", "clojure", "commonlisp", "python"]
...
> [!abstract] 이 노트에 대하여
> 
> 클로저와 리스프 계열 언어로 인공지능 프로그래밍을 익히려는 흐름을 마크 왓슨의 자료를 중심으로 모은다. 함수형 감각과 상징 조작의 장점을 함께 체감하게 한다.

## BIBLIOGRAPHY

<div class="csl-bib-body">
  <div class="csl-entry"><a id="citeproc_bib_item_1"></a>마크 왓슨. 2023. <i>마크왓슨 Ai 클로저 프로그래밍</i>. Leanpub. <a href="https://leanpub.com/clojureai/read">https://leanpub.com/clojureai/read</a>.</div>
  <div class="csl-entry"><a id="citeproc_bib_item_2"></a>———. 2024. <i>마크왓슨 커먼리스프 프로그래밍</i>. <a href="https://leanpub.com/lovinglisp/read">https://leanpub.com/lovinglisp/read</a>.</div>
  <div class="csl-entry"><a id="citeproc_bib_item_3"></a>“Junghan0611/Clojure-Ai-Book-Code from Mark-Watson.” 2025. <a href="https://github.com/junghan0611/Clojure-AI-Book-Code">https://github.com/junghan0611/Clojure-AI-Book-Code</a>.</div>
  <div class="csl-entry"><a id="citeproc_bib_item_4"></a>“Mark-Watson/Clojure-Ai-Book-Code.” 2024. <a href="https://github.com/mark-watson/Clojure-AI-Book-Code">https://github.com/mark-watson/Clojure-AI-Book-Code</a>.</div>
</div>
...
## <span class="org-todo todo TODO">TODO</span> 마크왓슨 AI 클로저 프로그래밍 {#마크왓슨-ai-클로저-프로그래밍}
...
(<a href="#citeproc_bib_item_3">“Junghan0611/Clojure-Ai-Book-Code from Mark-Watson” 2025</a>)

-   Han, Jung
-   Examples for Clojure AI book
-   mark-watson/Clojure-AI-Book-Code (<a href="#citeproc_bib_item_4">“Mark-Watson/Clojure-Ai-Book-Code” 2024</a>)
...
I spent time writing this book to help you, dear reader. I release this book under the Creative Commons License and set the minimum purchase price to 0.00 달러 (free!) in order to reach the most readers. Under this license you can share a PDF version of this book with your friends and coworkers and I encourage you to do so. If you found this book on the web (or it was given to you) and if it provides value to you then please consider doing one of the following to support my future writing efforts and also to support future updates to this book:
...
#### <span class="org-todo done DONE">DONE</span> Setting Up Your Common Lisp Development System and Quicklisp {#leanpub-auto-setting-up-your-common-lisp-development-system-and-quicklisp}
...
### <span class="org-todo todo TODO">TODO</span> WAITING {#waiting}
