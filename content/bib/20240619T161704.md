...
<style>.csl-entry{text-indent: -1.5em; margin-left: 1.5em;}</style><div class="csl-bib-body">
  <div class="csl-entry"><a id="citeproc_bib_item_1"></a>“Lpfp: Code for the Book Learn Physics with Functional Programming.” n.d. Hackage. Accessed June 19, 2024. <a href="hackage.haskell.org/package/LPFP">hackage.haskell.org/package/LPFP</a>.</div>
  <div class="csl-entry"><a id="citeproc_bib_item_2"></a>Scott N. Walck. 2023. <i>Learn Physics with Functional Programming: A Hands-on Guide to Exploring Physics with Haskell</i>. San Francisco: No Starch Press. <a href="https://lpfp.io/">https://lpfp.io/</a>.</div>
</div>
...
(<a href="#citeproc_bib_item_1">“Lpfp: Code for the Book Learn Physics with Functional Programming” n.d.</a>)
