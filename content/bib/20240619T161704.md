---
title: "@스캇 LPFP 하스켈 함수형 프로그래밍으로 배우는 물리학"
date: 2024-06-19T16:17:00+09:00
lastmod: 2024-12-10T11:20:00+09:00
tags: ["bib", "haskell", "person", "physics"]
...
<style>.csl-entry{text-indent: -1.5em; margin-left: 1.5em;}</style><div class="csl-bib-body">
  <div class="csl-entry"><a id="citeproc_bib_item_1"></a><i>Lpfp: Code for the book learn physics with functional programming</i>. (n.d.). Hackage. Retrieved June 19, 2024, from <a href="hackage.haskell.org/package/LPFP">hackage.haskell.org/package/LPFP</a></div>
  <div class="csl-entry"><a id="citeproc_bib_item_2"></a>Scott N. Walck. (2023). <i>Learn physics with functional programming: A hands-on guide to exploring physics with haskell</i>. No Starch Press. <a href="https://lpfp.io/">https://lpfp.io/</a></div>
</div>
...
## LPFP: Code for the book Learn Physics with Functional Programming {#lpfp-code-for-the-book-learn-physics-with-functional-programming}

(<a href="#citeproc_bib_item_1"><i>Lpfp: Code for the Book Learn Physics with Functional Programming</i>, n.d.</a>)

-   스캇 (2023) LPFP: 하스켈 함수형-프로그래밍으로 배우는 물리학
-   Code for the book Learn Physics with Functional Programming


## Learn Physics with Functional Programming: A Hands-on Guide to Exploring Physics with Haskell {#learn-physics-with-functional-programming-a-hands-on-guide-to-exploring-physics-with-haskell}

(<a href="#citeproc_bib_item_2">Scott N. Walck, 2023</a>)
...
[:텍스트-에디터 :편집기]({{< relref "/meta/20240614T090202.md" >}})
