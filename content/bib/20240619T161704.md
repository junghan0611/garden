...
<style>.csl-entry{text-indent: -1.5em; margin-left: 1.5em;}</style><div class="csl-bib-body">
  <div class="csl-entry"><i>Lpfp: Code for the book learn physics with functional programming</i>. (n.d.). Hackage. Retrieved June 19, 2024, from <a href="hackage.haskell.org/package/LPFP">hackage.haskell.org/package/LPFP</a></div>
  <div class="csl-entry">Scott N. Walck. (2023). <i>Learn physics with functional programming: A hands-on guide to exploring physics with haskell</i>. No Starch Press. <a href="https://lpfp.io/">https://lpfp.io/</a></div>
</div>
...
(<i>Lpfp: Code for the Book Learn Physics with Functional Programming</i>, n.d.)
