---
title: "@마크왓슨 @MarkWatson 개인지식관리 시맨틱웹 LLM 하스켈 클로저 하이랭 구루"
description: "마크 왓슨(Mark Watson)의 저작/레포를 한 곳에 모아, 개인지식관리·시맨틱웹·지식그래프·LLM·리스프 작업 흐름을 추적한다."
date: 2024-06-23T13:14:00+09:00
lastmod: 2026-04-30T11:07:00+09:00
tags: ["bib", "clojure", "commonlisp", "guru", "haskell", "hylang", "knowledgemanagement", "langchain", "lisp", "llm", "pkm", "python", "semanticweb"]
...
-   <span class="timestamp-wrapper"><span class="timestamp">[2026-04-30 Thu 11:07]</span></span> 노트 정리 통합했다
-   <span class="timestamp-wrapper"><span class="timestamp">[2024-06-23 Sun 13:14]</span></span> 구루를 모십니다.
...
<div class="csl-bib-body">
  <div class="csl-entry"><a id="citeproc_bib_item_1"></a>마크 왓슨. 2023a. <i>마크왓슨 Ai 파이썬 프로그래밍</i>. Leanpub. <a href="https://leanpub.com/pythonai">https://leanpub.com/pythonai</a>.</div>
  <div class="csl-entry"><a id="citeproc_bib_item_2"></a>———. 2023b. <i>마크왓슨 Ai 클로저 프로그래밍</i>. Leanpub. <a href="https://leanpub.com/clojureai/read">https://leanpub.com/clojureai/read</a>.</div>
  <div class="csl-entry"><a id="citeproc_bib_item_3"></a>———. 2023c. <i>마크왓슨 Ai 하스켈 프로그래밍</i>. <a href="https://leanpub.com/haskell-cookbook/read">https://leanpub.com/haskell-cookbook/read</a>.</div>
  <div class="csl-entry"><a id="citeproc_bib_item_4"></a>———. 2023d. <i>마크왓슨 Langchain Llamaindex Llm Ai 프로그래밍</i>. Leanpub. <a href="https://leanpub.com/langchain/read">https://leanpub.com/langchain/read</a>.</div>
  <div class="csl-entry"><a id="citeproc_bib_item_5"></a>———. 2024a. <i>마크왓슨 커먼리스프 프로그래밍</i>. <a href="https://leanpub.com/lovinglisp/read">https://leanpub.com/lovinglisp/read</a>.</div>
  <div class="csl-entry"><a id="citeproc_bib_item_6"></a>———. 2024b. <i>마크왓슨 Hylang 하이랭 파이썬 리스프 프로그래밍</i>. Leanpub. <a href="https://leanpub.com/hy-lisp-python">https://leanpub.com/hy-lisp-python</a>.</div>
  <div class="csl-entry"><a id="citeproc_bib_item_7"></a>———. n.d. “Knowledgebooks.Com - 지식 관리 및 시맨틱 웹에 대한 연구 Research on the Knowledge Management, and the Semantic Web.” Accessed June 20, 2024. <a href="https://knowledgebooks.com/">https://knowledgebooks.com/</a>.</div>
</div>
...
## LangChain / LlamaIndex / LLM {#langchain-llamaindex-llm}


## 마크왓슨 LangChain LlamaIndex LLM AI 프로그래밍 {#마크왓슨-langchain-llamaindex-llm-ai-프로그래밍}

(<a href="#citeproc_bib_item_4">마크 왓슨 2023d</a>)
...
## Practical Python AI {#practical-python-ai}


## 마크왓슨 AI 파이썬 프로그래밍 {#마크왓슨-ai-파이썬-프로그래밍}

(<a href="#citeproc_bib_item_1">마크 왓슨 2023a</a>)
...
## Clojure / Common Lisp {#clojure-common-lisp}


## 마크왓슨 AI 클로저 프로그래밍 {#마크왓슨-ai-클로저-프로그래밍}

(<a href="#citeproc_bib_item_2">마크 왓슨 2023b</a>)
...
(<a href="#citeproc_bib_item_5">마크 왓슨 2024a</a>)
...
(<a href="#citeproc_bib_item_3">마크 왓슨 2023c</a>)
...
## Hy (Lisp in Python) {#hy--lisp-in-python}


## 마크왓슨 하이랭 파이썬 리스프 프로그래밍 {#마크왓슨-하이랭-파이썬-리스프-프로그래밍}

(<a href="#citeproc_bib_item_6">마크 왓슨 2024b</a>)
...
(<a href="#citeproc_bib_item_7">마크 왓슨 n.d.</a>)
