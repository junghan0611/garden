...
(<a href="#citeproc_bib_item_3">마크 왓슨, 2023b</a>)
...
(<a href="#citeproc_bib_item_2">마크 왓슨, 2023a</a>)
...
<style>.csl-entry{text-indent: -1.5em; margin-left: 1.5em;}</style><div class="csl-bib-body">
  <div class="csl-entry"><a id="citeproc_bib_item_1"></a>마크 왓슨. (n.d.). <i>Knowledgebooks.com - 지식 관리 및 시맨틱 웹에 대한 연구 research on the knowledge management, and the semantic web</i>. Retrieved June 20, 2024, from <a href="https://knowledgebooks.com/">https://knowledgebooks.com/</a></div>
  <div class="csl-entry"><a id="citeproc_bib_item_2"></a>마크 왓슨. (2023a). <i>마크왓슨 ai 파이썬 프로그래밍</i>. Leanpub. <a href="https://leanpub.com/pythonai">https://leanpub.com/pythonai</a></div>
  <div class="csl-entry"><a id="citeproc_bib_item_3"></a>마크 왓슨. (2023b). <i>마크왓슨 langchain llamaindex llm ai 프로그래밍</i>. Leanpub. <a href="https://leanpub.com/langchain/read">https://leanpub.com/langchain/read</a></div>
</div>
