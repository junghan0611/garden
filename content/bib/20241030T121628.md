...
(<a href="#citeproc_bib_item_1">해럴드 에이블슨 et al., 2016</a>)
...
(<a href="#citeproc_bib_item_4">제럴드 제이 서스먼 &#38; 잭 위스덤, 2014</a>)
...
(<a href="#citeproc_bib_item_5"><i>Mentat-Collective/Sicm-Book Orgmode Emacs</i>, 2021/2024</a>) Executable version of Structure and Interpretation of Classical Mechanics.
...
(<a href="#citeproc_bib_item_6"><i>Mentat-Collective/Sicm-Scheme-Exercises \#Emacs</i>, 2015/2024</a>)
...
(<a href="#citeproc_bib_item_3">제럴드 제이 서스먼 &#38; 잭 위스덤, 2012</a>)
...
-   Functional Differential Geometry
-   (<a href="#citeproc_bib_item_7"><i>Scorpio Diagrams - Fdg 미분기하학</i>, n.d.</a>)
...
(<a href="#citeproc_bib_item_2">제럴드 제이 서스먼, 2022</a>) <span class="timestamp-wrapper"><span class="timestamp">[2024-10-30 Wed 16:25]</span></span> [#제럴드제이서스먼: #고전역학 #전산물리 #리스프]({{< relref "/bib/20241030T121628.md" >}})
...
<style>.csl-entry{text-indent: -1.5em; margin-left: 1.5em;}</style><div class="csl-bib-body">
  <div class="csl-entry"><a id="citeproc_bib_item_1"></a>해럴드 에이블슨, 제럴드 제이 서스먼, &#38; 줄리 서스먼. (2016). <i>Sicp 컴퓨터 프로그램의 구조와 해석</i> (이광근, Tran.). <a href="https://www.yes24.com/Product/Goods/23951885">https://www.yes24.com/Product/Goods/23951885</a></div>
  <div class="csl-entry"><a id="citeproc_bib_item_2"></a>제럴드 제이 서스먼. (2022). <i>[Scheme’22] programming is (should be) fun!</i> (제럴드 제이 서스먼, Ed.). <a href="https://www.youtube.com/watch?v=2MYzvQ1v8Ww">https://www.youtube.com/watch?v=2MYzvQ1v8Ww</a></div>
  <div class="csl-entry"><a id="citeproc_bib_item_3"></a>제럴드 제이 서스먼, &#38; 잭 위스덤. (2012). <i>함수형 미분기하학 \#sicm \#fdg</i>. <a href="https://m.yes24.com/Goods/Detail/9252829">https://m.yes24.com/Goods/Detail/9252829</a></div>
  <div class="csl-entry"><a id="citeproc_bib_item_4"></a>제럴드 제이 서스먼, &#38; 잭 위스덤. (2014). <i>고전 역학의 구조 및 해석 \#sicm</i>. <a href="https://tgvaughan.github.io/sicm/toc.html">https://tgvaughan.github.io/sicm/toc.html</a></div>
  <div class="csl-entry"><a id="citeproc_bib_item_5"></a><i>Mentat-collective/sicm-book orgmode emacs</i>. (2024). [Computer software]. Mentat Collective. <a href="https://github.com/mentat-collective/sicm-book">https://github.com/mentat-collective/sicm-book</a> (2021)</div>
  <div class="csl-entry"><a id="citeproc_bib_item_6"></a><i>Mentat-collective/sicm-scheme-exercises \#emacs</i>. (2024). [Computer software]. Mentat Collective. <a href="https://github.com/mentat-collective/sicm-scheme-exercises">https://github.com/mentat-collective/sicm-scheme-exercises</a> (2015)</div>
  <div class="csl-entry"><a id="citeproc_bib_item_7"></a><i>Scorpio diagrams - fdg 미분기하학</i>. (n.d.). Retrieved October 31, 2024, from <a href="http://scorpiodiagrams.com/#fdg;chapter001">http://scorpiodiagrams.com/#fdg;chapter001</a></div>
</div>
