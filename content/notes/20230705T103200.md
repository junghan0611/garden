---
title: "#이맥스 #통합개발환경: #웹 #자바스크립트"
description: "이맥스를 웹과 자바스크립트 개발 환경으로 쓰기 위한 패키지, LSP, 실행 도구 구성을 정리한다. 라이팅허브 같은 실제 프로젝트에 바로 쓸 수 있도록 최소하지만 통합된 개발 환경을 만드는 데 초점이 있다."
date: 2023-07-05T10:32:00+09:00
lastmod: 2025-05-29T00:00:00+09:00
tags: ["emacside", "javascript", "web"]
categories: ["Noname"]
draft: false
---
...
-   [#이맥스통합개발환경 #리눅스]({{< relref "/meta/20231123T040509.md" >}})
...
## <span class="org-hashtag">#둠이맥스</span> 관련 패키지 설치 {#둠이맥스-관련-패키지-설치}
...
## <span class="org-hashtag">#참고</span> <span class="org-hashtag">#미니멀</span> <span class="org-hashtag">#환경설정</span> (<a href="#citeproc_bib_item_1"><i>How to Setup Emacs for Web Development</i> 2024</a>) {#참고-미니멀-환경설정}
...
<div class="csl-bib-body">
  <div class="csl-entry"><a id="citeproc_bib_item_1"></a><i>How to Setup Emacs for Web Development</i>. 2024. <a href="https://www.youtube.com/watch?v=FukoOretjg8">https://www.youtube.com/watch?v=FukoOretjg8</a>.</div>
</div>


## <span class="org-todo done DONE">DONE</span> nodejs npm install with lsp {#nodejs-npm-install-with-lsp}
...
## <span class="org-todo done DONE">DONE</span> `pnpm` install on ubuntu {#pnpm-install-on-ubuntu}
