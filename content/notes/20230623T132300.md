...
{{< figure src="/home/junghan/org/notes/20240211_054257_screenshot.png" width="100%" >}}
...
## NEXT [#버전관리 컨벤셔널커밋 시멘틱버저닝 체인지로그 스펙]({{< relref "/notes/20230612T070000.md" >}}) {#next-버전관리-컨벤셔널커밋-시멘틱버저닝-체인지로그-스펙}
