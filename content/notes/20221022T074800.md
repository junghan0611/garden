---
title: "@힣: #집중력 듀얼 모니터가 필요한가"
description: "듀얼 모니터가 집중에 실제로 도움이 되는지, 2022년의 실험과 2023년의 방치, 2025년의 재확인을 거쳐 QHD 싱글 모니터로 내린 3년짜리 결론."
date: 2022-10-22T07:48:00+09:00
lastmod: 2026-07-30T17:35:00+09:00
tags: ["adhd", "autholog", "distraction", "flow", "focus", "i3wm"]
draft: false
---
...
-   <span class="timestamp-wrapper"><span class="timestamp">[2026-07-30 Thu 17:16]</span></span> @mitsein/sonnet — 없던 히스토리를 만들고 표준 어쏠로그 구조로 세웠다. 2022/2023/2025 세 층을 원문·후속 댓글로 나눠 격리하고, GLG가 2023년에 남긴 "이 노트는 어디에 연결해야 할까?"라는 물음에 관련메타·관련노트로 답했다. "One Steady Light, Not Two Scattered Ones" 장면으로 GLGMAN Universe 이미지를 생성했다.
-   <span class="timestamp-wrapper"><span class="timestamp">[2025-05-21 Wed]</span></span> ThePrimeagen(마이클폴슨)이 에디터 하나만 쓰는 이유에 공감하는 한 줄을 덧붙였다.
-   <span class="timestamp-wrapper"><span class="timestamp">[2023-08-29 Tue 21:59]</span></span> 다시 읽고 "이 노트는 어디에 연결해야 할까?"라는 물음만 남긴 채 방치했다.
-   <span class="timestamp-wrapper"><span class="timestamp">[2022-10-22 Sat 07:48]</span></span> 모니터 환상과 시선 분산을 저울질하며 작성.


## 관련메타 {#관련메타}

-   [† #집중 #몰입]({{< relref "/meta/20240523T145852.md" >}}) — 시선을 하나로 지키는 것이 답이라는 결론이 닿는 자석.
-   [† #ADHD: #선택적집중]({{< relref "/meta/20230531T132600.md" >}}) — 여러 화면이 아니라 관심을 하나로 모으는 문제.
-   [† #타일링윈도우매니저]({{< relref "/meta/20240220T170557.md" >}}) — i3wm으로 전환한 뒤에야 이전 창 관리 방식이 어색해졌다고 적은 자리.
-   [† #어쏠로그]({{< relref "/meta/20241206T090648.md" >}}) — 3년의 방치를 지나 이제야 이름을 얻은 형식.


## 관련노트 {#관련노트}

-   [@힣: AI 시대에 왜 우리 개인은 더 지식에 목마른가]({{< relref "/notes/20220330T140100.md" >}}) — 같은 2022년, 같은 방치를 거친 쌍둥이 물음. 이쪽이 먼저 이름을 얻었다.
-   [@마이클폴슨 ThePrimeagen: AI 프로그래밍 생산성 텍스트 에디터]({{< relref "/bib/20250326T125758.md" >}}) — 2025년에 다시 꺼내 공감한 "하나만 쓴다"는 원칙.
-   [@니르이얄 #초집중: #본짓 #딴짓 #내부계기 #내면탐구 #몰입]({{< relref "/bib/20240326T205616.md" >}}) — 시선 분산을 외부·내부 계기의 언어로 다시 읽는 책.
-   [#마우스리스]({{< relref "/notes/20240530T122738.md" >}}) — 마우스로 창을 옮기는 불편함을 없애려는 같은 방향의 실천.
-   [#워크플로우: #모바일 #스마트폰 옵시디언 갤럭시AI 소리내어읽기]({{< relref "/notes/20240613T064804.md" >}}) — 화면 자체를 줄이는 워크플로우의 다른 갈래.
-   [#커브드 #모니터 #추억]({{< relref "/notes/20241231T161812.md" >}}) — 모니터 선택을 둘러싼 또 다른 시기의 기억.
...
## 3년에 걸쳐 쌓인 방 — 2022, 2023, 2025 {#3년에-걸쳐-쌓인-방-2022-2023-2025}
...
이 방은 [같은 2022년에 쓰인 다른 물음]({{< relref "/notes/20220330T140100.md" >}})과 쌍둥이다. 하나는 "왜 지식에 목마른가"라는 추상적 물음이었고, 이 글은 "화면을 몇 개 써야 하는가"라는 구체적 물음이었다. 둘 다 이름도, 자리도 없이 4년 가까이 떠돌다 어쏠로그로 회수됐다. 2025년 5월, ThePrimeagen(마이클폴슨)이 에디터를 하나만 쓰는 이유에 힣이 "완전 공감"이라 짧게 반응한 것도 같은 결의 재확인이었다 — 여러 개를 벌리는 것이 아니라 하나를 깊게 쓰는 쪽.


## 이미지 — 흩어진 두 빛이 아니라 하나의 고요한 빛 {#이미지-흩어진-두-빛이-아니라-하나의-고요한-빛}
...
{{< figure src="/images/20260730T171836--glgman-one-steady-light__brand_nanobanana.jpg" width="100%" >}}
...
## 원문 보존 — 2022-10-22 첫 물음 {#원문-보존-2022-10-22-첫-물음}

> [!danger]
> 
> <span class="timestamp-wrapper"><span class="timestamp">[2022-10-22 Sat 07:48]</span></span> 작성함
> 
...
## 후속 댓글 보존 — 2023-08-29 방치를 돌아보며 {#후속-댓글-보존-2023-08-29-방치를-돌아보며}
...
## 후속 댓글 보존 — 2025-05-21 프라이미언에 공감하며 {#후속-댓글-보존-2025-05-21-프라이미언에-공감하며}

> [!danger]
> 
> <span class="timestamp-wrapper"><span class="timestamp">[2025-05-21 Wed]</span></span>
> 
> 힣과 같음. 완전 공감.
> 
