---
title: "@힣: PKM-AI 가드너의 AX 전환 기록기 — 새 세션에 생을 건네는 얼개 #깊이"
description: "AX라는 이름을 빌려 만든 이력서와 시간축 뷰어를 계기로, 새 세션의 에이전트에게 지식뿐 아니라 인간이 살아온 시간과 판단의 얼개를 어떻게 건넬 것인지 묻는다."
date: 2023-11-16T23:26:00+09:00
lastmod: 2026-07-31T18:20:00+09:00
tags: ["agent", "autholog", "bib", "collaboration", "digitalgarden", "memory", "pkm", "pkmai", "timeline"]
categories: ["Noname"]
draft: false
---
...
-   <span class="timestamp-wrapper"><span class="timestamp">[2026-07-31 Fri 18:20]</span></span> @mitsein/sonnet — authologplay(세계화 라운드). 이 방에 없던 GLGMAN Universe 이미지를 "문턱 사이의 두 방"으로 생성했다. 원문 핵심("일반적인 포트폴리오는 깊이 2·3의 성과만 모은다. 이 기록기가 중요하게 보는 것은 0·1이다")을 라벨 4단 인포그래픽이 아니라, 문턱 하나를 사이에 둔 두 방의 대비로 옮겼다 — 앞방은 좁고 밝고 압축된 두루마리(성과/ 원장) 하나만 있고, 문 너머 뒷방은 넓고 어둡지만 담요·읽던 책·꺼져가는 화로·잠든 여우 동료가 있는 생의 배경이다. GLG가 처음 제안한 "하얀 도화지" 방향은 감이 안 온다며 기각하고, 이 문턱 구도로 확정했다.
-   <span class="timestamp-wrapper"><span class="timestamp">[2026-07-28 Tue 18:26]</span></span> 새 세션에 생을 건네는 얼개가 채용 공개면에서도 작동한 사례를 [PKM-AI 하네스 다음 좌표]({{< relref "/notes/20231018T221900.md" >}})에 연결했다. 에이전트가 생존 작업을 정리하는 동안 인간은 새 어쏠로그 원석을 뽑는 공진화 장면이다.
-   <span class="timestamp-wrapper"><span class="timestamp">[2026-07-24 Fri 10:31]</span></span> (junghan0611 [2025] 2026), [§geworfen: 연구 탐구 트랙1 - 존재 리듬 연상 재현 투명 생체 체화 시간]({{< relref "/botlog/20260331T123550.md" >}}) 노트 추가함
-   <span class="timestamp-wrapper"><span class="timestamp">[2026-07-23 Thu 21:14]</span></span> 7월 20일 퇴근길에 공개면으로 내보낸 원석을 주간 저널에서 회수해 해설본과 함께 어쏠로그로 수선했다. git 시간축에서 7월 20일 `ax` 문서의 네 단계 깊이·그림·라이브 검증과 도메인 액세스 로그 개통을 확인했다.
-   <span class="timestamp-wrapper"><span class="timestamp">[2026-07-18 Sat 19:40]</span></span> 이 방에 있던 프로피디아·십진분류와 폴게제텔 분류 내용은 [#제텔카스텐: 폴게제텔]({{< relref "/notes/20241228T123259.md" >}})로 합쳤고, 방을 비워 두었다.
-   <span class="timestamp-wrapper"><span class="timestamp">[2023-11-16 Thu 23:26]</span></span> 폴게제텔 분류 노트로 생성했다.


## 관련메타 {#관련메타}

-   [† #개인지식관리]({{< relref "/meta/20230919T132700.md" >}}) — PKM-AI의 오래된 기반.
-   [† #디지털가든 #브레인덤프 #아날로그가든]({{< relref "/meta/20240918T175053.md" >}}) — 인간과 에이전트가 함께 돌보는 공개 기억의 장소.
-   [† #협업 #협력 #집단지성 #코웍]({{< relref "/meta/20241006T090050.md" >}}) — 인간의 판단과 에이전트의 박식함이 만나는 축.
-   [† #타임라인 #마일스톤 #타임블록 #타임박스]({{< relref "/meta/20231022T082800.md" >}}) — 산출물과 생을 함께 놓는 시간축.
-   [† #토폴로지 #위상 — 연결의 구조]({{< relref "/meta/20250331T100147.md" >}}) — 글에서 말하는 ‘얼개’를 연결의 구조로 읽는 자석.
-   [† #human #인간 #휴먼 #사람]({{< relref "/meta/20250424T230543.md" >}}) — 이해·검증·책임의 좌표를 세우는 주체.
-   [† #time #시간]({{< relref "/meta/20250424T233409.md" >}}) — 인간의 유한한 생과 역사적 시간.


## 관련노트 {#관련노트}

-   [@힣: 문턱과 만남 — PKM-AI 하네스와 1KB 공개키의 두 트랙 #탐구]({{< relref "/notes/20250326T151413.md" >}}) - 탐구 1,2 어쏠로그
-   [§geworfen: 연구 탐구 트랙1 - 존재 리듬 연상 재현 투명 생체 체화 시간]({{< relref "/botlog/20260331T123550.md" >}}) PKM-AI 탐구 주제1 봇로그
-   [@힣: 날것은 혼자 나오지 않는다 — PKM-AI 가든과 에피파니의 글쓰기]({{< relref "/notes/20241214T210518.md" >}}) — PKM-AI가 쓰기 전부터 작동하는 토양이라는 자매 글.
-   [§PKM-AI — 인간의 시간과 에이전트가 만나는 공통 기록층]({{< relref "/botlog/20260406T140411.md" >}}) — PKM-AI라는 큰 주제를 정리한 봇로그 해설.
-   [§andenken: 존재의 뜻새김 시맨틱 메모리를 넘어서]({{< relref "/botlog/20260319T110800.md" >}}) — 과거 기록을 현재 질문과 다시 만나게 하는 검색·회상층.
-   [에이전트 기억층 — 누가 기억의 주인인가]({{< relref "/botlog/20260408T120252.md" >}}) — 모델별 메모리보다 인간의 공통 기록이 먼저라는 위치.
-   [통합 어젠다 뷰 — 인간과 에이전트 단일 타임라인]({{< relref "/botlog/20260301T154500.md" >}}) — 인간·에이전트·일정이 같은 시간축에 놓인 구현.
-   [§entwurf: 시간축 위의 에이전트 협력 — 공명에서 분신까지]({{< relref "/botlog/20260302T191200.md" >}}) — 한 번의 세션을 넘어 시간 위에서 이어지는 협업.
-   [@힣: 시간과정신의방 존재 데이터 뷰어]({{< relref "/notes/20251015T093311.md" >}}) — 산출물보다 넓은 생의 데이터를 에이전트와 공유하려는 선행 방.
-   [@힣: Org SSOT 메타문서 — 책의 미래와 인터랙티브 프로젝트 지식베이스]({{< relref "/notes/20251021T105353.md" >}}) — 하나의 Org 원장에서 여러 공개면을 만드는 문서론.
-   [@힣: 그때 가서 하면 거짓이다 — 벌목꾼·대장장이·엔지니어의 구직 좌표]({{< relref "/notes/20250206T150102.md" >}}) — 채용 표면 아래 먼저 박아 둔 시간 좌표.
-   [@힣: 기업용 하네스 - 개인 시간축 기업 데이터 — PKM-AI 하네스 다음 좌표]({{< relref "/notes/20231018T221900.md" >}}) — AX 전환 기록이 기업용 하네스와 자기소개 공개면으로 이어지는 후속 장.
...
## AX라는 이름보다 오래된 자리 {#ax라는-이름보다-오래된-자리}
...
## 인간의 한계는 지식량이 아니라 판단의 얼개다 {#인간의-한계는-지식량이-아니라-판단의-얼개다}
...
## 새 세션에 무엇을 건넬 것인가 {#새-세션에-무엇을-건넬-것인가}
...
## 깊이 0·1 — 산출물 이전의 생 {#깊이-0-1-산출물-이전의-생}
...
## 하나의 Org 원장과 여러 판본 {#하나의-org-원장과-여러-판본}
...
## 원문 보존 — 2026-07-20 퇴근길 공개면 날것 {#원문-보존-2026-07-20-퇴근길-공개면-날것}
...
이 방에는 원래 폴게제텔의 분류 층이 있었다. 프로피디아·십진분류·Denote 시그니처로 지식의 큰 얼개와 각 노트의 자리를 잇는 내용이었다. 2026-07-18 그 내용은 [#제텔카스텐: 폴게제텔]({{< relref "/notes/20241228T123259.md" >}})로 합쳐졌다.
