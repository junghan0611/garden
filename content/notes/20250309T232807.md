---
title: "#이맥스 #조테로 #조직모드 #리딩리스트 #관리 #코드"
date: 2025-03-09T23:28:00+09:00
lastmod: 2025-03-09T00:00:00+09:00
tags: ["biblatex", "citar", "emacslisp", "reading", "bibtex"]
categories: ["Noname"]
draft: false
---
...
<style>.csl-entry{text-indent: -1.5em; margin-left: 1.5em;}</style><div class="csl-bib-body">
  <div class="csl-entry"><a id="citeproc_bib_item_1"></a>Kremers, J. (2025). <i>Joostkremers/ebib</i> [Computer software]. <a href="https://github.com/joostkremers/ebib">https://github.com/joostkremers/ebib</a> (2010)</div>
</div>


## Related Notes {#related-notes}

-   [org-books #도서목록관리 #이맥스]({{< relref "/notes/20250309T194056.md" >}}) 이게 필요 없을 것 같아


## History {#history}

-   <span class="timestamp-wrapper"><span class="timestamp">[2025-03-09 Sun 23:28] </span></span> [#조테로]({{< relref "/meta/20240320T110018.md" >}})를 사용하니까 여기 맞춰서 필요한 기능을 만들었다. 이렇게 해야 깔끔하다.
...
## <span class="timestamp-wrapper"><span class="timestamp">[2025-03-11 Tue 10:13] </span></span> 현재 버전 동작 방식 {#현재-버전-동작-방식}
...
처음에는 ebib (<a href="#citeproc_bib_item_1">Kremers, 2010/2025</a>)를 고민해봤다. 실제 비슷하게 관리도 가능하다. 근데 citar 인터페이스를 안쓸 필요가 있는가?!

그래서 기본 citar 인터페이스로 만들었다. 어짜피 내부에서 ol-bibtex.el를 사용해야 한다. 빌트인이다.

여러개를 한번에 넣을 수도 있다.

{{< figure src="~/screenshot/20250311T101403--citar-readinglist.png" >}}
...
### 그 다음에 org-books을 이용한 읽기와 별점 그리고 내보내기 {#그-다음에-org-books을-이용한-읽기와-별점-그리고-내보내기}
