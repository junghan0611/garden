...
tags: ["biblatex", "citar", "emacslisp", "llmlog", "reading"]
categories: ["Noname"]
draft: false
---
...
<style>.csl-entry{text-indent: -1.5em; margin-left: 1.5em;}</style><div class="csl-bib-body">
  <div class="csl-entry">NO_ITEM_DATA:joostkremersebib25</div>
</div>
...
처음에는 ebib (NO_ITEM_DATA:joostkremersebib25)를 고민해봤다. 실제 비슷하게 관리도 가능하다. 근데 citar 인터페이스를 안쓸 필요가 있는가?!
