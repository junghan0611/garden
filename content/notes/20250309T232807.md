...
<style>.csl-entry{text-indent: -1.5em; margin-left: 1.5em;}</style><div class="csl-bib-body">
  <div class="csl-entry">Kremers, J. (2025). <i>Joostkremers/ebib</i> [Computer software]. <a href="https://github.com/joostkremers/ebib">https://github.com/joostkremers/ebib</a> (2010)</div>
</div>
...
처음에는 ebib (Kremers, 2010/2025)를 고민해봤다. 실제 비슷하게 관리도 가능하다. 근데 citar 인터페이스를 안쓸 필요가 있는가?!
