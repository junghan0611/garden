...
-   [ ] 1-4. OpenCode에 emacs-elisp-dev 서버 등록 \`\`\`jsonc
    ...
    "mcp": { "emacs-elisp-dev": { "type": "local", "command": [ "node", "/home/tbdhny/repos/3rd/elisp-dev-mcp/build/index.js" ], "environment": { "EMACS_SERVER_FILE": "/tmp/emacs1000/server" }, "enabled": true } } \`\`\`
...
"emacs-elisp-dev": { "type": "local", "command": ["node", "/home/tbdhny/repos/3rd/elisp-dev-mcp/build/index.js"], "environment": { "EMACS_SERVER_FILE": "/tmp/emacs1000/server" }, "enabled": true }
