...
description: "클로저를 중심으로 함수형 프로그래밍 핵심 개념을 번역 메모와 함께 차근차근 정리해 가려는 노트."
date: 2023-11-14T14:35:00+09:00
lastmod: 2025-03-20T00:00:00+09:00
tags: ["clojure", "concepts", "functional", "notes", "programming"]
categories: ["Noname"]
draft: false
---
...
-   <span class="timestamp-wrapper"><span class="timestamp">[2022-05-21 Sat 14:35]</span></span> 로그시크에 작성해 둔 것


## 동질성 : 함수형 프로그래밍 언어 클로저 {#동질성-함수형-프로그래밍-언어-클로저}

<span class="timestamp-wrapper"><span class="timestamp">[2022-05-21 Sat 14:35]</span></span>
...
## 2022 함수형 프로그래밍의 개념을 다룬다. {#2022-함수형-프로그래밍의-개념을-다룬다-dot}
...
### Simple Recursion -- [Recursion](#recursion) {#simple-recursion-recursion--org88f14de}
...
#### [BROKEN LINK: Recursion/Tail-Recursion] 끝 재귀 이슈가 있다. {#broken-link-recursion-tail-recursion-끝-재귀-이슈가-있다-dot}
...
#### [BROKEN LINK: Recursion/Self-Recursion] with recur [BROKEN LINK: \_recur] {#broken-link-recursion-self-recursion-with-recur-broken-link-recur}
...
### [BROKEN LINK: Coin Tossing] 동전 던지기 예를 통해서 Lazy 프로그래밍 기법을 더 다룬다. {#broken-link-coin-tossing-동전-던지기-예를-통해서-lazy-프로그래밍-기법을-더-다룬다-dot}
...
<span class="timestamp-wrapper"><span class="timestamp">[2025-03-20 Thu 15:31]</span></span>


### Persistent Data Structure {#persistent-data-structure}

<span class="timestamp-wrapper"><span class="timestamp">[2025-03-20 Thu 15:32]</span></span>
...
<span class="timestamp-wrapper"><span class="timestamp">[2025-03-20 Thu 15:33]</span></span>
