---
title: "#EKG: #이맥스 #지식그래프 #활용법"
description: "EKG를 이맥스 지식그래프 도구로 실제 워크플로우에 붙일 수 있을지 검토한 활용 실험 노트."
date: 2024-02-13T14:44:00+09:00
lastmod: 2025-04-02T00:00:00+09:00
tags: ["bib", "ekg", "howtouse"]
categories: ["Noname"]
draft: false
---
...
<div class="csl-bib-body">
  <div class="csl-entry"><a id="citeproc_bib_item_1"></a><i>Ekg 0.7.0: Search</i>. n.d. Accessed April 20, 2025. <a href="https://youtube.com/watch?v=c93fVCE6Xt4">https://youtube.com/watch?v=c93fVCE6Xt4</a>.</div>
</div>


## 히스토리 {#히스토리}

-   <span class="timestamp-wrapper"><span class="timestamp">[2026-08-12 Wed 14:33]</span></span> @mitsein/sonnet-5 — 세션태그 자석과 세트로 수선. 첫 줄의 즉흥 링크를 관련메타로 승격하고 관련노트 헤딩 신설.
-   <span class="timestamp-wrapper"><span class="timestamp">[2025-04-20 Sun 16:34]</span></span> <span class="org-mention">@junghan</span> — EKG 0.7.0 검색 업데이트 절 추가.
-   <span class="timestamp-wrapper"><span class="timestamp">[2024-02-13 Tue 14:44]</span></span> <span class="org-mention">@junghan</span> — Org-mode와 EKG 연결 실험 기록 시작.


## 관련메타 {#관련메타}

-   [† #이맥스 #지식그래프]({{< relref "/meta/20230223T053200.md" >}}) — EKG 메타. 이 노트의 뿌리.


## 관련노트 {#관련노트}

-   [데이터베이스 vs 파일 - #노트 #개인지식관리 #규칙]({{< relref "/notes/20230223T054600.md" >}}) — 같은 2023-02 EKG 실험 계열, 규칙 쪽.
-   [@힣: 세션도 태그로 줄 세운다 — EKG 감각이 대화 더미를 만날 때]({{< relref "/notes/20240220T091923.md" >}}) — 이 감각을 대화 세션에 얹은 후속.
...
## 2025 EKG 0.7.0: Search EKG 0.7.0 {#2025-ekg-0-dot-7-dot-0-search-ekg-0-dot-7-dot-0}

(<a href="#citeproc_bib_item_1"><i>Ekg 0.7.0: Search</i> n.d.</a>)

<span class="timestamp-wrapper"><span class="timestamp">[2025-04-20 Sun 16:34]</span></span>
