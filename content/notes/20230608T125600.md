...
description: "리눅스 작업 흐름에 맞는 정지 화면·GIF 스크린샷 도구와 활용 시나리오를 실전 중심으로 정리한 자료."
date: 2023-06-08T12:56:00+09:00
lastmod: 2025-05-19T00:00:00+09:00
tags: ["bib", "emacs", "gif", "notes", "screenshot", "tools"]
categories: ["Noname"]
draft: false
---
...
> [!abstract] 이 노트에 대하여
> 
> 리눅스 작업 흐름에 맞는 정지 화면과 GIF 스크린샷 도구를 비교하며 활용 시나리오를 정리한다. 문서화와 데모 제작을 위해 어떤 캡처 방식이 효율적인지 고민한 흔적이 담겨 있다.
