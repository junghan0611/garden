...
<style>.csl-entry{text-indent: -1.5em; margin-left: 1.5em;}</style><div class="csl-bib-body">
  <div class="csl-entry">Firat. (2024). <i>Firatkiral/pypeek peek screen recorder and screenshot with annotation</i> [Computer software]. <a href="https://github.com/firatkiral/pypeek">https://github.com/firatkiral/pypeek</a> (2022)</div>
  <div class="csl-entry">Yaslem, S. (2024). <i>Xlmnxp/blue-recorder</i> [Computer software]. <a href="https://github.com/xlmnxp/blue-recorder">https://github.com/xlmnxp/blue-recorder</a> (2021)</div>
</div>
