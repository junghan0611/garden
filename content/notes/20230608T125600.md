---
title: "워크플로우 리눅스 스크린샷 GIF 터미널 데모 도구"
description: "리눅스 작업 흐름에서 정지 화면, GIF, 터미널 데모를 어떻게 뽑아 문서와 README에 붙일지 도구와 실제 제작 흐름을 함께 정리한 노트다."
date: 2023-06-08T12:56:00+09:00
lastmod: 2026-04-30T15:53:00+09:00
tags: ["asciinema", "bib", "documentation", "emacs", "gif", "screenshot", "terminal", "tools"]
categories: ["Noname"]
draft: false
---
...
<div class="csl-bib-body">
  <div class="csl-entry"><a id="citeproc_bib_item_1"></a>“Firatkiral/Pypeek Peek Screen Recorder and Screenshot with Annotation.” 2024. <a href="https://github.com/firatkiral/pypeek">https://github.com/firatkiral/pypeek</a>.</div>
  <div class="csl-entry"><a id="citeproc_bib_item_2"></a>“Xlmnxp/Blue-Recorder.” 2024. <a href="https://github.com/xlmnxp/blue-recorder">https://github.com/xlmnxp/blue-recorder</a>.</div>
</div>
...
## <span class="org-hashtag">#리눅스</span> <span class="org-hashtag">#애플리케이션</span> {#리눅스-애플리케이션}
...
### <span class="org-todo done DONE">DONE</span> Blue-Recorder {#blue-recorder}
...
(<a href="#citeproc_bib_item_2">“Xlmnxp/Blue-Recorder” 2024</a>)
...
### firatkiral/pypeek Peek screen recorder and screenshot with annotation {#firatkiral-pypeek-peek-screen-recorder-and-screenshot-with-annotation}

(<a href="#citeproc_bib_item_1">“Firatkiral/Pypeek Peek Screen Recorder and Screenshot with Annotation” 2024</a>) Firat 2024

Peek screen recorder and screenshot with annotations


#### <span class="org-todo done DONT">DONT</span> pypeek : gif screenshot on linux {#h-6e93802b-8cc5-43f3-849f-d48654327e55}


### <span class="org-todo done DONT">DONT</span> kazam {#kazam}


### <span class="org-todo done DONT">DONT</span> kooha {#kooha}


## <span class="org-hashtag">#이맥스</span> <span class="org-hashtag">#패키지</span> <span class="org-hashtag">#스크린샷</span> {#이맥스-패키지-스크린샷}

<span class="timestamp-wrapper"><span class="timestamp">[2023-06-08 Thu 14:56]</span></span> 아래 2 개가 최종 남았다. 각각은 훌륭하다. 이렇게 가져가면 된다.


### <span class="org-todo done DONE">DONE</span> gif-screencast {#gif-screencast}
...
## <span class="org-hashtag">#온라인</span> <span class="org-hashtag">#업로드</span> {#온라인-업로드}

<span class="timestamp-wrapper"><span class="timestamp">[2024-10-11 Fri 15:53]</span></span>


### Imgur (Upload) : 온라인 업로드 {#imgur--upload--온라인-업로드}
...
## <span class="org-todo done DONE">DONE</span> asciinema + agg — README용 터미널 GIF 문서화 {#asciinema-plus-agg-readme용-터미널-gif-문서화}
