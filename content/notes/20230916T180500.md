...
[SYS]: You are a helpful assistant. Please write in Korean language. @user editorconfig에 대해서 알려줘

@assistant EditorConfig는 여러 코드 편집기와 IDE에서 일관된 코딩 스타일을 유지할 수 있도록 도와주는 도구입니다. 이 도구는 프로젝트마다 다른 스타일 규칙을 정의하고, 이를 코드 편집기가 자동으로 적용할 수 있게 합니다.
