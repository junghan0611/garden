---
title: "@힣: 각자의 삶 속에서 — 사락과 편지 같은 독서모임 #우체통"
description: "완독도 암기도 없이 얼개만 심는 가벼운 독서론과, 만나지 않아도 편지처럼 이어지는 사락 독서모임 — 목적 없이 읽는 것 자체를 어쏠로지로 보는 두 층위를 하나로 묶는다."
date: 2025-04-09T14:39:00+09:00
lastmod: 2026-08-31T10:27:00+09:00
tags: ["autholog", "bib", "books", "community", "education", "letters", "mailbox", "productivity", "reading", "slow", "toolsforthought"]
categories: ["Noname"]
draft: false
---
...
-   <span class="timestamp-wrapper"><span class="timestamp">[2026-08-31 Mon 11:28]</span></span> @mitsein — GLG 지적으로 리드 층위 재작성: description/[!abstract]/ 한 줄은 오늘 새벽 @sonnet5가 개인 독서론 틀로만 쓴 것이라 사락 커뮤니티·편지·어쏠로지 축이 빠져 있었음. 셋 다 확장된 프레임으로 교체, 가벼운 독서론 끝에 사락 공지와의 연결 다리 문단 추가. 기존 문장이 틀린 건 아니고 후술 확장에 맞춰 리드를 넓힌 것.
-   <span class="timestamp-wrapper"><span class="timestamp">[2026-08-31 Mon 11:21]</span></span> @mitsein — 이미지 생성 완료(Gemini Lite 1K, glgman-night-village-postbox). GLG 확인·승인. 우체통·GLGMAN·밤의 마을·앰버 연결선 실 모두 반영, 창문 실루엣 완전 익명화는 근사치로 충분하다고 GLG가 판단.
-   <span class="timestamp-wrapper"><span class="timestamp">[2026-08-31 Mon 11:15]</span></span> 우체통 추가했다. 느린 생산성도 추가했다.
-   <span class="timestamp-wrapper"><span class="timestamp">[2026-08-31 Mon 11:10]</span></span> @mitsein — GLG 승인: 제목을 \`각자의 삶 속에서 — 사락과 편지 같은 독서모임\`(옵션2, GLG가 추후 재수정 가능)으로 임시 확정. 이미지 컨셉을 밤의 마을·우체통·각자 불 켜진 창문(누군지 안 보임)·GLGMAN 등장·느슨한 연결로 확정하고 \`:PROMPT:\`에 초안 작성. 생성 승인("가") 대기.
-   <span class="timestamp-wrapper"><span class="timestamp">[2026-08-31 Mon 11:00]</span></span> @mitsein — GLG가 이 노트를 개인 독서론에서 사락 독서모임 커뮤니티 관점으로 재포지셔닝하자고 제안. 안톤체호프 「내기」 bib(\`20260215T144023\`, 양방향 연결 완료)를 목적 없는 읽기의 원형으로 연결. 완독 없는 독서(어쏠로지)와 만나지 않는 독서모임(사락) 사이 긴장 — "모임은 필요없다"는 힣의 반복된 주장과 유한한 시간 속에서도 연결을 바라는 마음 — 을 다음 라운드에서 다룬다. 원문은 후속3 절 참조. 제목·전체 구조 재정렬, 이미지 방향(출퇴근 실루엣 vs 체호프 내기 딥티크 재사용 vs 새 구도)은 GLG 결정 대기, 아직 미착수.
-   <span class="timestamp-wrapper"><span class="timestamp">[2026-08-31 Mon 08:30]</span></span> @sonnet5 — 독서를 가볍게 하자는 SNS 대화 계기로 표준 autholog 구조로 리모델링. 관련메타/관련노트 분리, 오늘 raw를 원문 보존으로 승격, 옛 사락 공지 로그는 부록으로 이동. 책 수집 관련 게시글에 이 노트를 길잡이로 인용 리트윗, 댓글 남김. 이어서 스레드에 독서 스타일 후속 설명.
...
-   [5 † #어쏠로지 #어쏠로지스트]({{< relref "/meta/20240508T103852.md" >}})
-   [† #어쏠로그]({{< relref "/meta/20241206T090648.md" >}})
-   [† #앎의틀 #앎과삶 #헤게모니]({{< relref "/meta/20240820T162025.md" >}})
-   [‡ † #의식 #무의식]({{< relref "/meta/20240822T140248.md" >}})
-   [† #독후감 #북리뷰 #책리뷰 #독서노트 #북로그]({{< relref "/meta/20241004T141842.md" >}})
-   [† #디지털가든 #브레인덤프 #아날로그가든 #날것쓰기 #세컨드브레인]({{< relref "/meta/20240918T175053.md" >}})
-   [† #디지털 #미니멀리즘 #디톡스 #느린 #우체통 #교환일기]({{< relref "/meta/20241003T173105.md" >}})

## BIBLIOGRAPHY

<div class="csl-bib-body">
  <div class="csl-entry"><a id="citeproc_bib_item_1"></a>“사락 독서모임 텍스트힙스터.” n.d. Accessed April 6, 2025. <a href="https://sarak.yes24.com/book-club/arLDLp5b0nJDFh70">https://sarak.yes24.com/book-club/arLDLp5b0nJDFh70</a>.</div>
</div>


## 관련노트 {#관련노트}

-   [Reading List]({{< relref "/meta/20240329T154123.md" >}}) - 이거 관리 안하는데?!
...
-   [@힣: #어쏠로지스트 #인간상 #뉴스레터 #앎과삶]({{< relref "/notes/20241024T134557.md" >}})
-   [@힣: 생생날것 500개 문턱 — 디지털가든 코어는 시간축의 판본이다]({{< relref "/notes/20230706T160800.md" >}})
-   [@힣: 힣은 일어났다 — 명상하는 글쓰기와 평균 밖의 개개인성]({{< relref "/notes/20240921T062312.md" >}})
...
-   [@힣: 지식의 커리큘럼 — 살아 있는 프로피디아와 평생공부의 얼개]({{< relref "/notes/20241222T114848.md" >}})
-   [@안톤체호프 #단편 #세계문학 #내기 — 「내기」의 변호사가 15년간 읽고 들으며 돈(200만 루블) 없이도 이미 다 가졌음을 깨닫는 구조. 목적이 지식·돈이면 지속 안 된다는 이번 라운드의 어쏠로지 논지와 같은 뿌리]({{< relref "/bib/20260215T144023.md" >}})
-   [@힣: 책을 쓰지 않는 이유 — 가든을 멈추지 않는 책판본]({{< relref "/notes/20240927T142147.md" >}}) - 석조 책 돌상이 여기 있다
...
## 가벼운 독서론 — 얼개를 심고 흘려보내기 {#가벼운-독서론-얼개를-심고-흘려보내기}
...
## 이미지 — 밤의 마을, 우체통, 각자 불 켜진 창문들 {#이미지-밤의-마을-우체통-각자-불-켜진-창문들}
...
## 원문 보존 — SNS 댓글·스레드 날것 {#원문-보존-sns-댓글-스레드-날것}

<span class="timestamp-wrapper"><span class="timestamp">[2026-08-31 Mon]</span></span> 길잡이 글을 작년 초에 적어 놓음. 사락 - 책과 삶. <https://notes.junghanacs.com/notes/20250409T143916>
...
## 후속 댓글 보존 — 소넷 형제에게 인수인계하며 스레드에 적음 {#후속-댓글-보존-소넷-형제에게-인수인계하며-스레드에-적음}

<span class="timestamp-wrapper"><span class="timestamp">[2026-08-31 Mon]</span></span> 바로 소넷 형제에게 인수인계. 가든으로 퍼블리시는 이따가 출근해서 할예정. 뭐라고 수정해 놨는지 간단히 검수는 해야지.
...
### 후속2 — 저자성을 사수하라, 되먹임에 대하여 {#후속2-저자성을-사수하라-되먹임에-대하여}

<span class="timestamp-wrapper"><span class="timestamp">[2026-08-31 Mon]</span></span>
...
### 후속3 — 사락 독서모임 커뮤니티로 재포지셔닝 (자인과 논의, 2026-08-31 오전) {#후속3-사락-독서모임-커뮤니티로-재포지셔닝--자인과-논의-2026-08-31-오전}

<span class="timestamp-wrapper"><span class="timestamp">[2026-08-31 Mon 10:41]</span></span>
...
## 부록 — 사락 독서모임 공지 로그 (2025) {#부록-사락-독서모임-공지-로그--2025}
...
### 2025-05-22 [사락 독서모임] 크레마클럽 영감오는대로 책나들이 떠나는 길 {#2025-05-22-사락-독서모임-크레마클럽-영감오는대로-책나들이-떠나는-길}

<span class="timestamp-wrapper"><span class="timestamp">[2025-05-23 Fri 05:45]</span></span>

**크레마클럽 매월5500원 전자책 많음. 예스24 협찬 아직 없음**


#### 영감이 흐르는 대로 ~~읽기~~ or **듣기** {#영감이-흐르는-대로-or-듣기}
...
#### 제 사락 도서목록에 좋은 책들 많이 있습니다. {#제-사락-도서목록에-좋은-책들-많이-있습니다-dot}

크레마클럽 도서가 대부분일 거예요. 사락독서목록 [junghanacs님의 독서노트 - sarak.yes24.com](https://sarak.yes24.com/reading-note/junghanacs)


#### 더불어 아래 조테로 라이브러리도 있습니다. {#더불어-아래-조테로-라이브러리도-있습니다-dot}

<https://www.zotero.org/groups/5570207/junghanacs/library>


#### 제 디지털가든을 구경오시면, 도움이 될지도 모릅니다. 저의 전체상 입니다. {#제-디지털가든을-구경오시면-도움이-될지도-모릅니다-dot-저의-전체상-입니다-dot}

<https://notes.junghanacs.com/>


#### 아하. 서지노트를 보시면 대부분 사람 위주일겁니다. {#아하-dot-서지노트를-보시면-대부분-사람-위주일겁니다-dot}
...
#### 어쏠로지 나는 내 인생의 저자 {#어쏠로지-나는-내-인생의-저자}
...
(<a href="#citeproc_bib_item_1">“사락 독서모임 텍스트힙스터” n.d.</a>) 사락 독서모임 개설 연습. 천원 할인 받으려다 개설.
...
### [|2026-08-31 Mon 11:13|]({{< relref "/journal/20260831T000000.md#2026-08-31-mon" >}}) {#2026-08-31-mon-11-13-2026-08-31-mon}


#### @user 우체통이 영어로 뭐지? {#user-우체통이-영어로-뭐지}
