...
<style>.csl-entry{text-indent: -1.5em; margin-left: 1.5em;}</style><div class="csl-bib-body">
  <div class="csl-entry"><a id="citeproc_bib_item_1"></a><i>Creating info manuals and adding them into emacs</i>. (n.d.). Retrieved November 6, 2024, from <a href="https://blog.nawaz.org/posts/2023/Mar/creating-info-manuals-and-adding-them-into-emacs/">https://blog.nawaz.org/posts/2023/Mar/creating-info-manuals-and-adding-them-into-emacs/</a></div>
  <div class="csl-entry"><a id="citeproc_bib_item_2"></a>Petersen, M. (n.d.). <i>Full text searching in info mode with apropos</i>. Mastering Emacs. Retrieved July 3, 2024, from <a href="https://www.masteringemacs.org/article/full-text-searching-info-mode-apropos">https://www.masteringemacs.org/article/full-text-searching-info-mode-apropos</a></div>
</div>


## 히스토리 {#히스토리}

-   <span class="timestamp-wrapper"><span class="timestamp">[2025-03-19 Wed 19:16] </span></span> 이미지 링크 수정
-   <span class="timestamp-wrapper"><span class="timestamp">[2022-10-04 Tue 15:01] </span></span> 생성
...
## Full text searching in Info mode with Apropos {#full-text-searching-in-info-mode-with-apropos}

(<a href="#citeproc_bib_item_2">Petersen, n.d.</a>)
...
(<a href="#citeproc_bib_item_1"><i>Creating Info Manuals and Adding Them into Emacs</i>, n.d.</a>)
...
{{< figure src="~/screenshot/20221004T16-33.png" >}}


#### 함수 맵을 보라 {#함수-맵을-보라}

{{< figure src="~/screenshot/20221004T17-24.png" >}}
...
`o` ace-link-info 이게 있다!! ![](~/screenshot/20221004T19-09.png)
...
-   {{< figure src="~/screenshot/20221004T15-15.png" >}}

<!--listend-->

-   {{< figure src="~/screenshot/20221004T15-15-1.png" >}}
