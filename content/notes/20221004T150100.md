...
description: "이맥스 Info 매뉴얼을 로컬에서 읽고 apropos와 함께 활용하는 기본 접근법을 정리한 기록."
...
<div class="csl-bib-body">
  ...
  <div class="csl-entry"><a id="citeproc_bib_item_2"></a>Petersen, Mickey. n.d. “Full Text Searching in Info Mode with apropos.” Accessed July 3, 2024. <a href="https://www.masteringemacs.org/article/full-text-searching-info-mode-apropos">https://www.masteringemacs.org/article/full-text-searching-info-mode-apropos</a>.</div>
</div>
...
## "Creating Info Manuals And Adding Them Into~Emacs" <span class="org-hashtag">#인포모드</span> 통합 전략 {#creating-info-manuals-and-adding-them-into-emacs-인포모드-통합-전략}
