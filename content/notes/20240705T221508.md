...
tags: ["coq", "emacs", "howtouse", "ide", "install", "proofassistants"]
categories: ["Noname"]
draft: false
---
...
Make sure you have Coq installed and that the <kbd>coqtop</kbd> command is available. This comes with a standard installation of Coq. You can use your linux distribution's Coq package or one of the methods given on the [Coq website](https://coq.inria.fr/download).
...
A generic Emacs interface for proof assistants. (dev team n.d.) "Proof General - A generic Emacs interface for proof assistants."
...
<style>.csl-entry{text-indent: -1.5em; margin-left: 1.5em;}</style><div class="csl-bib-body">
  <div class="csl-entry">team, The PG dev. n.d. “Proof General - a Generic Emacs Interface for Proof Assistants.” Accessed July 5, 2024. <a href="https://proofgeneral.github.io/">https://proofgeneral.github.io/</a>.</div>
</div>
