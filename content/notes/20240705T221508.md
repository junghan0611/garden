...
A generic Emacs interface for proof assistants. (<a href="#citeproc_bib_item_1">dev team, n.d.</a>) "Proof General - A generic Emacs interface for proof assistants."
...
<style>.csl-entry{text-indent: -1.5em; margin-left: 1.5em;}</style><div class="csl-bib-body">
  <div class="csl-entry"><a id="citeproc_bib_item_1"></a>dev team, T. P. (n.d.). <i>Proof general - a generic emacs interface for proof assistants.</i> Retrieved July 5, 2024, from <a href="https://proofgeneral.github.io/">https://proofgeneral.github.io/</a></div>
</div>
