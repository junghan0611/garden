...
For some reason, installing [consult-omni](https://github.com/armindarvish/consult-omni) using the <kbd>:vc</kbd> keyword was giving me problems, so I checked it out from Github instead.
...
<style>.csl-entry{text-indent: -1.5em; margin-left: 1.5em;}</style><div class="csl-bib-body">
  ...
  <div class="csl-entry">“프로그래밍 검색 - 모든 검색엔진 - 구글 커스텀 검색 엔진.” n.d. Accessed April 11, 2025. <a href="https://programmablesearchengine.google.com/controlpanel/all">https://programmablesearchengine.google.com/controlpanel/all</a>.</div>
</div>
