---
title: "@힣: 링크드인 소개 업데이트 — 이력서가 아니라 시간축이 증언하는 공개키 #직무 #보유기술"
description: "2026년 7월 링크드인 소개를 새로 쓰며, 벌목꾼·대장장이 같은 존재어를 공개 채용면의 공용어로 번역한 원석을 보존한다. 이력서는 꾸민 파사드가 아니라 가든·커밋·저널·봇로그가 증언하는 시간축의 얇은 공개키라는 점을 밝힌다."
date: 2025-05-15T10:39:00+09:00
lastmod: 2026-07-29T06:24:00+09:00
tags: ["ai", "autholog", "career", "pkmai", "profile", "resume", "roles", "skills"]
categories: ["Noname"]
draft: false
---
...
> [!abstract] 이 노트에 대하여
> 
> 이 노트는 2026년 7월 28일 저널의 "링크드인 소개 업데이트" 원석을 회수한 autholog다. [자기소개서 히스토리]({{< relref "/notes/20230814T142800.md" >}})와 [추천을 내가 쓰지 않는 법]({{< relref "/notes/20251002T075659.md" >}})은 참고 좌표로 두되, 이 원석은 그 안에 숨기지 않는다. 링크드인이라는 공개 채용면에서 "벌목꾼·대장장이"라는 힣의 존재어를 `Agent Harness Engineering`, `AI Agent Systems`, `Knowledge Engineering`, `Embedded Systems`, `HCI` 같은 공용어로 번역한 사건 자체가 독립 원석이기 때문이다.


## 히스토리 {#히스토리}

-   <span class="timestamp-wrapper"><span class="timestamp">[2026-07-29 Wed 06:24]</span></span> @mitsein — 보유기술·직무 키워드 회수표를 추가했다. `Knowledge Engineering` 은 [지식공학]({{< relref "/notes/20240704T170917.md" >}}) 노트와 연결하고, FDE/Developer Experience Engineer/DXE/DEE 같은 직무 키워드를 검색 가능한 설명층에 명시했다.
-   <span class="timestamp-wrapper"><span class="timestamp">[2026-07-29 Wed 06:14]</span></span> @mitsein — GLG 지시에 따라 빈방 \`20250515T103930\`을 회수했다. 채용 플랫폼 비교 원문은 이미 [구직·채용·SNS 허브]({{< relref "/notes/20250402T191034.md" >}})로 이관되어 있었으므로, 이 ID를 링크드인 소개 업데이트 autholog 방으로 개장했다.
-   <span class="timestamp-wrapper"><span class="timestamp">[2026-07-28 Tue 18:31]</span></span> @mitsein — GLG 지시에 따라 문서를 합쳤다. 기존 채용 플랫폼 비교 llmlog 원문은 [구직·채용·SNS 허브]({{< relref "/notes/20250402T191034.md" >}})의 \`채용 플랫폼 비교 원문 로그\` 섹션으로 이관했고, 이 ID는 빈방으로 돌렸다.
-   <span class="timestamp-wrapper"><span class="timestamp">[2026-07-28 Tue 18:26]</span></span> 독립 노트로 확장하지 않고, 정리본은 [채용·SNS 허브]({{< relref "/notes/20250402T191034.md" >}})가 품도록 했다.
...
-   <span class="timestamp-wrapper"><span class="timestamp">[2025-05-15 Thu 10:39]</span></span> 채용 플랫폼 비교 llmlog 방 생성.


## 관련메타 {#관련메타}

-   [‡ † #기술 #기법]({{< relref "/meta/20240822T141000.md" >}}), [0zq ‡ † #지식]({{< relref "/meta/20250424T230029.md" >}})
-   [† #AX #AI전환 #PKM-AI]({{< relref "/meta/20250328T124902.md" >}}) — 개인의 PKM-AI 언어를 조직과 채용의 공용어로 옮기는 교량.
-   [† #디지털가든 #브레인덤프 #아날로그가든]({{< relref "/meta/20240918T175053.md" >}}) — 자기소개를 단일 문장보다 가든 전체의 공개키로 읽게 하는 기반.
-   [† #글쓰기 #쓰기 #라이팅허브]({{< relref "/meta/20240902T173233.md" >}}) — 원석 날것과 수선된 설명층을 함께 보존하는 글쓰기 축.
-   [† #HCI #인간 #컴퓨터 #인터페이스]({{< relref "/meta/20240516T163116.md" >}}) — 링크드인 프로필과 채용 플랫폼을 인간-에이전트-조직의 접면으로 읽는 축.
-   [† #임베디드시스템 #피지컬컴퓨팅 #펌웨어]({{< relref "/meta/20250516T110351.md" >}}) — 펌웨어·IoT·물리 세계와 맞닿은 하부 시스템 축.
-   [† #메타도구 #대장장이 #호모파베르]({{< relref "/meta/20250224T132139.md" >}}) — 대장장이·도구·접합부의 존재어를 공용 기술어로 번역하는 배경.


## 관련노트 {#관련노트}

-   [@힣: 링크드인 날것 공개면 — AI 크롤러 시대의 손가락 프롬프트]({{< relref "/notes/20250328T090326.md" >}}) — 링크드인을 날것 공개면과 AEO 표면으로 읽은 앞선 장.
-   [@힣: 그때 가서 하면 거짓이다 — 벌목꾼·대장장이·엔지니어의 구직 좌표]({{< relref "/notes/20250206T150102.md" >}}) — "벌목꾼·대장장이"라는 농담 같은 존재어를 먼저 던진 좌표.
-   [@힣: 기업용 하네스 - 개인 시간축 기업 데이터 — PKM-AI 하네스 다음 좌표]({{< relref "/notes/20231018T221900.md" >}}) — 기업용 하네스와 개인 시간축을 채용면으로 연결한 직전 autholog.
-   [@힣: PKM-AI 가드너의 AX 전환 기록기 — 새 세션에 생을 건네는 얼개]({{< relref "/notes/20231116T232654.md" >}}) — 새 세션과 에이전트에게 생을 건네는 PKM-AI/AX 얼개.
-   [@힣: 지식공학 — 개인지식관리·인공지능·PKM-AI 하네스의 관계]({{< relref "/notes/20240704T170917.md" >}}) — `Knowledge Engineering` 을 기억·검색·시간축·도메인 지식의 기술로 회수한 노트.
-   [하네스 엔지니어링: 돌도끼에서 인공지능까지, 도구와 존재의 접합부]({{< relref "/botlog/20260319T152938.md" >}}) — `Agent Harness Engineering` 의 botlog 정본.
-   [§homeagent-config: 임베디드 엔지니어링 - 디바이스 레벨을 에이전트와 조이기]({{< relref "/botlog/20260307T131455.md" >}}) — `Embedded Systems` 가 에이전트·디바이스 레벨과 만나는 botlog.
-   [career 커리어 언어 — 하네스 포지셔닝과 외부 번역] — 하네스 포지셔닝을 외부 직무 언어로 옮기던 llmlog.
-   [#구직 #채용 #업계 #소셜네트워크서비스: ¤링크드인 ¤원티드 ¤잡코리아 ¤리멤버]({{< relref "/notes/20250402T191034.md" >}}) — 이 ID의 옛 본문이 이관된 채용·SNS 허브.
-   [@힣: 자기소개서 히스토리 역사 이력서]({{< relref "/notes/20230814T142800.md" >}}) — 참고했지만 이번 원석을 넣지 않은 장기 자기소개 히스토리.
-   [@힣: 추천을 내가 쓰지 않는 법 — 이력서 공개키 에이전트에게 건네는 부탁]({{< relref "/notes/20251002T075659.md" >}}) — 참고했지만 이번 원석을 넣지 않은 추천/공개키 장.
-   [§junghan0611: 깃허브 프로파일 이력서 — 영문 공개키]({{< relref "/botlog/20260318T183247.md" >}}) — 원문 프롬프트가 참조한 GitHub 프로필·공개 이력서 합본.
...
## 이 방을 고른 이유 {#이-방을-고른-이유}

이 방의 옛 본문은 채용 플랫폼 비교 llmlog였다. 그 원문은 이미 [구직·채용·SNS 허브]({{< relref "/notes/20250402T191034.md" >}})로 합쳐졌고, 이 ID는 "후속 수선을 위한 빈방"으로 남아 있었다. 새 원석은 링크드인이라는 채용 공개면에서 실제 자기소개·보유기술·직무 입구를 다시 잡는 글이다. 그러므로 낡은 채용 플랫폼 방을 비워 둔 채 두는 것보다, 플랫폼 비교의 허물을 벗고 실제 공개 프로필 업데이트의 방으로 회수하는 편이 맞다.

[자기소개서 히스토리]({{< relref "/notes/20230814T142800.md" >}})는 긴 자기서사의 보관소이고, [추천을 내가 쓰지 않는 법]({{< relref "/notes/20251002T075659.md" >}})은 타인이 써 주는 추천과 공개키의 윤리를 다룬다. 이번 글은 둘을 참고하지만, 핵심은 "링크드인 소개를 지금 어떻게 고쳐 썼는가"라는 행위다. 그래서 별도의 autholog로 둔다.


## 공용어로 번역하되 존재어를 잃지 않는다 {#공용어로-번역하되-존재어를-잃지-않는다}
...
## 보유기술·직무 키워드 회수표 {#보유기술-직무-키워드-회수표}
...
|-----------------------|----------------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|------------------------|
| `Agent Harness Engineering` | 에이전트가 일할 수 있는 기반, 하네스·경계·작업면 | [하네스 엔지니어링 botlog]({{< relref "/botlog/20260319T152938.md" >}}), [기업용 하네스 autholog]({{< relref "/notes/20231018T221900.md" >}}), [AX/PKM-AI meta]({{< relref "/meta/20250328T124902.md" >}}) | 이미 강함.               |
| `AI Agent Systems`          | 하네스 위에서 움직이는 분신·에이전트 체계 | [PKM-AI/AX 얼개]({{< relref "/notes/20231116T232654.md" >}}), [PKM-AI 공통 기록층]({{< relref "/botlog/20260406T140411.md" >}}), [분신/ 서브에이전트 meta]({{< relref "/meta/20260323T143428.md" >}}) | agent/systems 언어를 계속 연결. |
| `Knowledge Engineering`     | 기억·검색·시간축·도메인 지식    | [지식공학]({{< relref "/notes/20240704T170917.md" >}}), [컨텍스트 레이어 기술 지도]({{< relref "/notes/20251024T085736.md" >}}), [개인지식관리 meta]({{< relref "/meta/20230919T132700.md" >}}) | 이번에 핵심 보강.        |
| `Embedded Systems`          | 현실 세계와 맞닿는 하부 시스템, 펌웨어·IoT·디바이스 | [임베디드시스템 meta]({{< relref "/meta/20250516T110351.md" >}}), [디바이스 레벨을 에이전트와 조이기]({{< relref "/botlog/20260307T131455.md" >}}), [메모리 대란과 임베디드 개발]({{< relref "/notes/20241019T193836.md" >}}) | 이미 축 있음.            |
| `HCI`                       | 인간이 시스템·에이전트·도구와 관계 맺는 접면 | [HCI meta]({{< relref "/meta/20240516T163116.md" >}}), [인터페이스 meta]({{< relref "/meta/20240822T141024.md" >}}), [링크드인 공개면]({{< relref "/notes/20250328T090326.md" >}})           | 화면보다 작업 흐름의 인터페이스. |

직무 키워드는 아직 별도 meta가 약하다. 지금은 이 autholog와 [기업용 하네스]({{< relref "/notes/20231018T221900.md" >}})가 검색 관문이다.
...
## 이력서가 필요 없는 사람과 그래도 써야 하는 공개면 {#이력서가-필요-없는-사람과-그래도-써야-하는-공개면}
...
여기서 힣의 선택은 이력서를 없애는 것이 아니라, 이력서를 가든의 얇은 문으로 바꾸는 것이다. 문 자체는 짧고 공용어로 쓰인다. 그러나 그 문 뒤에는 [기업용 하네스]({{< relref "/notes/20231018T221900.md" >}}), [구직 좌표]({{< relref "/notes/20250206T150102.md" >}}), [PKM-AI/AX 얼개]({{< relref "/notes/20231116T232654.md" >}}), [링크드인 날것 공개면]({{< relref "/notes/20250328T090326.md" >}})이 연결된다. 공개면의 작은 문구는 단독으로 사람을 증명하지 않는다. 문구가 부르는 시간축이 사람을 증언한다.


## 이미지 — 공개 프로필 문이 시간축으로 열린다 {#이미지-공개-프로필-문이-시간축으로-열린다}
...
{{< figure src="/images/20260729T061223--world-glgman-universe-style-2d__brand_nanobanana.jpg" width="100%" >}}
...
## 원문 보존 — 2026-07-28 저널 날것 {#원문-보존-2026-07-28-저널-날것}
...
이 ID의 옛 씨앗은 "채용 플랫폼 비교"였다. 독립 문서로 둘 이유가 약해져 2026년 7월 28일 [구직·채용·SNS 허브]({{< relref "/notes/20250402T191034.md" >}})의 \`채용 플랫폼 비교 원문 로그\` 섹션으로 이관했다. 이 노트는 그 빈방을 회수해, 플랫폼 비교가 아니라 실제 공개 프로필 업데이트의 원석을 담는다.
