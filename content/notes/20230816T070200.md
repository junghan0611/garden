...
<style>.csl-entry{text-indent: -1.5em; margin-left: 1.5em;}</style><div class="csl-bib-body">
  <div class="csl-entry"><a id="citeproc_bib_item_1"></a>Polygon. (2024). <i>Muisedestiny/zotero-attanger</i> [Computer software]. <a href="https://github.com/MuiseDestiny/zotero-attanger">https://github.com/MuiseDestiny/zotero-attanger</a> (2023)</div>
</div>
