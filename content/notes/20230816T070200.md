---
title: "#조테로: #플러그인 #활용법"
description: "조테로 플러그인과 API 키, 버전 이슈를 실제 설치 경험 기준으로 정리해 둔 활용 메모."
...
<div class="csl-bib-body">
  <div class="csl-entry"><a id="citeproc_bib_item_1"></a>“Muisedestiny/Zotero-Attanger.” 2024. <a href="https://github.com/MuiseDestiny/zotero-attanger">https://github.com/MuiseDestiny/zotero-attanger</a>.</div>
</div>
...
### [#조테로: §zotFile 문서 슬라이드 로컬 저장 연동]({{< relref "/notes/20240705T144627.md" >}}) {#조테로-zotfile-문서-슬라이드-로컬-저장-연동}


### [Better BibTeX 조테로 필수 플러그인 인용키]({{< relref "/bib/20250409T072408.md" >}}) {#better-bibtex-조테로-필수-플러그인-인용키}
...
(<a href="#citeproc_bib_item_1">“Muisedestiny/Zotero-Attanger” 2024</a>)
