---
title: "#안드로이드 #이맥스 #설치"
description: "안드로이드에서 Emacs를 네이티브와 Termux 방식으로 설치하는 방법을 기록한 노트이다."
date: 2025-04-13T18:36:00+09:00
lastmod: 2026-03-01T00:00:00+09:00
tags: ["android", "bib", "emacs", "graphical", "install", "native", "termux"]
categories: ["Noname"]
draft: false
---
...
-   <span class="timestamp-wrapper"><span class="timestamp">[2026-03-01 Sun 12:28]</span></span> 잠시만, 이거 안해. 너무 번거로워서. 이렇게 안드로이드에 하면 안할거야!
-   <span class="timestamp-wrapper"><span class="timestamp">[2025-06-27 Fri 15:05]</span></span> 동작된다
...
(<a href="#citeproc_bib_item_2">Martin Stemplinger 2025</a>) Martin Stemplinger 2025
...
<div class="csl-bib-body">
  <div class="csl-entry"><a id="citeproc_bib_item_1"></a>emacswiki. 2025. “Emacswiki: Doom Emacs on Android - 둠이맥스 안드로이드 설치.” 2025. <a href="https://www.emacswiki.org/emacs/DoomEmacsOnAndroid">https://www.emacswiki.org/emacs/DoomEmacsOnAndroid</a>.</div>
  <div class="csl-entry"><a id="citeproc_bib_item_2"></a>Martin Stemplinger. 2025. “Native Graphical Emacs on Android.” January 5, 2025. <a href="https://mstempl.netlify.app/post/emacs-on-android/">https://mstempl.netlify.app/post/emacs-on-android/</a>.</div>
</div>


## 2025 폴드4 안드로이드 이맥스 설치 {#2025-폴드4-안드로이드-이맥스-설치}
...
-   [#안드로이드 #리눅스 #미러링 scrcpy]({{< relref "/notes/20231118T065236.md" >}}) ADB 설치
...
(<a href="#citeproc_bib_item_1">emacswiki 2025</a>) emacswiki 2025
...
### [|2025-07-17 Thu 08:48|]({{< relref "/journal/20250714T000000.md#2025-07-17-thu" >}}) {#2025-07-17-thu-08-48-2025-07-17-thu}


#### @user 우분투 리눅스에 adb 설치하고 adb로 emacs apk 설치하는 방법 과정 정리 {#user-우분투-리눅스에-adb-설치하고-adb로-emacs-apk-설치하는-방법-과정-정리}
...
#### @user 안드로이드폰에서 termux ssh server 띄워서 접속하는 방법 {#user-안드로이드폰에서-termux-ssh-server-띄워서-접속하는-방법}
