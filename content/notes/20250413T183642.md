...
<style>.csl-entry{text-indent: -1.5em; margin-left: 1.5em;}</style><div class="csl-bib-body">
  <div class="csl-entry">emacswiki. (2025). <i>Emacswiki: Doom emacs on android - 둠이맥스 안드로이드 설치</i>. <a href="https://www.emacswiki.org/emacs/DoomEmacsOnAndroid">https://www.emacswiki.org/emacs/DoomEmacsOnAndroid</a></div>
  <div class="csl-entry">Martin Stemplinger. (2025, January 5). <i>Native graphical emacs on android</i>. <a href="https://mstempl.netlify.app/post/emacs-on-android/">https://mstempl.netlify.app/post/emacs-on-android/</a></div>
</div>
