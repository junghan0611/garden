...
description: "어드벤트 캘린더 형식으로 특정 주제를 꾸준히 기록하는 방법과 의미를 살펴본 실험용 메모 기록."
...
<div class="csl-bib-body">
  <div class="csl-entry"><a id="citeproc_bib_item_1"></a>“어드벤트 캘린더(Advent Calendar).” 2025. <a href="https://ko.wikipedia.org/w/index.php?title=%EC%9E%AC%EB%A6%BC%EC%A0%88_%EB%8B%AC%EB%A0%A5&oldid=38435170">https://ko.wikipedia.org/w/index.php?title=%EC%9E%AC%EB%A6%BC%EC%A0%88_%EB%8B%AC%EB%A0%A5&#38;oldid=38435170</a>.</div>
</div>
...
(<a href="#citeproc_bib_item_1">“어드벤트 캘린더(Advent Calendar)” 2025</a>)
...
### <span class="org-todo done DONE">DONE</span> advent {#advent}
...
### <span class="timestamp-wrapper"><span class="timestamp">[2023-07-24 Mon 09:56]</span></span> {#83f827}


#### @user  Advent Calendar 에 대해서 알려줘 {#user-advent-calendar-에-대해서-알려줘}
