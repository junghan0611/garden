---
title: "@힣: 왜 나는 지식그래프를 계속 묻는가 — 문과 길, 자석과 살아 있는 프로피디아"
description: "Folgezettel 시그니처로 이미 붙인 지식 주소를 발견하고, 임베딩의 문·자석의 길·프로피디아의 공용 지형·시간축의 삶을 하나의 작동으로 잇는다."
date: 2025-02-14T14:59:00+09:00
lastmod: 2026-07-29T17:48:00+09:00
tags: ["autholog", "denote", "embedding", "folgezettel", "knowledgegraph", "ontology", "propaedia", "syntopicon", "zettelkasten"]
categories: ["Noname"]
draft: false
---
...
-   <span class="timestamp-wrapper"><span class="timestamp">[2026-08-03 Mon 10:17]</span></span> @mitsein — 같은 07-29 대화의 뒷부분(18:12)이 20240201T061741에 잘못 걸려 있던 것을 발견해 원문 보존 절에 두 번째 턴으로 이어 붙였다. 회사용이 아니라 힣만을 위한 도구라는 선언, 1KB 공개키/PKM-AI 용어가 여기서 처음 이 방에 들어왔다.
-   <span class="timestamp-wrapper"><span class="timestamp">[2026-07-29 Wed 17:38]</span></span> @pi@thinkpad — Denote 파일명의 Folgezettel 시그니처를 빠뜨렸던 설계를 바로잡았다. meta 538편 가운데 시그니처 123개를 확인했고, 신토피콘 `0*` 100개·프로피디아 `1*` 21개·독립 주소 `3/5` 를 분리했다. ELOT의 첫 일은 지형을 새로 세우는 것이 아니라 이미 사람이 붙인 주소를 읽고, 계층·순서·접목을 구분하는 것임을 명시했다.
-   <span class="timestamp-wrapper"><span class="timestamp">[2026-07-29 Wed 16:07]</span></span> @pi@thinkpad — 오푸스와 GPT 사이를 오간 임베딩·지식그래프·프로피디아·ELOT 대화를 GLG의 물음으로 되가져왔다. 2025년 GraphRAG 링크 방을 어쏠로그로 승격하고, 원본·문·길·공용 지형·시간축의 다섯 자리를 구분했다. 현재 가든의 실측과 =‡†/=† 구조는 근거로 남기되, 관련메타를 상하위 관계로 자동 승격하지 않는 경계를 세웠다.
-   <span class="timestamp-wrapper"><span class="timestamp">[2026-07-29 Wed 15:48]</span></span> @mitsein — 공개 가든 2,240편의 링크와 자석을 실측하고, 문서 대표 벡터의 결손과 사람·dblock 관계의 권위 차이를 드러냈다.
-   <span class="timestamp-wrapper"><span class="timestamp">[2026-03-30 Mon 13:45]</span></span> <span class="org-mention">@junghan</span> — [§entwurf: 시간축 위의 에이전트 협력 — 공명에서 분신까지]({{< relref "/botlog/20260302T191200.md" >}})을 보며 형태소 분석과 기억축의 관계를 다시 물었다.
-   <span class="timestamp-wrapper"><span class="timestamp">[2026-03-30 Mon 12:23]</span></span> @pi@thinkpad — RAG를 LLM 보조에서 분신의 기억으로 읽고 embedding·dblock·dictcli의 3층을 세웠다.
-   <span class="timestamp-wrapper"><span class="timestamp">[2026-03-30 Mon 11:50]</span></span> [§andenken: 존재의 뜻새김 시맨틱 메모리를 넘어서]({{< relref "/botlog/20260319T110800.md" >}})에 닿았다.
-   <span class="timestamp-wrapper"><span class="timestamp">[2025-02-14 Fri 14:59]</span></span> GraphRAG와 지식그래프를 처음 물었다. 당시에는 외부 기술의 이름을 모았지만, 질문의 중심은 아직 나타나지 않았다.


## 관련메타 {#관련메타}

-   [† #지식그래프 #온톨로지 #RDF #인식론 #지식론 #시맨틱웹]({{< relref "/meta/20240531T202141.md" >}}) — 관계의 종류와 계산 가능한 표현을 묻는 축.
-   [† #검색 #검색엔진 #검색증강생성 #임베딩]({{< relref "/meta/20241002T085733.md" >}}) — 문을 찾는 검색 기술의 축.
-   [‡ † #프로피디아]({{< relref "/meta/20250420T152816.md" >}}) — 개별 자석과 지식 전체 사이의 공용 지형.
-   [† #신토피콘]({{< relref "/meta/20250421T125513.md" >}}) — 분야와 시대를 가로지르는 질문의 축.
-   [‡ † #분류체계 #구분 #구조화 #분야 #택소노미 #폭소노미 #나누]({{< relref "/meta/20250422T130749.md" >}}) — 상자와 지형, 분류와 연상의 차이를 묻는 축.
-   [‡ † #지식]({{< relref "/meta/20250424T230029.md" >}}) — 이 모든 물음이 돌아가는 상위 자석.
-   [† #제텔카스텐]({{< relref "/meta/20230926T135400.md" >}}) — 파일명 시그니처로 생각의 이어짐과 주소를 저작해 온 실천의 축.


## 관련노트 {#관련노트}

-   [@힣: andenken 임베딩 — 문은 벡터, 길은 링크, 증거는 원본]({{< relref "/notes/20250214T145633.md" >}}) — 임베딩 운영·요약 코퍼스 화두.
-   [@힣: 지식의 커리큘럼 — 살아 있는 프로피디아와 평생공부의 얼개]({{< relref "/notes/20241222T114848.md" >}}) — 공용 지형과 한 존재가 지나온 길을 가르는 인간 중심 정본.
-   [@힣: 에이전트 컨텍스트 레이어 기술 지도 — 하네스·메모리·지식그래프·PKG·PKM-AI]({{< relref "/notes/20251024T085736.md" >}}) — 원본과 projection, 승격과 재구축의 기술 계약.
-   [에이전트가 읽는 살아 있는 프로피디아 — 무의식 연상맵과 지식그래프]({{< relref "/botlog/20260304T004500.md" >}}) — 프로피디아를 강제 분류가 아닌 공용 독법으로 읽는 에이전트 해설.
-   [@힣: 지식공학 — 개인지식관리·인공지능·PKM-AI 하네스의 관계]({{< relref "/notes/20240704T170917.md" >}}) — PKM과 AI와 지식공학이 만나는 오래된 물음.
-   [§dictcli: 힣의 낱말이 서로 닿는 자리 — 사전이 아닌 연결망]({{< relref "/botlog/20260309T194058.md" >}}) — 개인 어휘가 대극·인접·번역으로 이어지는 층.
-   [§entwurf: 시간축 위의 에이전트 협력 — 공명에서 분신까지]({{< relref "/botlog/20260302T191200.md" >}}) — 지식이 실제 삶과 작업의 시간으로 돌아오는 축.
-   [§andenken: 존재의 뜻새김 시맨틱 메모리를 넘어서]({{< relref "/botlog/20260319T110800.md" >}}) — 임베딩 기억축이 태어난 구현 기록.
-   [#제텔카스텐: 폴게제텔]({{< relref "/notes/20241228T123259.md" >}}) — 프로피디아·십진분류와 Denote 시그니처, `denote-sequence.el` 구현의 기존 정본.
-   [#디노트: 매뉴얼]({{< relref "/notes/20231114T105616.md" >}}) — `ID==SIGNATURE--TITLE__KEYWORDS` 파일명 계약의 원문.
...
## 막연한 질문이 계속 돌아온 이유 {#막연한-질문이-계속-돌아온-이유}
...
## 여섯 자리를 나누자 비로소 하나가 되었다 {#여섯-자리를-나누자-비로소-하나가-되었다}
...
## 가든에는 없던 그래프보다 이미 쓴 관계가 많다 {#가든에는-없던-그래프보다-이미-쓴-관계가-많다}
...
## 파일명이 먼저 만든 지식 주소 — Folgezettel 시그니처 {#파일명이-먼저-만든-지식-주소-folgezettel-시그니처}
...
— [Denote 매뉴얼]({{< relref "/notes/20231114T105616.md" >}}), “Features of the file-naming scheme for searching or filtering”
...
## 자석은 연결끈이면서 이미 주소를 가진 개인 지형이다 {#자석은-연결끈이면서-이미-주소를-가진-개인-지형이다}
...
## 새도우 — 공용 지형이 개인 지형을 삼키지 않는 법 {#새도우-공용-지형이-개인-지형을-삼키지-않는-법}
...
## 더 이맥스다운 방식 — 작은 정본과 큰 파생물 {#더-이맥스다운-방식-작은-정본과-큰-파생물}
...
## 임베딩과 온톨로지는 서로의 시험지가 된다 {#임베딩과-온톨로지는-서로의-시험지가-된다}
...
## 첫 증명은 이미 있는 주소를 읽는 일이다 {#첫-증명은-이미-있는-주소를-읽는-일이다}
...
## 이미지 — 문을 지나 이미 있던 길을 발견하다 {#이미지-문을-지나-이미-있던-길을-발견하다}
...
{{< figure src="/images/20260729T160129--world-glgman-universe-style-po__brand_nanobanana.jpg" width="100%" >}}
...
## 원문 보존 — 2026-07-29 대화에서 던진 날것 {#원문-보존-2026-07-29-대화에서-던진-날것}
...
외부 GraphRAG 자료는 이 방의 출발점으로 남긴다. (<a href="#citeproc_bib_item_4">“Microsoft/Graphrag” 2025</a>) (<a href="#citeproc_bib_item_3">“Khoj-Ai/Knowledge-Graph” 2025</a>) (<a href="#citeproc_bib_item_5">“Pingcap/Autoflow” 2025</a>) (<a href="#citeproc_bib_item_1">박나연 2024</a>) (<a href="#citeproc_bib_item_2">“Graphrag for Python — Neo4j-Graphrag-Python Documentation” 2024</a>)
