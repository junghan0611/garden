...
<style>.csl-entry{text-indent: -1.5em; margin-left: 1.5em;}</style><div class="csl-bib-body">
  <div class="csl-entry"><a id="citeproc_bib_item_1"></a>Han, J. (2023). <i>Junghan0611/hunspell-dict-ko</i> [Computer software]. <a href="https://github.com/junghan0611/hunspell-dict-ko">https://github.com/junghan0611/hunspell-dict-ko</a> (2022)</div>
</div>


## 히스토리 {#히스토리}

-   <span class="timestamp-wrapper"><span class="timestamp">[2023-06-11 Sun 22:34] </span></span> 아!맞춤법 검사와 사전 기능은 다른 것이다. 다른 관점에서 접근한다. 4 년만에

한국어 사전이 업데이트 되었다 감사할 일이다.
...
(<a href="#citeproc_bib_item_1">Han, 2022/2023</a>)
...
이맥스는 ispell - hunspell 을 사용해야 한다. 훈스펠 바이너리로 한/영, 영/한에 따라서 결과가 달라진다. 이는 aff, dic 파일이 서로 문제를 일으킨다는 것이다.
