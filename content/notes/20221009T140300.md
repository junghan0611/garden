...
## DONT `Bufler.el` :: new buffer manager package {#dont-bufler-dot-el-new-buffer-manager-package}
...
## DONT `ibuffer` layer in spacemacs {#dont-ibuffer-layer-in-spacemacs}
