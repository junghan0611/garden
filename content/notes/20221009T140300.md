---
title: "#이맥스: #패키지: 버퍼관리 ibuffer"
description: "ibuffer를 중심으로 프로젝트별 버퍼 묶기와 이맥스 버퍼 관리 방식을 간단히 정리한 기록."
date: 2022-10-09T14:03:00+09:00
lastmod: 2025-01-18T23:12:00+09:00
tags: ["emacs", "notes", "packages"]
categories: ["Noname"]
draft: false
---
...
## 둠이맥스 :emacs ibuffer {#둠이맥스-emacs-ibuffer}

<span class="timestamp-wrapper"><span class="timestamp">[2025-02-07 Fri 11:20]</span></span> 둠이맥스 주는대로 쓰면 간단해진다.
...
## <span class="org-todo done DONT">DONT</span> `Bufler.el` :: new buffer manager package {#bufler-dot-el-new-buffer-manager-package}
...
## <span class="org-todo done DONT">DONT</span> `ibuffer` layer in spacemacs {#ibuffer-layer-in-spacemacs}
...
{{< figure src="/images/20221009T13-58.png" >}}
