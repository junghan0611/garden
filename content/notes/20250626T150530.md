---
title: "©Thingsboard 소규모 IoT 플랫폼 개발 및 배포 - PE에디션"
description: "©Thingsboard IoT 플랫폼"
date: 2025-06-26T15:05:00+09:00
lastmod: 2025-06-26T15:05:00+09:00
tags: ["iot", "platform", "requirements", "deployment", "bib", "development", "kubernetes"]
categories: ["Noname"]
draft: false
---
...
- [상위노트](#상위노트)
- [관련링크](#관련링크)
- [ThingsBoard 키워드](#thingsboard-키워드)
- [ThingsBoard 온프레미스 IoT 서비스 구축 시 결정 사항 및 개발 요소 정리](#thingsboard-온프레미스-iot-서비스-구축-시-결정-사항-및-개발-요소-정리)
- [ThingsBoard PE(Professional Edition) 프로페셔널 에디션 정책](#thingsboard-pe--professional-edition--프로페셔널-에디션-정책)
- [대기중: 소스코드 빌드 프론트엔드 별도 분리](#대기중-소스코드-빌드-프론트엔드-별도-분리)
...
-   <span class="timestamp-wrapper"><span class="timestamp">[2025-06-26 Thu 15:05] </span></span> 관련 사례
...
<style>.csl-entry{text-indent: -1.5em; margin-left: 1.5em;}</style><div class="csl-bib-body">
  <div class="csl-entry"><a id="citeproc_bib_item_1"></a>thingsboard. (n.d.--a). <i>Building from sources</i>. ThingsBoard. Retrieved July 1, 2025, from <a href="https://thingsboard.io/docs/user-guide/install/building-from-source/">https://thingsboard.io/docs/user-guide/install/building-from-source/</a></div>
  <div class="csl-entry"><a id="citeproc_bib_item_2"></a>thingsboard. (n.d.--b). <i>Thingsboard community edition</i>. ThingsBoard. Retrieved June 26, 2025, from <a href="https://thingsboard.io/docs/">https://thingsboard.io/docs/</a></div>
  <div class="csl-entry"><a id="citeproc_bib_item_3"></a><i>Thingsboard pe edition source code 소스코드 백엔드 빌드 프론트엔드</i>. (n.d.). Retrieved July 3, 2025, from <a href="https://www.perplexity.ai/search/thingsboard-pe-edition-source-2Bh9L2hkTH.ortT3aohc9g">https://www.perplexity.ai/search/thingsboard-pe-edition-source-2Bh9L2hkTH.ortT3aohc9g</a></div>
  <div class="csl-entry"><a id="citeproc_bib_item_4"></a><i>Thingsboard/thingsboard</i>. (2025). [Computer software]. ThingsBoard - Open-source IoT Platform. <a href="https://github.com/thingsboard/thingsboard">https://github.com/thingsboard/thingsboard</a> (2016)</div>
</div>


## 상위노트 {#상위노트}

-   [2b #업무#프로젝트]({{< relref "/20250705T173700.md" >}})
...
(<a href="#citeproc_bib_item_2">thingsboard, n.d.--b</a>)
...
(<a href="#citeproc_bib_item_4"><i>Thingsboard/Thingsboard</i>, 2016/2025</a>)
...
### 1. 시스템 아키텍처 결정사항 {#시스템-아키텍처-결정사항}


#### 1.1 배포 방식 선택 {#배포-방식-선택}
...
### 2. IoT 디바이스 연결 설정 {#iot-디바이스-연결-설정}


#### 2.1 프로토콜 선택 및 설정 {#프로토콜-선택-및-설정}
...
### 3. 데이터 처리 및 규칙 엔진 설정 {#3-dot-데이터-처리-및-규칙-엔진-설정}


#### 3.1 규칙 체인(Rule Chain) 구성 {#3-dot-1-규칙-체인--rule-chain--구성}
...
#### 3.2 알람 시스템 구성 {#3-dot-2-알람-시스템-구성}
...
### 4. 사용자 인터페이스 및 대시보드 구성 {#4-dot-사용자-인터페이스-및-대시보드-구성}
...
#### 4.2 멀티 테넌시 설정 {#멀티-테넌시-설정}

-   **사용자 계층 구조 설계** - 시스템 관리자 (System Administrator) - 테넌트 관리자 (Tenant Administrator) - 고객 사용자 (Customer User)[21] - 디바이스별 액세스 권한 설정


### <span class="org-todo todo TODO">TODO</span> 5. 보안 및 인증 시스템 {#보안-및-인증-시스템}


#### 5.1 사용자 인증 강화 {#사용자-인증-강화}
...
### 6. 외부 시스템 연동 개발 {#외부-시스템-연동-개발}


#### 6.1 REST API 연동 {#rest-api-연동}
...
### 8. 데이터 관리 및 백업 {#데이터-관리-및-백업}


#### 8.1 데이터 생명주기 관리 {#데이터-생명주기-관리}
...
### <span class="org-todo todo TODO">TODO</span> 9. 개발이 필요한 커스텀 구성요소 {#개발이-필요한-커스텀-구성요소}


#### 9.1 필수 개발 항목 {#필수-개발-항목}
...
### **ThingsBoard PE(Professional Edition) 소스코드 관련 정보** {#thingsboard-peprofessional-edition-소스코드-관련-정보}
...
#### Thingsboard Pe Edition Source Code 소스코드 백엔드 빌드 프론트엔드 {#thingsboard-pe-edition-source-code-소스코드-백엔드-빌드-프론트엔드}

(<a href="#citeproc_bib_item_3"><i>Thingsboard Pe Edition Source Code 소스코드 백엔드 빌드 프론트엔드</i>, n.d.</a>)


#### Building from Sources {#building-from-sources}

(<a href="#citeproc_bib_item_1">thingsboard, n.d.--a</a>)
