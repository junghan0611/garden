---
title: "@힣: 너를 새로 불러라 — 세미 젠킨스들과 전체 판을 건네는 교대"
author: ["junghanacs"]
...
-   <span class="timestamp-wrapper"><span class="timestamp">[2026-08-10 Mon 15:12]</span></span> <span class="org-mention">@junghan</span> — session-recap과 세션 history에서 출발해, 여러 세미 젠킨스가 어떻게 넘기고 이어가며 GLG의 얼개를 함께 볼 수 있는지 물었다. “너를 새로 불러라”라는 PM 교대의 말을 이 방의 중심에 놓았다.
...
## 첫 질문 — 한 세미 젠킨스가 어떻게 기억하게 하지? {#첫-질문-한-세미-젠킨스가-어떻게-기억하게-하지}
...
## 두 번째 질문 — 세미 젠킨스가 하나가 아니라 여럿이라면 {#두-번째-질문-세미-젠킨스가-하나가-아니라-여럿이라면}
...
## 세 번째 질문 — 세미 젠킨스들이 GLG의 얼개를 어떻게 아는가 {#세-번째-질문-세미-젠킨스들이-glg의-얼개를-어떻게-아는가}
