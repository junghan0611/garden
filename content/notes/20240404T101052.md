...
description: "둠이맥스의 elisp-demos와 API 문서를 읽고 번역하며 활용 포인트를 모으는 매뉴얼 노트."
...
> [!abstract] 이 노트에 대하여
> 
> Doom Emacs의 Emacs Lisp 관련 문서를 읽고 정리하며 자체 API와 데모 코드를 익힌다. 일반 Elisp 문서와 달리 둠 특유의 확장 지점을 이해하기 위한 실전 매뉴얼 노트다.
...
-   [llmlog/ §doomemacs-config: 이맥스 31 IGC vs 30.2 비교 마이그레이션 가이드 '2026-03-22]
