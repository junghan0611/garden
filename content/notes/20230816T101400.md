---
title: "#이맥스: #번역기모드 #패키지"
description: "이맥스 번역기 모드의 사용법과 레퍼런스 버퍼 중심 작업 방식을 정리해 둔 짧은 실전 안내."
date: 2023-08-16T10:14:00+09:00
lastmod: 2024-12-01T06:30:00+09:00
tags: ["emacs", "packages", "translationtool"]
categories: ["Noname"]
draft: false
---
...
> [!abstract] 이 노트에 대하여
> 
> 번역기 모드에서 원문 파일과 레퍼런스 버퍼를 짝으로 열고 이동하는 흐름을 설명한다. 실제 번역 작업에서 어떤 명령과 시각적 강조가 필요한지 감을 잡게 해 주는 짧은 안내다.

How-to use translate-mode on Emacs 방법 중에 하나다.

-   [OmegaT]({{< relref "/meta/20230530T060200.md" >}})
...
<span class="timestamp-wrapper"><span class="timestamp">[2023-08-16 Wed 10:17]</span></span> [#사전 #용어사전]({{< relref "/meta/20240903T113914.md" >}}) 에서도 언급하였지만 용어 관리를 잘 해야 한다.
