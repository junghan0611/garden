...
-   (Wellons, 2015/2024)- "skeeto/x86-lookup" Wellons, Christopher 2024 Quickly jump to x86 documentation from Emacs

-   "skeeto/devdocs-lookup" Wellons, Christopher 2024 Quick Emacs API lookup on devdocs.io (Wellons, 2014/2024)
...
<style>.csl-entry{text-indent: -1.5em; margin-left: 1.5em;}</style><div class="csl-bib-body">
  <div class="csl-entry">Wellons, C. (2024). <i>Skeeto/x86-lookup</i> [Computer software]. <a href="https://github.com/skeeto/x86-lookup">https://github.com/skeeto/x86-lookup</a> (2015)</div>
  <div class="csl-entry">Wellons, C. (2024). <i>Skeeto/devdocs-lookup</i> [Computer software]. <a href="https://github.com/skeeto/devdocs-lookup">https://github.com/skeeto/devdocs-lookup</a> (2014)</div>
</div>
