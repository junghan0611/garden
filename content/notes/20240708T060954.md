...
<style>.csl-entry{text-indent: -1.5em; margin-left: 1.5em;}</style><div class="csl-bib-body">
  <div class="csl-entry"><a id="citeproc_bib_item_1"></a>Wellons, C. (2024). <i>Skeeto/x86-lookup</i> [Computer software]. <a href="https://github.com/skeeto/x86-lookup">https://github.com/skeeto/x86-lookup</a> (2015)</div>
  <div class="csl-entry"><a id="citeproc_bib_item_2"></a>Wellons, C. (2024). <i>Skeeto/devdocs-lookup</i> [Computer software]. <a href="https://github.com/skeeto/devdocs-lookup">https://github.com/skeeto/devdocs-lookup</a> (2014)</div>
</div>
