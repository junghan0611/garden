...
<style>.csl-entry{text-indent: -1.5em; margin-left: 1.5em;}</style><div class="csl-bib-body">
  <div class="csl-entry"><i>키티 터미널 kitty the fast, feature-rich, gpu based terminal emulator</i>. (n.d.). kitty. Retrieved June 18, 2025, from <a href="https://sw.kovidgoyal.net/kitty/">https://sw.kovidgoyal.net/kitty/</a></div>
  <div class="csl-entry"><i>Slimmer emacs with kitty 터미널 이맥스 키티 통합</i>. (2022). <a href="https://jao.io/blog/slimmer-emacs-with-kitty.html">https://jao.io/blog/slimmer-emacs-with-kitty.html</a></div>
...
(<i>Slimmer Emacs with Kitty 터미널 이맥스 키티 통합</i>, 2022)
...
(<i>키티 터미널 Kitty the Fast, Feature-Rich, Gpu Based Terminal Emulator</i>, n.d.)
