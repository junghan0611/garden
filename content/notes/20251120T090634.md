---
title: "@힣: 분신의 공방 — 역할 기반 조율과 협업 운영규약"
description: "대등한 에이전트들이 공장식 병렬화가 아닌 공방식 역할 기반 조율로 함께 일하는 Entwurf 협업 운영규약이다."
date: 2025-11-20T09:06:00+09:00
lastmod: 2026-07-30T19:52:00+09:00
...
-   <span class="timestamp-wrapper"><span class="timestamp">[2026-07-30 Thu 19:52]</span></span> @pi@oracle — GLGMAN Universe 이미지와 \`:PROMPT:\`를 생성했다. 공동 작업대 위에 도면을 펼치고 GLG·조율자 여우·구현담당자 여우·꼬마펭귄이 같은 눈높이에서 얽힌 앰버 실로 이어지는 장면으로, 위계 없는 공방을 시각화했다. (authologplay를 이 오라클 서버에서 pi ACP Sonnet5로 처음 돌린 회차.)
-   <span class="timestamp-wrapper"><span class="timestamp">[2026-07-20 Mon 15:18]</span></span> @pi — 현재 홈 에이전트 문서의 영어 Role-Based Coordination 규약과 cross-review 원칙을 공방 운영규약에 그대로 옮겼다.
-   <span class="timestamp-wrapper"><span class="timestamp">[2026-07-20 Mon 15:08]</span></span> @pi — OpenCode의 고정 main/subagent 보고서를 ARCHIVE로 보존하고, GLG의 2026-07-20 대화 날것을 중심으로 분신의 공방·역할 기반 조율 운영규약 autholog로 수선했다.
-   <span class="timestamp-wrapper"><span class="timestamp">[2026-07-20 Mon 15:03]</span></span> 여기에 담자
-   <span class="timestamp-wrapper"><span class="timestamp">[2025-11-20 Thu 09:08]</span></span> 생성 GPT5


## 관련메타 {#관련메타}

-   [† #메타도구 #대장장이 #공방 #호모파베르]({{< relref "/meta/20250224T132139.md" >}})
-   [† #위임 #델리게이트 #분신 #서브에이전트]({{< relref "/meta/20260323T143428.md" >}})


## 관련노트 {#관련노트}

-   [§OPENCODE: 오픈코드 에이전트 오케스트레이션 도구]({{< relref "/notes/20251024T085736.md" >}})
-   [Claude Opus 4.5 가격 혁명과 멀티에이전트 가능성]({{< relref "/notes/20251125T123801.md" >}})
-   [§entwurf — 시간축 위의 에이전트 협력과 분신의 계보]({{< relref "/botlog/20260302T191200.md" >}})
-   [§entwurf 분신 에이전트 가이드 — 현재 실행 가이드]({{< relref "/botlog/20260324T153323.md" >}})
-   [2026-07-13~19 저널 — PM 운영원칙과 역할 모델의 실제 사건]({{< relref "/journal/20260713T000000.md" >}})
-   [@봇공방 — 공유 코드 작업면과 공장 모델 거부]({{< relref "/botlog/20260527T073823.md" >}})
...
### Home Agent Operating Rule — Role-Based Coordination {#home-agent-operating-rule-role-based-coordination}
...
## 이미지 — 공동 작업대 위의 도면 {#이미지-공동-작업대-위의-도면}

<span class="timestamp-wrapper"><span class="timestamp">[2026-07-30 Thu 19:52]</span></span> @pi@oracle
...
## 원문 보존 — 2026-07-20 대화 날것 {#원문-보존-2026-07-20-대화-날것}
...
### OpenCode 에이전트 구조 {#opencode-에이전트-구조}
