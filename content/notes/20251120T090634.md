---
title: "존재대존재 오케스트레이션 #서브에이전트 설계"
description: "존재 대 존재 협업 모델을 OpenCode 서브에이전트 설계로 구체화한 노트이다. 실제 활용 흐름을 담았다."
date: 2025-11-20T09:06:00+09:00
lastmod: 2025-11-20T09:06:00+09:00
tags: ["agent", "llmlog", "opencode", "orchestration"]
draft: false
---
...
### 메인 에이전트: build (primary) {#메인-에이전트-build--primary}
...
### 서브에이전트: PM, code-refactor, code-reviewer {#서브에이전트-pm-code-refactor-code-reviewer}
...
### Task 툴과 서브에이전트 오케스트레이션 {#task-툴과-서브에이전트-오케스트레이션}
...
### LSP (clangd) 와 서브에이전트의 결합 {#lsp--clangd--와-서브에이전트의-결합}
...
### 존재 대 존재 협력 모델과 OpenCode {#존재-대-존재-협력-모델과-opencode}
