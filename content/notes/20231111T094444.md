---
title: "remark"
description: "org-remark로 남긴 주석과 발췌를 파일별로 누적해 두는 개인 어노테이션 저장소 기록."
date: 2023-11-11T09:44:00+09:00
lastmod: 2023-11-11T09:44:00+09:00
categories: ["Noname"]
draft: false
---
...
## denote 메뉴얼 한글 {#denote-메뉴얼-한글}


## \* 13.5. Use `dired-virtual-mode` for ar… {#13-dot-5-dot-use-dired-virtual-mode-for-ar}
...
## .gitmodules {#dot-gitmodules}


### [submodule "plugins/ffmpeg-crop"] {#submodule-plugins-ffmpeg-crop}
...
### 그 심술궂은 외관 아래에는 아마도 _가장_ 가장 접… {#그-심술궂은-외관-아래에는-아마도-가장-가장-접}
...
## My Emacs Keybindings {#my-emacs-keybindings}


### 키바인딩 설정 파일에 대하여 (번역) {#키바인딩-설정-파일에-대하여--번역}
...
### “I do mathematics because once you prove… {#i-do-mathematics-because-once-you-prove}


## 유발 하라리 (2024) 넥서스: 석기 시대부터 AI까지 정보 네트워크의 간략한 역사 {#유발-하라리--2024--넥서스-석기-시대부터-ai까지-정보-네트워크의-간략한-역사}


### 둘째, 실리콘 커튼이 인간을 한 집단과 다른 집단으로 나누는 것이 아니라… {#둘째-실리콘-커튼이-인간을-한-집단과-다른-집단으로-나누는-것이-아니라}
