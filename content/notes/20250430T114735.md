---
title: "#그리스문자 #발음 #수학기호 αβγδεζηθικλμνξοπρςτυφχψω"
author: ["Junghan Kim"]
...
-   [#모음: #수학 #논리 #기호 #그리스문자]({{< relref "/notes/20240519T080251.md" >}})
...
## 권말부록: 그리스 문자와 발음 {#권말부록-그리스-문자와-발음}
...
-   [@장회익 #자연철학 #온생명 #스승]({{< relref "/bib/20240510T113546.md" >}}) 선생님 책 말이야.
    ...
    -   Υυ [Upsilon 윕실론 웁실론](https://en.wikipedia.org/wiki/Upsilon)
    ...
    -   Ψψ [Psi 프사이](https://en.wikipedia.org/wiki/Psi_(Greek))
