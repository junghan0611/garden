---
title: "marginalia vertico-multiform - sort-modified - emacs"
date: 2025-03-27T12:35:00+09:00
...
-   <span class="timestamp-wrapper"><span class="timestamp">[2025-03-27 Thu 12:35]</span></span>


### <span class="org-todo done DONE">DONE</span> 11:18 버그픽스 필요 - vertico childframe {#11-18-버그픽스-필요-vertico-childframe}
...
{{< figure src="/images/20250327T111700-marginalia-annotator-none-category-file.png" >}}


## 로그 {#로그}


### [|2025-03-27 Thu 12:35|]({{< relref "/journal/20250324T000000.md" >}}) {#2025-03-27-thu-12-35--relref-journal-20250324t000000-dot-md}

@user 조직모드 파일을 검색 할 때, marginalia annotator category를 최근 수정한 파일 목록 기준으로 정렬 하도록 함수를 만들어줘.

@assistant 조직모드에서 특정 카테고리(marginalia annotator category)를 기준으로 최근 수정한 파일 목록을 정렬하는 함수를 만들기 위해서는 Emacs Lisp을 사용하여 함수를 정의해야 합니다. 아래는 그 예시입니다.

```elisp
(defun org-sort-recently-modified-marginalia-annotator-category ()
  "Marginalia Annotator Category를 기준으로 최근 수정한 파일 목록을 정렬합니다."
  (interactive)
...
이 함수를 사용하려면 Emacs에서 `M-x org-sort-recently-modified-marginalia-annotator-category`를 실행하면 됩니다.
...
## <span class="org-todo todo TODO">TODO</span> 11:18 버그픽스 필요 - vertico childframe {#11-18-버그픽스-필요-vertico-childframe}

<span class="timestamp-wrapper"><span class="timestamp">[2025-03-27 Thu 13:37]</span></span> 여기에 필요한 기능을 정의해서 넣어야 한다. 샘플은 다 구했다. 근데 넣고 뭐 하는데 1시간 걸릴 것 같다. 잠시 대기.
...
### 엄청난 주제이며 중요한 주제다 {#엄청난-주제이며-중요한-주제다}
