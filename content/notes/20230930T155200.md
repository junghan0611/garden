...
<style>.csl-entry{text-indent: -1.5em; margin-left: 1.5em;}</style><div class="csl-bib-body">
  <div class="csl-entry"><a id="citeproc_bib_item_1"></a><i>Rnkn/binder: Emacs global minor mode facilitating multi-file writing projects</i>. (n.d.). Retrieved September 23, 2024, from <a href="https://github.com/rnkn/binder/tree/master">https://github.com/rnkn/binder/tree/master</a></div>
</div>


## 관련노트 {#관련노트}

[@최은광 #스크리브너]({{< relref "/bib/20250108T105154.md" >}}) 다시 만남.
...
(<a href="#citeproc_bib_item_1"><i>Rnkn/Binder: Emacs Global Minor Mode Facilitating Multi-File Writing Projects</i>, n.d.</a>)
