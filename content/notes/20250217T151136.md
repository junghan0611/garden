---
title: "§ob-doc-python 조직모드 바벨 파이썬 매뉴얼 - #코드블록"
date: 2025-02-17T15:11:00+09:00
lastmod: 2025-02-17T15:11:00+09:00
tags: ["bib", "orgbabel", "orgmode", "python", "worg"]
categories: ["Noname"]
draft: false
---
...
<style>.csl-entry{text-indent: -1.5em; margin-left: 1.5em;}</style><div class="csl-bib-body">
  <div class="csl-entry"><a id="citeproc_bib_item_1"></a><i>Bzg/worg - org community-driven documentation - sourcehut git</i>. (n.d.). Retrieved February 17, 2025, from <a href="https://git.sr.ht/~bzg/worg">https://git.sr.ht/~bzg/worg</a></div>
  <div class="csl-entry"><a id="citeproc_bib_item_2"></a><i>Python source code blocks in org mode worg</i>. (2024). <a href="https://orgmode.org/worg/org-contrib/babel/languages/ob-doc-python.html">https://orgmode.org/worg/org-contrib/babel/languages/ob-doc-python.html</a></div>
</div>


## History {#history}

-   <span class="timestamp-wrapper"><span class="timestamp">[2025-07-17 Thu 18:00] </span></span> 바벨 관련
...
-   [§ob-jupyter 조직모드 바벨 파이썬 주피터]({{< relref "/notes/20240603T174450.md" >}}) 주피터를 이용할 경우
...
(<a href="#citeproc_bib_item_1"><i>Bzg/Worg - Org Community-Driven Documentation - Sourcehut Git</i>, n.d.</a>) <https://git.sr.ht/~bzg/worg>


### DONT Replacing Jupyter Notebook with Org Mode {#dont-replacing-jupyter-notebook-with-org-mode}


### Python Source Code Blocks in Org Mode {#python-source-code-blocks-in-org-mode}

(<a href="#citeproc_bib_item_2"><i>Python Source Code Blocks in Org Mode Worg</i>, 2024</a>)
...
-   추가 [#이맥스 #통합개발환경: #파이썬]({{< relref "/notes/20240112T165512.md" >}})
...
## Org Mode Features for Python Source Code Blocks {#h:8d2a8166-38de-4aeb-9df6-343ec5f61d05}
...
### Graphics 그래픽스 {#graphics-그래픽스}


#### DONT Manual plotting with Org 9.6 and earlier {#dont-manual-plotting-with-org-9-dot-6-and-earlier}


#### <span class="org-todo todo TODO">TODO</span> Automatic plotting in Org 9.7+ {#automatic-plotting-in-org-9-dot-7-plus}
...
### Extracting data from an org-mode table {#extracting-data-from-an-org-mode-table}
