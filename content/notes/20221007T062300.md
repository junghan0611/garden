...
description: "paredit, smartparens, puni를 중심으로 이맥스의 구조적 괄호 편집 개념과 선택지를 모아 둔 자료."
...
<div class="csl-bib-body">
  <div class="csl-entry"><a id="citeproc_bib_item_1"></a>“Amaikinono/Puni.” 2025. <a href="https://github.com/AmaiKinono/puni">https://github.com/AmaiKinono/puni</a>.</div>
  <div class="csl-entry"><a id="citeproc_bib_item_2"></a>“Fuco1/Smartparens.” 2025. <a href="https://github.com/Fuco1/smartparens">https://github.com/Fuco1/smartparens</a>.</div>
  <div class="csl-entry"><a id="citeproc_bib_item_3"></a>karthink. n.d. “A Consistent Structural Editing Interface - Smartparens Paredit Puni Treesit.” Accessed November 15, 2024. <a href="https://karthinks.com/software/a-consistent-structural-editing-interface/?">https://karthinks.com/software/a-consistent-structural-editing-interface/?</a></div>
</div>
...
## smartparens / mark-sexp — 상위 폼 한 번에 선택 {#smartparens-mark-sexp-상위-폼-한-번에-선택}

-   커서가 폼 안/근처에 있을 때:
    -   `C-M-u` (`backward-up-list`) → 바깥으로
    -   `C-M-d` (`down-list`) → 폼 안으로
    -   `C-M-SPC` (`mark-sexp`) → sexp 선택(region)
-   원래 기록(퍼블리시 ID 보존용 스텁): [smartparens mark-sexp (통합됨)]({{< relref "/notes/20250320T103618.md" >}})
...
(<a href="#citeproc_bib_item_1">“Amaikinono/Puni” 2025</a>)
...
(<a href="#citeproc_bib_item_2">“Fuco1/Smartparens” 2025</a>)
...
(<a href="#citeproc_bib_item_3">karthink n.d.</a>)
...
아래 사이트에 요약을 가져 왔다. 이게 원 저자의 키 바인닝이다 [A Cheatsheet for Emacs Smarparens example configuration · GitHub](https://gist.github.com/pvik/8eb5755cc34da0226e3fc23a320a3c95#file-smartparens-cheatsheet-md) ![](/images/2022-10-13_06-36-smartparens-cheat.png)
...
### - <SPAN CLASS="ORG-HASHTAG">#FIXME</SPAN> 5e7bb2b6-3a5a-49d1-8783-aeaffd55faec][기계인간님]] 님 블로그를 보니 {#fixme-5e7bb2b6-3a5a-49d1-8783-aeaffd55faec-기계인간님-님-블로그를-보니}
