---
title: "@힣: 작가라는 입구 — 디지털가든 코어를 책판본으로 낸다"
description: "판매 부수보다 저자됨의 사회적 입구를 만들기 위해, 살아 있는 가든의 어쏠로그를 이미지까지 수선하고 Org SSOT와 memex-kb로 재현 가능한 『디지털가든 코어』 책판본을 주기적으로 고정한다."
date: 2024-05-17T11:05:00+09:00
lastmod: 2026-07-28T16:52:00+09:00
tags: ["autholog", "author", "books", "digitalgarden", "ebook", "memex", "orgmode", "publishing", "reproducibility", "wikidocs"]
categories: ["Noname"]
draft: false
---
...
-   <span class="timestamp-wrapper"><span class="timestamp">[2026-07-28 Tue 16:54]</span></span> @mitsein — 2024년의 두 원석을 표준 어쏠로그로 다시 세웠다. ‘힣은 일어났다’는 코어가 책 이전에 시작된 명상적 글쓰기·귀로 듣는 독법의 원점이고, ‘책을 쓰지 않는 이유’는 가든을 멈추지 않고 판본을 닫는 운영 경계다.
-   <span class="timestamp-wrapper"><span class="timestamp">[2026-07-28 Tue 16:22]</span></span> @mitsein — GLG 검수에서 빠졌던 핵심축을 복원했다. Org SSOT·재현 가능한 책·디지털가든 배포 파이프라인과 `memex-kb` 문서 변환 3편을 연결하고, 재현성을 출판 실무의 부록이 아니라 책과 문서의 내부 골격으로 올렸다.
-   <span class="timestamp-wrapper"><span class="timestamp">[2026-07-28 Tue 16:06]</span></span> @mitsein — 자가출판 서비스 세 곳만 적힌 얇은 컬렉션 방을 회수했다. 2026-07-22~28 위키독스 출판 논의의 원문과 해설을 보존하고, 『디지털가든 코어』의 저자됨·어쏠로그 중심·판본 운영 원칙을 세웠다. GLGMAN Universe의 살아 있는 가든 나무와 책 제본 장면을 생성해 한 어쏠로그 한 이미지 계약까지 닫았다.
-   <span class="timestamp-wrapper"><span class="timestamp">[2024-05-17 Fri 11:05]</span></span> 위키독스·린북스·부크크를 자가출판 서비스 후보로 짧게 적어 둔 컬렉션 노트를 만들었다.


## 관련메타 {#관련메타}

-   [† #재현성 #복기]({{< relref "/meta/20241207T151519.md" >}}) — 같은 Org 원본과 절차에서 같은 판본을 다시 만들 수 있어야 한다는 책의 기술적 중심.
-   [† #어쏠로지]({{< relref "/meta/20240508T103852.md" >}}) — 모두가 자기 삶의 저자라는 책의 중심 명제.
-   [† #저자 #작가 #글쓴이]({{< relref "/meta/20241014T211115.md" >}}) — 작가라는 사회적 입구와 판본을 책임지는 주체.
-   [† #디지털가든 #브레인덤프 #아날로그가든 #날것쓰기]({{< relref "/meta/20240918T175053.md" >}}) — 계속 자라는 정본.
-   [† #출판 #퍼블리싱 #배포]({{< relref "/meta/20230814T162600.md" >}}) — 가든의 코어를 책으로 내보내는 축.
-   [† #내보내기 #업데이트 #개정 #갱신]({{< relref "/meta/20250416T171517.md" >}}) — 패치와 새 판을 구분하는 개정의 축.
-   [† #서브스택 #위키독스]({{< relref "/meta/20230716T041900.md" >}}) — `wikidocs` 영어 태그의 자석.


## 관련노트 {#관련노트}

-   [@힣: Org SSOT 메타문서 — 책의 미래와 인터랙티브 프로젝트 지식베이스]({{< relref "/notes/20251021T105353.md" >}}) — 원문·코드·JS·에셋·실행 절차와 export를 한 시간축에 묶는 문서론적 북극성.
-   [#콰르토 #재현성 #전자책 — 재현 가능한 책의 미래]({{< relref "/notes/20240923T162112.md" >}}) — Quarto가 먼저 가리켰고 이제 Org SSOT가 더 안쪽에서 맡는 오래된 문제의식.
-   [@힣: 디지털가든 배포 파이프라인]({{< relref "/notes/20230811T092200.md" >}}) — Org→ox-hugo→Quartz→Netlify로 살아 있는 정본을 공개면에 반복해서 내보낸 실증.
-   [@힣: §memex-kb 힣의 범용 지식베이스 변환 시스템]({{< relref "/notes/20251030T011105.md" >}}) — 플랫폼과 레거시 문서를 Org/Denote 정본으로 회수하고 여러 형식으로 다시 내보내는 본거지.
-   [§memex-kb 제안서 문서 변환 메타포멧]({{< relref "/botlog/20260306T130726.md" >}}) — Org 한 원본에서 ODT·DOC·Google Docs 등 실무 판본을 재생성한 사례.
-   [§memex-kb 스캔책을 귀로 듣기까지 — OCR 파이프라인 여정]({{< relref "/botlog/20260606T130306.md" >}}) — 종이책·PDF를 깨끗한 Org로 회수해 EPUB으로 되살리는 반대 방향의 실증.
-   [@힣: 생생날것 500개 문턱 — 디지털가든 코어는 시간축의 판본이다]({{< relref "/notes/20230706T160800.md" >}}) — 500개 운영 제약을 실제 코어 판본으로 전환한 앞선 어쏠로그.
-   [§garden2wikidocs — 원본 가든을 건드리지 않는 위키독스 미러]({{< relref "/botlog/20260220T201100.md" >}}) — 정본을 보존하면서 위키독스 발견면과 출판면을 만드는 번역 하네스.
-   [#모음: #전자책 #퍼블리싱 #서비스 — #라이팅허브]({{< relref "/notes/20230725T174400.md" >}}) — 이 방이 품었던 서비스 수집과 살아 있는 기술 서적의 선행 기록.
-   [#출판: #콰르토 #전자책 #퍼블리싱 #코드문서통합 #개정판자동화]({{< relref "/notes/20240125T164008.md" >}}) — 코드·문서·개정판 자동화를 잇는 도구축.
-   [@열린책들 편집자 매뉴얼 — 국립국어원 맞춤법·표준어·출판·국문법]({{< relref "/bib/20250502T172814.md" >}}) — 실제 편집 단계에서 참고할 실무 기준.
-   [@힣: 힣은 일어났다 — 명상하는 글쓰기와 평균 밖의 개개인성]({{< relref "/notes/20240921T062312.md" >}})
-   [@힣: 책을 쓰지 않는 이유 — 가든을 멈추지 않는 책판본]({{< relref "/notes/20240927T142147.md" >}})
...
## 왜 책인가 — 돈보다 작가라는 입구 {#왜-책인가-돈보다-작가라는-입구}
...
## 재현 가능한 책 — Org SSOT와 memex-kb {#재현-가능한-책-org-ssot와-memex-kb}
...
### 전자책 패치 버전 — 같은 판 안의 작은 갱신 {#전자책-패치-버전-같은-판-안의-작은-갱신}
...
### 새로운 판 — 의미 있는 시점에 닫기 {#새로운-판-의미-있는-시점에-닫기}
...
## ISBN 질문은 출간 직전에 묻는다 {#isbn-질문은-출간-직전에-묻는다}
...
## 이미지 — 살아 있는 가든이 책판본이 되는 순간 {#이미지-살아-있는-가든이-책판본이-되는-순간}
...
{{< figure src="/images/20260728T160611--world-glgman-universe-style-2d__brand_nanobanana.jpg" width="100%" >}}
...
## 원문 보존 — 2026-07-22 디지털가든 코어 출판 날것 {#원문-보존-2026-07-22-디지털가든-코어-출판-날것}
...
## 후속 질문 보존 — 2026-07-28 ISBN과 월별 판본 {#후속-질문-보존-2026-07-28-isbn과-월별-판본}
...
이 방은 2024년 5월 위키독스·린북스·부크크라는 자가출판 서비스 이름 세 개만 적어 둔 959바이트짜리 컬렉션 노트였다. "여러 서비스가 있다. 아무렴."이라는 한 문장과 서비스 목록은 아직 살아 있는 질문이지만, 서비스 수집은 이미 [전자책 퍼블리싱 서비스와 라이팅허브 컬렉션]({{< relref "/notes/20230725T174400.md" >}})이 더 오래, 더 구체적으로 맡고 있었다.
