---
title: "#재배포시스템: NIX 홈매니저 배포판 관리 구축"
description: "Nix와 홈매니저로 재현 가능한 배포·패키지 관리 시스템을 구축할 수 있을지 탐색한 노트."
date: 2024-05-30T12:07:00+09:00
lastmod: 2025-06-20T00:00:00+09:00
tags: ["linux", "macos", "nix", "packages", "brew", "distribution", "home", "manager", "rollback", "dotfiles", "reproducibility"]
categories: ["Noname"]
draft: false
---
...
-   <span class="timestamp-wrapper"><span class="timestamp">[2025-06-20 Fri 13:12]</span></span> 다시 바라 볼까? 아니. 당장은 노우.
...
-   [#재배포 #시스템 #롤백]({{< relref "/meta/20240530T120348.md" >}})
-   [#닷파일]({{< relref "/meta/20230825T162600.md" >}})

## BIBLIOGRAPHY

<div class="csl-bib-body">
  <div class="csl-entry"><a id="citeproc_bib_item_1"></a>“Cmacrae/Config Nix Emacs.” 2024. <a href="https://github.com/cmacrae/config">https://github.com/cmacrae/config</a>.</div>
  <div class="csl-entry"><a id="citeproc_bib_item_2"></a>“Ericdallo/Dotfiles: Dotfiles for My Nixos System Based on Dracula Theme Clojure Doomemacs.” 2025. <a href="https://github.com/ericdallo/dotfiles">https://github.com/ericdallo/dotfiles</a>.</div>
  <div class="csl-entry"><a id="citeproc_bib_item_3"></a>“Hlissner/Dotfiles #Nix.” 2025. <a href="https://github.com/hlissner/dotfiles">https://github.com/hlissner/dotfiles</a>.</div>
  <div class="csl-entry"><a id="citeproc_bib_item_4"></a>“Nix (Package Manager).” 2024. <a href="https://en.wikipedia.org/w/index.php?title=Nix_(package_manager)&oldid=1224556819">https://en.wikipedia.org/w/index.php?title=Nix_(package_manager)&#38;oldid=1224556819</a>.</div>
  <div class="csl-entry"><a id="citeproc_bib_item_5"></a>“Noctuid/Dotfiles.” 2024. <a href="https://github.com/noctuid/dotfiles">https://github.com/noctuid/dotfiles</a>.</div>
  <div class="csl-entry"><a id="citeproc_bib_item_6"></a>“Sdedovic/Dotfiles Nix Home-Manager Stow.” 2025. <a href="https://github.com/sdedovic/dotfiles">https://github.com/sdedovic/dotfiles</a>.</div>
</div>

(<a href="#citeproc_bib_item_4">“Nix (Package Manager)” 2024</a>)


## 2023 Emacs Distribution on Mac and Linux {#h-ed7bbc97-69c1-42a1-9913-f3a06213107b}

-   <span class="timestamp-wrapper"><span class="timestamp">[2023-05-09 Tue 06:01]</span></span> NIX 는 이 자체로 새로운 시스템이다. 훌륭하다. 허나 진입장벽이 높다. 간단한 시스템이 필요하다. Brew 가 더 적합하다.


### <span class="org-todo done DONE">DONE</span> Emacs on NIX pkgs {#emacs-on-nix-pkgs}

<span class="timestamp-wrapper"><span class="timestamp">[2023-05-11 Thu 04:56]</span></span>
...
<span class="timestamp-wrapper"><span class="timestamp">[2023-05-11 Thu 05:13]</span></span>
...
#### Install Nix: the package manager 2.15.0 {#install-nix-the-package-manager-2-dot-15-dot-0}

<span class="timestamp-wrapper"><span class="timestamp">[2023-05-09 Tue 06:23]</span></span> 리눅스에 닉스 패키지 매니저만 설치한다. 닉스 운영체제는 아니다. 싱글채널로 일단 가볍게 [Download Nix / NixOS | Nix &amp; NixOS](https://nixos.org/download.html#nix-install-linux)
...
#### <span class="org-todo done DONE">DONE</span> 궁금증 NIX Emacs 설치 어떤가? 좋아. {#궁금증-nix-emacs-설치-어떤가-좋아-dot}

<span class="timestamp-wrapper"><span class="timestamp">[2023-05-12 Fri 14:00]</span></span> 진정 궁금하다. 배포 생각하는게 아니라. 패키지로 있는 Emacs 를 Direnv 으로 독립된 환경에서 동작 시킬 경우 컴파일 하는가? 아니면 설치하는가? 설치할 수도 있을 텐데 GUI 지원까지 본다면 덩치가 클 것 같다. 가능한가?
...
<span class="timestamp-wrapper"><span class="timestamp">[2023-05-12 Fri 14:11]</span></span> 위의 한글 블로그에 보면 닉스를 설치하고 디렉토리만들고 shell.nix 파일 생성 추가했다.
...
##### direnv 알고 싶어 이 친구! {#direnv-알고-싶어-이-친구}

<span class="timestamp-wrapper"><span class="timestamp">[2023-05-12 Fri 14:29]</span></span>
...
##### Emacs 설치 (1) emacs {#emacs-설치--1--emacs}

<span class="timestamp-wrapper"><span class="timestamp">[2023-05-12 Fri 16:13]</span></span> non nixos 에서는 아래와 같이 설치하라고 한다.
...
##### Emacs 설치 (2) emacs-gtk {#emacs-설치--2--emacs-gtk}

<span class="timestamp-wrapper"><span class="timestamp">[2023-05-13 Sat 18:13]</span></span> emacs 패키지 말고 emacs-gtk 를 설치하자. 자동으로 설치하는구나. 보니까 아래의 패키지들을 추가로 설치한다고 한다. 그럼 그렇지.
...
##### emacs-direnv {#emacs-direnv}

<span class="timestamp-wrapper"><span class="timestamp">[2023-05-12 Fri 14:30]</span></span> 이맥스에서 제대로 지원한다. 많은 분들이 활용하더이다. 스페이스맥스에는 없다. 별도로.


##### niv 사용법을 익힐 것 {#niv-사용법을-익힐-것}

<span class="timestamp-wrapper"><span class="timestamp">[2023-05-12 Fri 16:22]</span></span>


#### <span class="org-todo done DONE">DONE</span> purcell/nix-emacs-ci {#purcell-nix-emacs-ci}

[GitHub - purcell/nix-emacs-ci: Emacs installations for co...](https://github.com/purcell/nix-emacs-ci) <span class="timestamp-wrapper"><span class="timestamp">[2023-05-13 Sat 17:10]</span></span>
...
### <span class="org-todo done DONE">DONE</span> Desktop 파일을 만들어서 실행하려면 어떻게 하는가 {#desktop-파일을-만들어서-실행하려면-어떻게-하는가}

<span class="timestamp-wrapper"><span class="timestamp">[2023-05-13 Sat 18:18]</span></span> nix 패키지로 설치하니 좋다. Direnv 로 디렉토리 들어가면 자동으로 실행되서 좋다. 근데 애플리케이션 Desktop 파일 만들어서 바로 실행하고 싶은데 방법은?
...
### NIX Home-manager 에 답이 있다. {#nix-home-manager-에-답이-있다-dot}

<span class="timestamp-wrapper"><span class="timestamp">[2023-05-13 Sat 21:33]</span></span> <https://github.com/jeffkreeftmeijer/.emacs.d> [Manage user environments with Nix and Home Manager](https://jeffkreeftmeijer.com/nix-home-manager/) 이 글이 딱 답이 될 것 같다. 얽어보자.
...
### <span class="org-todo done DONE">DONE</span> Brew :: Macos 전용으로 가자! {#brew-macos-전용으로-가자}

<span class="timestamp-wrapper"><span class="timestamp">[2023-05-11 Thu 11:59]</span></span> tshu 닷파일을 보니 컨셉이 좋은데 이게 빌드 시간이 너무 오래 걸린다. 말도 안된다. 이렇게 해서는 리눅스에서는 매력이 없다. 맥에서야 이렇게 한다고 하지만 별 의미 없다. 바보 같은 짓이다. 리눅스 서버는 괜찮겠다. 그냥 패키징해서 배포하는게 빠르겠다.
...
### <span class="org-todo done DONE">DONE</span> Emacs DEB Dockerfile 패키징 {#emacs-deb-dockerfile-패키징}
...
### <span class="org-todo done DONE">DONE</span> evil-guide 쓰신 분의 dotfiles 에 답이 있다. {#evil-guide-쓰신-분의-dotfiles-에-답이-있다-dot}

<span class="timestamp-wrapper"><span class="timestamp">[2023-05-15 Mon 12:29]</span></span>
...
-   <span class="timestamp-wrapper"><span class="timestamp">[2023-05-12 Fri 22:19]</span></span> [‘순수 함수형’ 패키지 관리자 Nix 맛보기 | The Sapzil](https://blog.sapzil.org/2021/05/09/nix/)
...
(<a href="#citeproc_bib_item_6">“Sdedovic/Dotfiles Nix Home-Manager Stow” 2025</a>) Dedovic, Stevan 2025


### Nix for All and mouseless workflow {#nix-for-all-and-mouseless-workflow}

<span class="timestamp-wrapper"><span class="timestamp">[2023-05-12 Fri 22:19]</span></span> <https://github.com/noctuid/dotfiles>

(<a href="#citeproc_bib_item_5">“Noctuid/Dotfiles” 2024</a>)


### cmacrae/config NIX EMACS {#cmacrae-config-nix-emacs}

(<a href="#citeproc_bib_item_1">“Cmacrae/Config Nix Emacs” 2024</a>)

A collection of machine configurations, expressed in Nix


### ericdallo/dotfiles: Dotfiles for my NixOS system based on Dracula theme clojure doomemacs {#ericdallo-dotfiles-dotfiles-for-my-nixos-system-based-on-dracula-theme-clojure-doomemacs}

(<a href="#citeproc_bib_item_2">“Ericdallo/Dotfiles: Dotfiles for My Nixos System Based on Dracula Theme Clojure Doomemacs” 2025</a>)

Eric Dallo 2025

<span class="timestamp-wrapper"><span class="timestamp">[2025-06-20 Fri 15:27]</span></span> 홈매니저 활용 가능
...
### hlissner/dotfiles <span class="org-hashtag">#nix</span> {#hlissner-dotfiles-nix}

(<a href="#citeproc_bib_item_3">“Hlissner/Dotfiles #Nix” 2025</a>)
