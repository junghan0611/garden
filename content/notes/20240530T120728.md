...
<style>.csl-entry{text-indent: -1.5em; margin-left: 1.5em;}</style><div class="csl-bib-body">
  <div class="csl-entry">Dedovic, S. (2025). <i>Sdedovic/dotfiles nix home-manager stow</i> [Computer software]. <a href="https://github.com/sdedovic/dotfiles">https://github.com/sdedovic/dotfiles</a> (2021)</div>
  <div class="csl-entry">Eric Dallo. (2025). <i>Ericdallo/dotfiles: Dotfiles for my nixos system based on dracula theme clojure doomemacs</i> [Computer software]. <a href="https://github.com/ericdallo/dotfiles">https://github.com/ericdallo/dotfiles</a></div>
  <div class="csl-entry">Henrik Lissner. (2025). <i>Hlissner/dotfiles \#nix</i> [Computer software]. <a href="https://github.com/hlissner/dotfiles">https://github.com/hlissner/dotfiles</a> (2013)</div>
  <div class="csl-entry">Kiester, F. (2024). <i>Noctuid/dotfiles</i> [Computer software]. <a href="https://github.com/noctuid/dotfiles">https://github.com/noctuid/dotfiles</a> (2014)</div>
  <div class="csl-entry">MacRae, C. (2024). <i>Cmacrae/config nix emacs</i> [Computer software]. <a href="https://github.com/cmacrae/config">https://github.com/cmacrae/config</a> (2019)</div>
  <div class="csl-entry">Nix (package manager). (2024). In <i>Wikipedia</i>. <a href="https://en.wikipedia.org/w/index.php?title=Nix_(package_manager)&oldid=1224556819">https://en.wikipedia.org/w/index.php?title=Nix_(package_manager)&#38;oldid=1224556819</a></div>
</div>
