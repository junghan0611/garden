...
tags: ["emacs", "howtouse", "miniconda", "notes", "python"]
categories: ["Note"]
draft: false
---
...
-   [2024-09-23]({{< relref "/journal/20240923T000000.md" >}}) 최근에 아예 지웠다. 이맥스 패키지 문제 있어서. 여기에 하모니카 8.0으로 업그레이드 했다. 미니콘다 없이 하이랭 커버하면 굳이 필요 없을 것이다. 여기에 이슈는 또 (ag91 n.d.) 이 이슈도 있었다.
