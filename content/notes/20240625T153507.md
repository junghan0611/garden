...
## <span class="org-todo done DONT">DONT</span> 미니콘다 설치 및 터미널 동작 확인 {#미니콘다-설치-및-터미널-동작-확인}
...
## <span class="org-todo done DONT">DONT</span> 이맥스에서 확인해보자. {#이맥스에서-확인해보자-dot}
...
## <span class="org-todo done DONT">DONT</span> 콘다에서 필요한 패키지 설치 {#콘다에서-필요한-패키지-설치}
...
## <span class="org-todo done DONT">DONT</span> `텍스트 분석` : 콘다 환경 생성 시 YAML 파일 활용 {#텍스트-분석-콘다-환경-생성-시-yaml-파일-활용}
