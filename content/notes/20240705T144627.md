---
title: "#조테로: §zotFile 플러그인 문서 슬라이드 로컬 저장 연동"
description: "ZotFile로 문서와 슬라이드를 로컬에 저장하고 조테로와 이맥스 접근 흐름을 잇는 구성 기록."
date: 2024-07-05T14:46:00+09:00
lastmod: 2024-07-05T14:46:00+09:00
tags: ["attachment", "documents", "zotero", "zotfile", "pdf", "plugin"]
categories: ["Noname"]
draft: false
---
...
## §zotfile 플러그인 {#zotfile-플러그인}

<span class="timestamp-wrapper"><span class="timestamp">[2024-07-05 Fri 14:46]</span></span>

[#조테로: #플러그인 #활용법]({{< relref "/notes/20230816T070200.md" >}}) 의 확장으로서 플러그인을 활용한다.
...
{{< figure src="/images/20240705_143701_screenshot.png" >}}
