...
| `SPC b n` or `:bnext`     | Switch to the next buffer. (See [BROKEN LINK: special-buffers])     |
| `SPC b p` or `:bprevious` | Switch to the previous buffer. (See [BROKEN LINK: special-buffers]) |
