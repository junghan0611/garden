...
description: "깃허브 프로필과 오픈프로필 소개 문구를 다듬으며 온라인 자아를 어떻게 드러낼지 정리한 기록이다."
...
-   <span class="timestamp-wrapper"><span class="timestamp">[2026-03-18 Wed 16:51]</span></span> 업데이트 영문 버전
-   <span class="timestamp-wrapper"><span class="timestamp">[2025-12-21 Sun 16:11]</span></span> 업데이트
...
<div class="csl-bib-body">
  <div class="csl-entry"><a id="citeproc_bib_item_1"></a>“Junghan0611/Junghan0611 Github Profile.” 2025. <a href="https://github.com/junghan0611/junghan0611">https://github.com/junghan0611/junghan0611</a>.</div>
  <div class="csl-entry"><a id="citeproc_bib_item_2"></a>junghanacs. n.d. “힣/Sw대장장이/인생도구 on Openprofile.” Accessed May 24, 2025. <a href="https://open.kakao.com/me/junghanacs">https://open.kakao.com/me/junghanacs</a>.</div>
</div>
...
### 힣 _SW대장장이_ 인생도구 on Openprofile {#힣-sw대장장이-인생도구-on-openprofile}

-   (<a href="#citeproc_bib_item_2">junghanacs n.d.</a>)
-   junghanacs
...
(<a href="#citeproc_bib_item_1">“Junghan0611/Junghan0611 Github Profile” 2025</a>)

-   Han, Jung 2025
-   Personal README - AI Infra Architect | Polymath Engineer | Digital Gardener


## 2026-03-18 Junghan Kim (힣) {#2026-03-18-junghan-kim--힣}
...
<span class="timestamp-wrapper"><span class="timestamp">[2026-03-18 Wed 16:51]</span></span>
...
#### agent-config --- Memory Across Sessions {#agent-config-memory-across-sessions}
...
#### Shared Agenda --- Emacs as Meeting Ground {#shared-agenda-emacs-as-meeting-ground}
...
#### geworfen --- Thrown Into the World {#geworfen-thrown-into-the-world}
...
#### HomeAgent --- On-Device AI for IoT {#homeagent-on-device-ai-for-iot}
...
#### Why Clojure --- Code Is Data Is Shared Understanding {#why-clojure-code-is-data-is-shared-understanding}
...
#### Agent CLI Toolkit {#agent-cli-toolkit}
...
#### The Forge --- Reproducible Foundation {#the-forge-reproducible-foundation}
...
##### nixos-config --- Same Machine Everywhere {#nixos-config-same-machine-everywhere}
...
##### doomemacs-config --- The Shared Workshop {#doomemacs-config-the-shared-workshop}
...
##### Supporting -config Projects {#supporting-config-projects}
...
## 2025-12-21 👋 안녕하세요, 정한입니다 (힣) {#2025-12-21-안녕하세요-정한입니다--힣}

<span class="timestamp-wrapper"><span class="timestamp">[2025-12-21 Sun 16:11]</span></span>
