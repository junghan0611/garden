...
<style>.csl-entry{text-indent: -1.5em; margin-left: 1.5em;}</style><div class="csl-bib-body">
  <div class="csl-entry"><i>Emacs evil mode regular expression search and replace - emacs - makble</i>. (n.d.). Retrieved March 29, 2023, from <a href="http://makble.com/emacs-evil-mode-regular-expression-search-and-replace">http://makble.com/emacs-evil-mode-regular-expression-search-and-replace</a></div>
</div>
...
(<i>Emacs Evil Mode Regular Expression Search and Replace - Emacs - Makble</i>, n.d.)
