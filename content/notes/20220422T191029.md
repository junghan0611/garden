---
title: "@힣: 재능·노력·연습 — 지루함을 익숙한 도구로 건너는 법"
description: "재능과 노력, 연습의 차이를 지루함을 견디는 방식과 익숙한 도구의 힘으로 다시 해석한다. 노력은 의식적으로 지식을 구성하는 과정이고, 연습은 그 지식을 몸과 잠재기억에 심는 과정이라는 2022년 원석을 보존한다."
date: 2022-04-22T19:10:00+09:00
lastmod: 2026-07-29T06:37:00+09:00
tags: ["autholog", "effort", "practice", "skills", "talent"]
draft: false
---
...
-   <span class="timestamp-wrapper"><span class="timestamp">[2026-07-29 Wed 06:37]</span></span> @mitsein — GLG 검수 중 요청으로 표준 autholog 구조에 맞췄다. 한 줄·해설·이미지·원문 보존·후속 로그 보존을 분리하고, 보유기술/스킬 자석인 [재능·재주·능력 meta]({{< relref "/meta/20240414T224508.md" >}})와 다시 연결했다.
-   <span class="timestamp-wrapper"><span class="timestamp">[2025-06-13 Fri 06:12]</span></span> 관련 메타 추가
-   <span class="timestamp-wrapper"><span class="timestamp">[2022-04-22 Fri 19:10]</span></span> 재능 노력 연습의 의미
...
-   [† #재능 #재주 #능력 #노력 #연습 #지루함 #익숙함]({{< relref "/meta/20240414T224508.md" >}}) — 이 노트의 중심 자석. 보유기술·스킬 매트릭스까지 받는 능력 형성의 메타.
-   [† #메타도구 #대장장이 #호모파베르]({{< relref "/meta/20250224T132139.md" >}}) — 지루한 연습을 익숙한 도구와 따라하기로 건너는 도구 축.
-   [† #채용 #구직 #취업]({{< relref "/meta/20230814T144500.md" >}}) — 능력과 보유기술이 직무·포지션명으로 번역되는 채용 표면.


## 관련노트 {#관련노트}

-   [@힣: 링크드인 소개 업데이트 — 이력서가 아니라 시간축이 증언하는 공개키]({{< relref "/notes/20250515T103930.md" >}}) — 보유기술을 공개 채용어로 번역한 2026년 원석.
-   [§junghan0611: 깃허브 프로파일 이력서 — 영문 공개키]({{< relref "/botlog/20260318T183247.md" >}}) — 스킬 표면이 공개키/이력서 언어로 정리된 botlog.
-   [@폴그레이엄 #해커뉴스 #리스프]({{< relref "/bib/20231025T132200.md" >}}) — 원문이 들은 Paul Graham의 `How to Work Hard` 배경.
-   [@힣: 제주 재주 재수 - 정보과학회 전문가 막차]({{< relref "/notes/20240730T091506.md" >}}) — 재주와 재수, 능력과 운을 다시 묻는 후속 autholog.
...
## 노력과 연습을 나누어야 하는 이유 {#노력과-연습을-나누어야-하는-이유}
...
## 지루함에는 익숙한 도구로 따라하기 {#지루함에는-익숙한-도구로-따라하기}
...
## 보유기술로 다시 돌아오는 이유 {#보유기술로-다시-돌아오는-이유}
...
그러므로 [재능·재주·능력 meta]({{< relref "/meta/20240414T224508.md" >}})가 중요하다. 가든에서 능력은 소유물이 아니라 형성 과정이다. 재능은 멀리 두고, 노력은 기록하고, 연습은 몸에 심고, 익숙한 도구로 반복의 문턱을 낮춘다. 그 시간축이 쌓인 뒤에야 보유기술이라는 말이 허공의 키워드가 아니라 증거가 된다.


## 이미지 — 노력은 책상 위에, 연습은 얼음 바닥에 새겨진다 {#이미지-노력은-책상-위에-연습은-얼음-바닥에-새겨진다}
...
{{< figure src="/images/20260729T063610--world-glgman-universe-style-2d__brand_nanobanana.jpg" width="100%" >}}
...
## 원문 보존 — 2022 재능 노력 연습의 의미 {#원문-보존-2022-재능-노력-연습의-의미}
...
## 후속 로그 보존 — 2025 연습과 따라하기 {#후속-로그-보존-2025-연습과-따라하기}

> [!danger]
> 
> , \*\* [2025-02-08 W05]({{< relref "/journal/20250203T000000.md" >}}) 연습은 지루해서 못하겠다 - 그러면 따라하기 - 도구 빨도 좀 있다. <span class="timestamp-wrapper"><span class="timestamp">[2025-02-08 Sat 05:44]</span></span>
> 
...
### @user 재능 노력 연습의 영어 단어의 의미와 차이를 알려줘 {#user-재능-노력-연습의-영어-단어의-의미와-차이를-알려줘}
