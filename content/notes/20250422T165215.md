---
title: "@protesilaos @junghan0611 §emacs-lisp-elements 이맥스 리스프 가이드 #번역"
description: "Protesilaos의 Emacs Lisp Elements 가이드와 그 번역본을 함께 기록한 노트이다."
date: 2025-04-22T16:52:00+09:00
lastmod: 2025-04-22T16:52:00+09:00
tags: ["emacslisp", "guide", "bib", "translation"]
categories: ["Noname"]
draft: false
---
...
<div class="csl-bib-body">
  <div class="csl-entry"><a id="citeproc_bib_item_1"></a>“Junghan0611/Emacs-Lisp-Elements.” 2025. <a href="https://github.com/junghan0611/emacs-lisp-elements">https://github.com/junghan0611/emacs-lisp-elements</a>.</div>
  <div class="csl-entry"><a id="citeproc_bib_item_2"></a>“Protesilaos/Emacs-Lisp-Elements.” 2025. <a href="https://github.com/protesilaos/emacs-lisp-elements">https://github.com/protesilaos/emacs-lisp-elements</a>.</div>
  <div class="csl-entry"><a id="citeproc_bib_item_3"></a>Stavrou, Protesilaos. 2025. “Emacs Lisp Elements.” April 13, 2025. <a href="https://protesilaos.com/emacs/emacs-lisp-elements">https://protesilaos.com/emacs/emacs-lisp-elements</a>.</div>
</div>


## History {#history}

-   <span class="timestamp-wrapper"><span class="timestamp">[2025-04-22 Tue 16:52]</span></span> 그래 담아. 확인


### <span class="org-todo done DONE">DONE</span> 매뉴얼 Emacs Lisp Elements {#매뉴얼-emacs-lisp-elements}

(<a href="#citeproc_bib_item_3">Stavrou 2025</a>) Stavrou, Protesilaos 2025
...
(<a href="#citeproc_bib_item_1">“Junghan0611/Emacs-Lisp-Elements” 2025</a>) Han, Jung 2025 A book that provides a big picture view of the Emacs Lisp programming language.


#### protesilaos/emacs-lisp-elements {#protesilaos-emacs-lisp-elements}

(<a href="#citeproc_bib_item_2">“Protesilaos/Emacs-Lisp-Elements” 2025</a>) Stavrou, Protesilaos 2025


## 한글 번역 {#한글-번역}

-   <span class="timestamp-wrapper"><span class="timestamp">[2025-04-22 Tue 17:19]</span></span> gemini 번역
-   [Emacs Lisp Elements | Protesilaos Stavrou - protesilaos.com](https://protesilaos.com/emacs/emacs-lisp-elements)


### 1\\. Emacs Lisp 시작하기 - Getting started with Emacs Lisp {#1-dot-emacs-lisp-시작하기-getting-started-with-emacs-lisp}
...
### 2\\. Emacs Lisp 평가하기 - Evaluate Emacs Lisp {#2-dot-emacs-lisp-평가하기-evaluate-emacs-lisp}
...
### 3\\. 부작용 및 반환 값 Side effect and return value {#3-dot-부작용-및-반환-값-side-effect-and-return-value}
...
### 4. Buffers as data structures {#4-dot-buffers-as-data-structures}
...
### 5. Text has its own properties {#5-dot-text-has-its-own-properties}
...
### 6. Symbols, balanced expressions, and quoting {#6-dot-symbols-balanced-expressions-and-quoting}
...
### 7. Evaluate some elements inside of a list {#7-dot-evaluate-some-elements-inside-of-a-list}
...
### 8. Evaluation inside of a macro or special form {#8-dot-evaluation-inside-of-a-macro-or-special-form}
...
### 9. Mapping through a list of elements {#9-dot-mapping-through-a-list-of-elements}
...
### 10. The match data of the last search {#10-dot-the-match-data-of-the-last-search}
...
### 11. Switching to another buffer, window, or narrowed state {#11-dot-switching-to-another-buffer-window-or-narrowed-state}
...
### 12. Basic control flow with `if`, `cond` , and others {#12-dot-basic-control-flow-with-if-cond-and-others}
...
### 13. Control flow with `if-let*`  and friends {#13-dot-control-flow-with-if-let-and-friends}
...
### 14. Pattern match with `pcase`  and related {#14-dot-pattern-match-with-pcase-and-related}
...
### 15. Run some code or fall back to some other code {#15-dot-run-some-code-or-fall-back-to-some-other-code}
...
### 16. When to use a named function or a lambda function {#16-dot-when-to-use-a-named-function-or-a-lambda-function}
...
### 17. Make your interactive function also work from Lisp calls {#17-dot-make-your-interactive-function-also-work-from-lisp-calls}
