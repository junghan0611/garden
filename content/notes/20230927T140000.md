...
<style>.csl-entry{text-indent: -1.5em; margin-left: 1.5em;}</style><div class="csl-bib-body">
  <div class="csl-entry">Depoix, J. (2025). <i>Jdepoix/youtube-transcript-api</i> [Computer software]. <a href="https://github.com/jdepoix/youtube-transcript-api">https://github.com/jdepoix/youtube-transcript-api</a> (2018)</div>
  <div class="csl-entry"><i>Yt-dlp/yt-dlp</i>. (2025). [Computer software]. yt-dlp. <a href="https://github.com/yt-dlp/yt-dlp">https://github.com/yt-dlp/yt-dlp</a> (2020)</div>
</div>
