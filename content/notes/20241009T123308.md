---
title: "#이맥스 #통합개발환경: #R언어 #ESS"
description: "R과 ESS, 그리고 Quarto 흐름을 이맥스 통합개발환경으로 가져오는 설치 기록이다. 실제 활용 흐름을 담았다."
date: 2024-10-09T12:33:00+09:00
lastmod: 2024-12-01T06:30:00+09:00
tags: ["emacside", "rlang", "rstudio", "quarto"]
categories: ["Noname"]
draft: false
---
...
## 리눅스 R언어 패키지 설치 - 우분투 {#리눅스-r언어-패키지-설치-우분투}
...
## <span class="org-todo done DONE">DONE</span> [#콰르토]({{< relref "/meta/20241006T075550.md" >}}) 관련하여 필요한 패키지 {#h-df5879e4-2b8d-40d5-b2a3-5bdaf21cf410}

<span class="timestamp-wrapper"><span class="timestamp">[2025-02-12 Wed 15:51]</span></span>
...
## <span class="org-todo done DONT">DONT</span> <span class="org-hashtag">#둠이맥스</span> ESS 모듈 활용 {#둠이맥스-ess-모듈-활용}
