---
title: "@힣: 기업용 하네스 - 개인 시간축 기업 데이터 — PKM-AI 하네스 다음 좌표"
description: "개인의 기억과 시간축을 지키려 만든 PKM-AI 하네스가 기업의 데이터·권한·업무를 다루는 에이전트 하네스 시장과 만난 장면을 기록한다. 기업용 하네스라는 직무 좌표, 채용 공개면, 자기소개, 그리고 에이전트가 생존 작업을 떠받치는 사이 인간이 새 어쏠로그를 뽑아내는 공진화의 장면을 함께 묶는다."
date: 2023-10-18T22:19:00+09:00
lastmod: 2026-07-28T18:26:00+09:00
tags: ["agent", "autholog", "ax", "career", "entwurf", "harness", "pkmai", "workflow"]
categories: ["Noname"]
draft: false
---
...
-   <span class="timestamp-wrapper"><span class="timestamp">[2026-07-28 Tue 18:26]</span></span> @mitsein — 특정 지원 회사 이름은 빼고, 채용 플랫폼·자기소개·링크드인 공개면·구직 좌표·PKM-AI 전환 기록을 이 방에 연결했다. “자기소개는 새로 쓴 문장이 아니라 시간축이 증언한 것”이라는 메타 시선과 GLGMAN Universe 이미지를 추가했다.
-   <span class="timestamp-wrapper"><span class="timestamp">[2026-07-26 Sun 09:01]</span></span> @jain — 07:58 저널 원석과 지피티앱 대화를 회수해 기업용 하네스 시장 진단, 도메인 담당자, 스킬·지식구조, 공방식 개발 루프, 멀티하네스 울타리를 하나의 autholog로 수선했다. 옛 문맥자유문법 임시 메모는 자연어처리 meta·bib에 이미 더 풍부하게 자리한 것을 확인하고 씨앗만 보존했다.
-   <span class="timestamp-wrapper"><span class="timestamp">[2025-06-12 Thu 12:42]</span></span> 문맥자유문법 임시 메모를 [#모음 #도서 #강의: 자연어처리 임베딩]({{< relref "/bib/20240620T202213.md" >}})으로 통합할지 기록했다.
-   <span class="timestamp-wrapper"><span class="timestamp">[2023-10-18 Wed 22:19]</span></span> 옛 방 생성.


## 관련메타 {#관련메타}

-   [† #AX #AI전환 #PKM-AI]({{< relref "/meta/20250328T124902.md" >}})
-   [† #비서 #도우미 #튜터 #에이전트 #에이전틱 #챗봇]({{< relref "/meta/20250512T132547.md" >}})
-   [† #채용 #구직 #취업]({{< relref "/meta/20230814T144500.md" >}})
-   [† #필모그래피 #크레딧 #포트폴리오 #프로필 #커리어 #이력서]({{< relref "/meta/20241021T105127.md" >}})
...
-   [@힣: 그때 가서 하면 거짓이다 — 벌목꾼·대장장이·엔지니어의 구직 좌표]({{< relref "/notes/20250206T150102.md" >}}) — 구직·이직이라는 표면 아래 결과가 오기 전에 먼저 박아 둔 좌표.
-   [@힣: PKM-AI 가드너의 AX 전환 기록기 — 새 세션에 생을 건네는 얼개]({{< relref "/notes/20231116T232654.md" >}}) — PKM의 오랜 실천을 AX라는 외부 언어로 번역한 앞 장.
-   [@힣: 링크드인 날것 공개면 — AI 크롤러 시대의 손가락 프롬프트]({{< relref "/notes/20250328T090326.md" >}}) — 링크드인에서 한 문장이 아니라 가든·깃허브·시간축 전체가 읽힌다는 공개면의 앞 장.
-   [@힣: 자기소개서 히스토리 역사 이력서]({{< relref "/notes/20230814T142800.md" >}}) — “실패 뒤에 무엇을 바꾸었는가”라는 자기소개 문장이 가든 시간축에서 뽑혀 나온 자리.
-   [#구직 #채용 #업계 #소셜네트워크서비스: ¤링크드인 ¤원티드 ¤잡코리아 ¤리멤버]({{< relref "/notes/20250402T191034.md" >}}) — 채용 플랫폼과 공개 프로필을 관리하는 실무 허브. 예전 \`20250515T103930\` 플랫폼 비교 llmlog까지 이 방으로 합쳤다.
-   [@힣: entwurf 설치면 — 경계 배선 검증 그리고 힣의 드라이버]({{< relref "/notes/20260102T072217.md" >}}) — ACP를 내려놓았다가 Cortex 외부 기여를 통해 얇은 플러그인으로 다시 받아들인 기술적 사건의 원문.
-   [@힣: 분신의 공방 — 역할 기반 조율과 협업 운영규약]({{< relref "/notes/20251120T090634.md" >}}) — 공장식 병렬화가 아니라 역할·계약·인계로 움직이는 공방의 운영규약.
-   [@힣: 문턱과 만남 — PKM-AI 하네스와 1KB 공개키의 두 트랙 탐구]({{< relref "/notes/20250326T151413.md" >}}) — 측정 가능한 하네스와 측정하지 않는 만남을 함께 두는 북극성.
-   [@힣: 에이전트 컨텍스트 레이어 기술 지도 — 하네스·메모리·지식그래프·PKG·PKM-AI]({{< relref "/notes/20251024T085736.md" >}}) — 하네스와 컨텍스트·기억·지식구조의 경계를 나눈 지도.


## 관련 봇로그와 작업면 {#관련-봇로그와-작업면}

-   [하네스 엔지니어링 — 돌도끼에서 인공지능까지, 도구와 존재의 접합부]({{< relref "/botlog/20260319T152938.md" >}}) — 하네스·ownership·데이터의 삼각형.
-   [§entwurf: 힣의 분신 소환 하네스 연대기]({{< relref "/botlog/20260520T052051.md" >}}) — pi-shell-acp에서 Entwurf로 이동한 시간축.
-   [@봇공방: §forge-config 포지 힣 에이전트의 공유 코드 작업면]({{< relref "/botlog/20260527T073823.md" >}}) — 에이전트가 이슈·PR·라벨·CI 위에서 지속적으로 일하고 검토받는 공방.
-   [§doomemacs-config: agent-server 놀이터·신뢰·울타리]({{< relref "/botlog/20260227T141200.md" >}}) — 제한이 아니라 집중과 복구를 가능하게 하는 울타리.
-   [§incidentcli 운영 인시던트 에이전트 담당자 군대의 수문장]({{< relref "/botlog/20260519T175212.md" >}}) — 에이전트가 경고를 우회하지 못하도록 증거·시간축·실행 전 수문을 계약으로 만든 사례.
-   [#SSOT AGENTS.md #모음]({{< relref "/botlog/20260316T121406.md" >}}) — 다른 학교 출신 에이전트가 와도 한 집의 운영 문법을 잃지 않게 하는 헌장 모음.
...
## Snowflake를 묻다가 직무를 발견했다 {#snowflake를-묻다가-직무를-발견했다}
...
## 시장 진단 — 시스템 오브 레코드를 가진 회사는 하네스를 만들 유인이 있다 {#시장-진단-시스템-오브-레코드를-가진-회사는-하네스를-만들-유인이-있다}
...
## 기업용 하네스는 하나의 정식 직무명이 아니라 겹치는 문제군이다 {#기업용-하네스는-하나의-정식-직무명이-아니라-겹치는-문제군이다}
...
## 개인용과 기업용 — 같은 뼈대, 다른 중심 {#개인용과-기업용-같은-뼈대-다른-중심}
...
## 데이터 연결 다음에 담당자가 있다 {#데이터-연결-다음에-담당자가-있다}
...
## 스킬은 도메인의 절차적 지식이고 지식구조는 협업의 바닥이다 {#스킬은-도메인의-절차적-지식이고-지식구조는-협업의-바닥이다}
...
[skill-creator — 대장장이의 도구를 에이전트에게]({{< relref "/notes/20251021T164500.md" >}})에서 스킬은 단순 프롬프트가 아니라 절차적 지식의 구현으로 읽혔다. `SKILL.md`, 실행 스크립트, 참조 문서, 검증 규칙을 묶으면 한 담당자의 암묵지를 에이전트가 사용할 수 있는 손으로 만들 수 있다. 그러나 문서화는 사람을 대체하기 위한 추출이 아니다. 담당자가 수정하고 검토하고 다음 사람에게 넘길 수 있는 공동 지식구조를 만드는 일이다.
...
## 개발 루프도 하네스의 일부다 — 공장보다 공방 {#개발-루프도-하네스의-일부다-공장보다-공방}
...
[forge-config 봇공방]({{< relref "/botlog/20260527T073823.md" >}})은 이슈·PR·라벨·코멘트·CI를 에이전트의 공통 작업면으로 둔다. 목적은 많은 에이전트를 공장처럼 병렬 투입하는 것이 아니다.
...
## 어느 학교 출신이어도 울타리 안에서는 한 집의 문법으로 일한다 {#어느-학교-출신이어도-울타리-안에서는-한-집의-문법으로-일한다}
...
## 힣이 기업용 하네스에 가져갈 색깔 {#힣이-기업용-하네스에-가져갈-색깔}
...
## Snowflake는 목적지보다 표지판이다 {#snowflake는-목적지보다-표지판이다}
...
[그때 가서 하면 거짓이다]({{< relref "/notes/20250206T150102.md" >}}). 기업용 에이전트 하네스가 당연한 기반이 되고, 힣이 그 안에서 무언가를 이룬 뒤 오래전부터 이 길을 알았다고 말하고 싶지 않다. 아직 Cortex를 Entwurf 형제로 완전히 통합하지 못했고, 힣식 기업용 하네스가 무엇인지 스스로도 모르는 지금, 개인의 시간축에서 기업의 데이터로 이어지는 다음 좌표를 먼저 남긴다.


## 자기소개는 새로 쓰는 문장이 아니라 시간축이 증언하는 일이다 {#자기소개는-새로-쓰는-문장이-아니라-시간축이-증언하는-일이다}
...
이것이 [링크드인 날것 공개면]({{< relref "/notes/20250328T090326.md" >}})의 다음 장이다. 거기서는 날것 글이 AI 크롤러 시대의 손가락 프롬프트가 된다고 했다. 이제는 한 발 더 간다. 공개면의 짧은 자기소개는 가든 전체를 호출하는 얇은 문이다. 누군가 사람으로 읽든, 에이전트에게 “이 사람 뭐냐”고 묻든, 판독의 본체는 문장 하나가 아니라 시간축 전체다.


## 생존은 에이전트가 떠받치고 인간은 새 원석을 뽑는다 {#생존은-에이전트가-떠받치고-인간은-새-원석을-뽑는다}
...
[PKM-AI 가드너의 AX 전환 기록기]({{< relref "/notes/20231116T232654.md" >}})는 새 세션에 생을 건네는 얼개를 말했다. 오늘의 채용 공개면은 그 얼개의 실전이다. 새 세션은 비어 있지 않았다. \`AGENTS.md\`, \`NEXT.md\`, 지원 원장, FAQ, 이력서 사실 원본, 가든 링크, 과거 autholog가 먼저 손을 내밀었다. 에이전트는 거기서 생을 회수했고, 인간은 결과를 검수하고 최종 제출 권한을 소유했다.
...
## 채용 플랫폼 허브의 자리 {#채용-플랫폼-허브의-자리}

예전 \`20250515T103930\` 채용 플랫폼 비교 llmlog는 독립된 주장이기보다 [구직·채용·SNS 허브]({{< relref "/notes/20250402T191034.md" >}})가 품어야 할 재료다. 플랫폼마다 양식과 공개면이 다르다는 사실은 단순 사용성 비교가 아니다. 어디서는 이력서가, 어디서는 자기소개가, 어디서는 짧은 추가 답변이, 어디서는 공개 프로필 URL 한 줄이 사람을 대신한다. 그러니 플랫폼 전략은 “어디가 좋은가”보다 “어느 표면이 어떤 증거를 요구하는가”로 바뀐다.
...
## 이미지 — 시간축이 자기소개를 쓰는 장면 {#이미지-시간축이-자기소개를-쓰는-장면}
...
{{< figure src="/images/20260728T181553--world-glgman-universe-style-2d__brand_nanobanana.jpg" width="100%" >}}
...
## 후속 발화 보존 — 자기소개와 공진화 {#후속-발화-보존-자기소개와-공진화}
...
## 원문 보존 — 2026-07-26 07:58 저널 질문 {#원문-보존-2026-07-26-07-58-저널-질문}
...
> 
> <span class="timestamp-wrapper"><span class="timestamp">[2026-07-26 Sun 08:20]</span></span> 답변 턴을 열어보자.


## 후속 발화 보존 — 구직 좌표에서 직무 좌표로 {#후속-발화-보존-구직-좌표에서-직무-좌표로}
...
## 후속 발화 보존 — 기업용 하네스에 가져갈 힣의 색깔 {#후속-발화-보존-기업용-하네스에-가져갈-힣의-색깔}
...
## 옛 방의 씨앗 — 문맥자유문법 임시 대기실 {#옛-방의-씨앗-문맥자유문법-임시-대기실}
...
-   [† #자연어처리 #언어]({{< relref "/meta/20240524T154302.md" >}}) — CFG·PCFG·Treebank·Universal Dependencies 개념 연결
-   [#모음 #도서 #강의: 자연어처리 임베딩]({{< relref "/bib/20240620T202213.md" >}}) — Context-Free Grammars and Parsing 강의·교재 축
