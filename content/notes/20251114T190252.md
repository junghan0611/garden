...
description: "리포지토리 중심으로 Denote Silo를 동적으로 관리하는 시스템 개요 노트이다. 실제 활용 흐름을 담았다."
date: 2025-11-14T19:02:00+09:00
lastmod: 2025-11-14T19:02:00+09:00
tags: ["denote", "dynamic", "management", "repos", "silo"]
draft: false
---
...
## 설정된 Silo 목록 {#설정된-silo-목록}


### 기본 Silo (고정) {#기본-silo--고정}
...
#### 2. 특정 프로젝트 문서 찾기 {#2-dot-특정-프로젝트-문서-찾기}
...
#### 3. 전체 Silo에서 파일 검색 {#3-dot-전체-silo에서-파일-검색}
...
#### 4. 새 프로젝트 추가 후 갱신 {#4-dot-새-프로젝트-추가-후-갱신}
...
### Silo가 인식되지 않을 때 {#silo가-인식되지-않을-때}
