...
description: "Emacs와 AI를 MCP와 REPL 중심 협업 패러다임으로 다시 묶어 보는 노트이다. 실제 활용 흐름을 담았다."
...
##### <span class="org-todo done DONT">DONT</span> Emigo {#emigo}
...
-   [agent-shell + OpenCode 커스텀 가이드]({{< relref "/notes/20251121T131412.md" >}})
-   [브라우저 자동화 도구 비교]({{< relref "/notes/20251121T122829.md" >}})
