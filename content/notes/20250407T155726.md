...
<style>.csl-entry{text-indent: -1.5em; margin-left: 1.5em;}</style><div class="csl-bib-body">
  <div class="csl-entry"><a id="citeproc_bib_item_1"></a><i>Emacs-eaf/emacs-application-framework</i>. (2024). [Computer software]. Emacs Application Framework. <a href="https://github.com/emacs-eaf/emacs-application-framework">https://github.com/emacs-eaf/emacs-application-framework</a> (2018)</div>
</div>
...
(<a href="#citeproc_bib_item_1"><i>Emacs-Eaf/Emacs-Application-Framework</i>, 2018/2024</a>)
...
### DONT 실패: 시스템 패키지로 설치해야 동작한다 {#dont-실패-시스템-패키지로-설치해야-동작한다}
