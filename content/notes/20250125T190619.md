---
title: "조합형 NFD 자모를 완성형 NFC 음절 변환 - 정규화"
date: 2025-01-25T19:06:00+09:00
lastmod: 2025-11-15T21:11:43+09:00
tags: ["llmlog", "unicode", "utf8", "pandoc", "encoding", "hangul"]
categories: ["Noname"]
draft: false
---
...
<style>.csl-entry{text-indent: -1.5em; margin-left: 1.5em;}</style><div class="csl-bib-body">
  <div class="csl-entry"><a id="citeproc_bib_item_1"></a><i>Astoff/code-cells.el: Emacs utilities for code split into cells, including jupyter notebooks</i>. (n.d.). [Computer software]. Retrieved January 28, 2025, from <a href="https://github.com/astoff/code-cells.el">https://github.com/astoff/code-cells.el</a></div>
  <div class="csl-entry"><a id="citeproc_bib_item_2"></a>Han, J. (2025). <i>Junghan0611/ds-book</i> [Computer software]. <a href="https://github.com/junghan0611/ds-book">https://github.com/junghan0611/ds-book</a> (2025)</div>
</div>


## 히스토리 {#히스토리}

-   <span class="timestamp-wrapper"><span class="timestamp">[2025-11-14 Fri 08:05] </span></span> 링크 엄청 중요한 문제를 해결한 것이다.
...
-   <span class="timestamp-wrapper"><span class="timestamp">[2025-01-25 Sat 19:06] </span></span> 생성 문제 해결 NFC(완성형)와 NFD(분해형)


## 완벽한 한글 처리를 위한 두 가지 이슈 해결 {#완벽한-한글-처리를-위한-두-가지-이슈-해결}

이맥스를 사용하지 않더라도 앞으로 터미널 환경에서 AI 에이전트와 협업하려면 반드시 마주칠 수 있는 귀한 정보입니다. UTF-8 정규화 문제의 완벽한 해결책입니다.


### 1️⃣ 이슈 #1: Confluence 문서 변환 시 한글 깨짐 {#1️⃣-이슈-1-confluence-문서-변환-시-한글-깨짐}
...
##### Python 스크립트 (memex-kb 프로젝트) {#python-스크립트--memex-kb-프로젝트}
...
##### 후처리 (Fenced Div 제거) {#후처리--fenced-div-제거}
...
### 2️⃣ 이슈 #2: Termux Emacs 실시간 한글 입력 문제 {#2️⃣-이슈-2-termux-emacs-실시간-한글-입력-문제}


#### 문제 상황 (가장 심각한 이슈!) {#문제-상황--가장-심각한-이슈}
...
#### 원인 분석 (UTF-8 Normalization) {#원인-분석--utf-8-normalization}
...
#### 해결 방법 (실시간 변환!) {#해결-방법--실시간-변환}


##### Emacs Lisp 패키지 {#emacs-lisp-패키지}
...
###### 자동 활성화 (Termux 감지) {#자동-활성화--termux-감지}
...
## 조합형 자모를 완성형 음절로 변환 문제 {#조합형-자모를-완성형-음절로-변환-문제}
...
<span class="timestamp-wrapper"><span class="timestamp">[2025-02-09 Sun 11:51]</span></span> (<a href="#citeproc_bib_item_1"><i>Astoff/Code-Cells.El: Emacs Utilities for Code Split into Cells, Including Jupyter Notebooks</i>, n.d.</a>)
