...
description: "지능형 홈 지원 사업과 현재 프로젝트들을 Zigbee·Thread·Matter 축으로 연결한 노트이다."
...
> [!abstract] 이 노트에 대하여
> 
> 지능형 홈 허브 프로젝트들과 디지털가든의 연결고리를 Zigbee와 Thread, Matter, 임베디드 개발 맥락에서 정리한다. 현재 작업을 더 큰 아키텍처 안에 위치시키는 노트다.
