...
description: "할일 목록을 무작위로 섞어 보는 Org-mode 시간관리 아이디어를 정리한 노트이다. 실제 활용 흐름을 담았다."
...
> [!abstract] 이 노트에 대하여
> 
> 미정의된 할일을 섞어 뽑는 방식으로 TODO 목록을 다루는 Org-mode 아이디어를 기록한다. 시간의 유한함을 받아들이면서도 일을 흘러가는 강처럼 대하려는 감각이 드러난다.
...
## 2024-12-19 버크먼 책에 실습 {#2024-12-19--버크먼-책에-실습}

할일 목록 만드는 부분을 참고하고 넣다.

[@올리버버크먼: #4000주 #불완전주의 #삶의유한함 #받아들임::시간의 유한함을 받아들이는 방법 10]({{< relref "/bib/20241022T145747.md#h-a8cc3588-07f8-4e4b-9541-c6c5e94da07b" >}})


## <span class="org-todo todo TODO">TODO</span> Shuffling my Org Mode unscheduled tasks <span class="org-hashtag">#orgql</span> {#shuffling-my-org-mode-unscheduled-tasks-orgql}
