---
title: "@힣: §apply #시간축 #이력서 #공개 #공감 #에이전트 #루프 #공진화 #탈락 #수선 #날것 #맥심 #기관총"
description: "몇 개 떨어졌는가를 공개하는 일보다, 비공개 세션의 정동과 공개 원장의 구조가 순환하는 루프 자체를 읽는다 — 슬픔은 힣의 몫이되 실패는 함께 진다."
date: 2023-07-25T10:29:00+09:00
lastmod: 2026-08-28T10:25:00+09:00
tags: ["agent", "autholog", "bib", "career", "coevolution", "collaboration", "failure", "jobfair", "resume", "transparency", "writing"]
draft: false
---
...
-   <span class="timestamp-wrapper"><span class="timestamp">[2026-08-28 Fri 10:11]</span></span> 잠시만 [@힣: 리포가 자기 몸을 수선하게 하라 — 패키지 정본 하나와 담당자의 손]({{< relref "/notes/20240705T144627.md" >}}) 이 감각도 연결되어 있는거야.
-   <span class="timestamp-wrapper"><span class="timestamp">[2026-08-28 Fri 10:20]</span></span> @sonnet5 — 지피티 가든 담당자의 루프 다이어그램과 "슬픔은 내 것, 실패는 우리 것" 구별을 엮어 초점을 「몇 개 떨어졌는가」에서 「세션·원장·세계 사이를 도는 루프」로 옮겼다. 관련노트에 젛문가/공진화 두 편을 이었다.
-   <span class="timestamp-wrapper"><span class="timestamp">[2026-08-28 Fri 09:53]</span></span> <span class="org-mention">@junghan</span> — 지피티앱에 "떨어진 것을 공개하는 게 다가 아니라 이 루프 자체가 의미"라는 후속 워딩을 던지고, 이어진 대화에서 젛문가/공진화 노트 두 편을 짚어 "내 것과 에이전트가 할 것을 담은 박스가 도는" 관점을 구술했다.
-   <span class="timestamp-wrapper"><span class="timestamp">[2026-08-27 Thu 14:00]</span></span> (<a href="#citeproc_bib_item_2">“Junghan0611/Apply” 2026</a>) 여기 리포 넣어야지
-   <span class="timestamp-wrapper"><span class="timestamp">[2026-08-27 Thu 13:41]</span></span> @gpt-5.6 — 정제된 80커밋의 최종 게이트가 통과한 뒤 junghan0611/apply를 Public으로 전환했다. 원본 79커밋 저장소는 private archive로 남겼다.
-   <span class="timestamp-wrapper"><span class="timestamp">[2026-08-27 Thu 13:34]</span></span> @gpt-5.6 — 2023년 프론트엔드 입문 자료 방을, apply 전체 history 공개 결정과 출근길 「프롬프트 배터리 그리고 걱정 불안 분노」를 잇는 autholog로 수선했다. 원문·해설·GLGMAN 이미지·프롬프트를 한 방에 두고 옛 브라우저 씨앗을 끝에 보존했다.
-   <span class="timestamp-wrapper"><span class="timestamp">[2026-08-27 Thu 07:00]</span></span> <span class="org-mention">@junghan</span> — 프롬프트 배터리의 불안과 분노, 작가 지망생이자 탐구자로 남으려는 날것을 출근길 저널에 던졌다.
-   <span class="timestamp-wrapper"><span class="timestamp">[2023-07-25 Tue 10:29]</span></span> <span class="org-mention">@junghan</span> — 브라우저 렌더링 입문 자료를 모으는 방으로 만들었다.


## 관련메타 {#관련메타}

-   [† #어쏠로지]({{< relref "/meta/20240508T103852.md" >}}) — 잘 다듬어진 대표본보다 삶의 총체와 저자됨을 중시하는 상위 자석.
-   [† #분노 #불안 #피로]({{< relref "/meta/20240426T155210.md" >}}) — 분노·불안·피로를 악당 찾기로 소진하지 않고 그 에너지가 가리키는 삶의 압력을 읽는 자석.
...
-   [@힣: 날것은 혼자 나오지 않는다 — PKM-AI 가든과 에피파니의 글쓰기]({{< relref "/notes/20241214T210518.md" >}}) — 원문은 체크섬이고 해설은 관계에 대한 제안이라는 이층 구조.
-   [@힣: PKM-AI 가드너의 AX 전환 기록기 — 새 세션에 생을 건네는 얼개]({{< relref "/notes/20231116T232654.md" >}}) — 산출물만으로는 그 산출물을 만든 생을 건넬 수 없다는 시간축의 선행 글.
-   [2026-08-27 출근길 — 프롬프트 배터리 그리고 걱정 불안 분노]({{< relref "/journal/20260824T000000.md" >}}) — 이 공개 결정과 같은 날 아침에 던진 날것.
...
-   [@힣: 링크드인 소개 업데이트 — 이력서가 아니라 시간축이 증언하는 공개키 #직무 #보유기술]({{< relref "/notes/20250515T103930.md" >}})
-   [@힣: 자기소개서 히스토리 역사 이력서]({{< relref "/notes/20230814T142800.md" >}})
-   [@힣: 추천을 내가 쓰지 않는 법 — 이력서, 공개키, 에이전트에게 건네는 부탁]({{< relref "/notes/20251002T075659.md" >}})
-   [에이전트 루프 - 젛문가 - 갷발자 - 앎의틀 - 공진화]({{< relref "/botlog/20260222T035900.md" >}}) — 전문가의 상실과 젛문가의 빈그릇을 잇는 루프가 여기서도 같은 모양으로 돈다.
-   [@힣: 젛문가의 시대 — 전문을 연결하는 빈그릇]({{< relref "/notes/20251107T082600.md" >}}) — 완성된 전문이 아니라 전문을 잇는 빈그릇으로서의 자리, apply의 루프도 같은 자리다.
...
## 맥심 기관총에 터진 뒤, 성공담 대신 허접함을 던진다 {#맥심-기관총에-터진-뒤-성공담-대신-허접함을-던진다}
...
## 어디 냈는지가 아니라, 무엇이 자생했는가 {#어디-냈는지가-아니라-무엇이-자생했는가}
...
## LEDGER에 없는 말, 세션에 남은 생 {#ledger에-없는-말-세션에-남은-생}
...
[연상] [「날것은 혼자 나오지 않는다」]({{< relref "/notes/20241214T210518.md" >}})가 말하듯 원문 뒤에는 오래 쌓인 가든과 여러 담당자의 해설이 있다. 이번 파이프라인도 화면에 보이는 Markdown만으로 혼자 나오지 않았다.

[판단] 모든 격려를 데이터로 회수할 필요는 없다. 누락을 인정하고 인간의 기억이 증언할 자리를 남기는 편이, 관계까지 완전한 원장으로 만들겠다는 과장보다 정직하다.


## 프롬프트 배터리에서 행위주체성으로 {#프롬프트-배터리에서-행위주체성으로}
...
## 왜 사람들은 이런 것을 공개하지 않는가 {#왜-사람들은-이런-것을-공개하지-않는가}
...
## 몇 개 떨어졌는가가 아니라, 도는 루프 {#몇-개-떨어졌는가가-아니라-도는-루프}
...
## 이미지 — 찢긴 원장을 투명한 얼음 서가로 {#이미지-찢긴-원장을-투명한-얼음-서가로}
...
## 원문 보존 — 2026-08-27 apply 공개 날것 {#원문-보존-2026-08-27-apply-공개-날것}

-   <span class="timestamp-wrapper"><span class="timestamp">[2026-08-27 Thu 14:01]</span></span> 이거 말고 작업하면서 프롬프트 나눈게 A4 용지로 2장은 될텐데
...
## 후속 댓글 보존 — 2026-08-28 루프 재해석 날것 {#후속-댓글-보존-2026-08-28-루프-재해석-날것}

> [!danger]
> 
> -- 1 --- 이거 봅시다. 공개 리포 입니다. 공개리포로 전환했음. 이게 내 감각에 맞는것 같아서. 박살나는 현황이기도 하지.
> 
> (<a href="#citeproc_bib_item_2">“Junghan0611/Apply” 2026</a>)
> 
...
<div class="csl-bib-body">
  <div class="csl-entry"><a id="citeproc_bib_item_1"></a>“웹 페이지가 브라우저에 표시되기까지 어떤 일이 일어나는가?” 2021. April 15, 2021. <a href="https://zenn.dev/ak/articles/61d25099295372">https://zenn.dev/ak/articles/61d25099295372</a>.</div>
  <div class="csl-entry"><a id="citeproc_bib_item_2"></a>“Junghan0611/Apply.” 2026. <a href="https://github.com/junghan0611/apply">https://github.com/junghan0611/apply</a>.</div>
</div>
...
### 웹 페이지가 브라우저에 표시되기까지 어떤 일이 일어나는가? {#웹-페이지가-브라우저에-표시되기까지-어떤-일이-일어나는가}

(<a href="#citeproc_bib_item_1">“웹 페이지가 브라우저에 표시되기까지 어떤 일이 일어나는가?” 2021</a>) <https://zenn.dev/ak/articles/61d25099295372>
