...
### Modernizing my Python development setup in Emacs {#modernizing-my-python-development-setup-in-emacs}

(Paul Winkler 2024)


### Python in Emacs: Vanilla is a Powerful Flavor {#python-in-emacs-vanilla-is-a-powerful-flavor}
...
### virtualenv project deps {#virtualenv-project-deps}
...
## #pipx `머신러닝` 파이썬 패키지 설치 {#h:f68445a8-f195-4eac-88e2-4338c92d8de3}
