...
tags: ["bib", "emacside", "notes", "python"]
categories: ["Noname"]
draft: false
---
...
[주피터 파이썬 리눅스 모든 것]({{< relref "/notes/20250222T190241.md" >}})을 본다. 그 다음에 이맥스랑 놀아본다.
...
## [#파이썬: #활용법: 미니콘다]({{< relref "/notes/20240625T153507.md" >}}) 크로스 플랫폼 공략 {#771b2e7b-74f4-46e5-a436-9a9a4471848a}
...
## `참고` apt-get install {#참고-apt-get-install}

```sh
sudo apt-get install jupyter -y
sudo apt-get install python3-matplotlib python3-plotly -y
sudo apt-get install -y python3-pandas

sudo apt-get install python3-seaborn python3-openpyxl python3-lxml python3-statsmodels python3-patsy python3-scipy
...
- python3-lxml - libxml2 및 libxslt 라이브러리에 대한 pythonic 바인딩
