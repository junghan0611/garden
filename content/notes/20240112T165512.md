...
<style>.csl-entry{text-indent: -1.5em; margin-left: 1.5em;}</style><div class="csl-bib-body">
  ...
  <div class="csl-entry">“Martibosch/Snakemacs: Emacs28 Setup for Python with Conda/Mamba.” n.d. Accessed January 28, 2025. <a href="https://github.com/martibosch/snakemacs">https://github.com/martibosch/snakemacs</a>.</div>
...
(“Martibosch/Snakemacs: Emacs28 Setup for Python with Conda/Mamba” n.d.)
...
-   [@ #리터레이트 #프로그래밍 #이맥스 콰르토 주피터 (2024-06-03)]({{< relref "/notes/20240603T174450.md" >}})
...
-   [Replacing Jupyter Notebook with Org Mode - sqrtminusone.xyz](https://sqrtminusone.xyz/posts/2021-05-01-org-python/)

오래되긴 했다. 이거 리포 가서 확인해봐라. 요즘에 어떻게 쓰는지
