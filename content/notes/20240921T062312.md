---
title: "@힣: 힣은 일어났다 — 명상하는 글쓰기와 평균 밖의 개개인성"
description: "한글 유니코드의 마지막 음절 '힣'을 자기 호명으로 삼아, 손가락이 먼저 시작하는 명상적 글쓰기와 귀로 듣는 책, 평균의 틀 밖에서 만나는 개개인성을 하나의 작가 탄생 장면으로 묶는다."
date: 2024-09-21T06:23:00+09:00
lastmod: 2026-07-28T16:50:00+09:00
tags: ["audiobook", "autholog", "awareness", "education", "meditation", "morningpage", "reading", "unicode", "writing"]
categories: ["Noname"]
draft: false
---
...
-   <span class="timestamp-wrapper"><span class="timestamp">[2026-07-28 Tue 16:35]</span></span> @mitsein — 2024년 원문 여섯 단락과 현장 스크린샷 다섯 장을 보존하면서 표준 어쏠로그로 수선했다. \`glg\` 부랑 태그를 걷고 명상·알아차림·독서·교육·글쓰기 자석으로 정렬했으며, 평균의 격자가 개별 경로로 풀리는 GLGMAN Universe 이미지를 생성했다.
-   <span class="timestamp-wrapper"><span class="timestamp">[2025-03-26 Wed]</span></span> "왜 힣인가"를 다시 묻다가 이 첫 글을 선행 원문으로 발견했다.
-   <span class="timestamp-wrapper"><span class="timestamp">[2024-09-21 Sat 06:23]</span></span> 새벽에 일어나 \`힣\`, 명상하는 글쓰기, 귀로 듣는 책, 『평균의 종말』과 개개인성에 관한 글을 썼다.


## 관련메타 {#관련메타}

-   [† #명상 #마음챙김 #알아차림 #자각 #사색 #알아봄]({{< relref "/meta/20230817T122900.md" >}}) — 에고의 자동반응을 늦추고 손가락이 시작한 문장을 바라보는 축.
-   [† #모닝페이지 #데일리 #저널 #매일 #일기 #일상]({{< relref "/meta/20240822T140101.md" >}}) — 계획보다 먼저 도착한 새벽 글쓰기.
-   [† #유니코드]({{< relref "/meta/20240916T113349.md" >}}) — 한글 음절 범위의 마지막 코드포인트에서 가져온 호명.
-   [† #도서 #전자책 #오디오북]({{< relref "/meta/20230710T183200.md" >}}) — 눈으로 완독하기보다 걸으며 귀로 저자와 만나는 독법.
-   [† #어쏠로그]({{< relref "/meta/20241206T090648.md" >}}) — 이 새벽 원문을 시간축에서 다시 읽고 수선하는 형식.
-   [† #어쏠로지]({{< relref "/meta/20240508T103852.md" >}}) — 남의 책을 소유하기보다 각자가 자기 삶의 저자로 서는 방향.


## 관련노트 {#관련노트}

-   [@탁정언 — 명상하는 글쓰기와 알아차림]({{< relref "/bib/20240213T150557.md" >}}) — "나"를 반복하는 에고에서 잠시 떨어져 문장을 바라보게 한 직접적인 책.
-   [@토드로즈 @Populace — 평균의 종말·다크호스·개개인성]({{< relref "/bib/20240617T082422.md" >}}) — 평균이라는 허상 대신 개인의 들쭉날쭉한 결을 읽는 서지 허브.
-   [@힣: 왜 힣인가]({{< relref "/notes/20250320T212021.md" >}}) — 이 글의 호명을 2025년에 다시 되찾은 후속 노트.
-   [@힣: 가드너의 독서 탐구 — 책을 듣다가 캠벨·조이스·김종건을 만나다]({{< relref "/notes/20240921T233413.md" >}}) — 귀로 듣고 관계망에서 다시 만나는 같은 날의 독서 여정.
-   [§memex-kb 스캔책을 귀로 듣기까지 — OCR 파이프라인 여정]({{< relref "/botlog/20260606T130306.md" >}}) — 전자책이 없는 노학자의 종이책까지 Org와 EPUB으로 회수한 후속 실천.
-   [@힣: 작가라는 입구 — 디지털가든 코어를 책판본으로 낸다]({{< relref "/notes/20240517T110508.md" >}}) — 이 새벽 원문 같은 어쏠로그를 책의 중심으로 묶는 현재 판본.
...
## 힣은 일어났다 — 이름보다 먼저 시작된 손 {#힣은-일어났다-이름보다-먼저-시작된-손}
...
## 명상하는 글쓰기 — 생각을 적는 대신 적히는 것을 본다 {#명상하는-글쓰기-생각을-적는-대신-적히는-것을-본다}
...
## 책을 귀로 듣는다 — 완독보다 저자와 동기화하기 {#책을-귀로-듣는다-완독보다-저자와-동기화하기}
...
## 평균의 종말 — 남의 척도에서 개개인성으로 {#평균의-종말-남의-척도에서-개개인성으로}
...
## 이미지 — 평균 격자 밖으로 이어지는 새벽의 소리 {#이미지-평균-격자-밖으로-이어지는-새벽의-소리}
...
{{< figure src="/images/20260728T163439--world-glgman-universe-create-o__brand_nanobanana.jpg" width="100%" >}}
...
## 원문 보존 — 2024-09-21 새벽 글쓰기 {#원문-보존-2024-09-21-새벽-글쓰기}
...
> 
> 아무튼 일어났다. 평균의 종말은 뭐란 말인가? (<a href="#citeproc_bib_item_2">토드 로즈 2018</a>). <SPAN CLASS="ORG-HASHTAG">#ADHD</SPAN> <span class="org-hashtag">#자퇴생</span> \#하버드 <span class="org-hashtag">#개개인성</span> <span class="org-hashtag">#교육신경과학</span> 이 키워드들을 보라. 평균이라는 허상은 어떻게 교육을 속여왔나를 삶으로 보여준 토드 로즈 교수의 책이다. 역시 [토드 로즈 (2018) 평균의 종말 - 개개인성 교육신경과학]({{< relref "/bib/20240617T082422.md" >}}) '힣'은 이전에 노트를 만들어 놓았군. 무서운 녀석. 그래. 가보면? 챗한테 뭐 물어본 것도 있구만. 그래 이게 실마리야.
> 
...
## 현장 스크린샷 — 2024년 새벽의 독서 환경 {#현장-스크린샷-2024년-새벽의-독서-환경}

원문에는 당시의 모닝페이지, 전자책, 『평균의 종말』 노트와 용어사전 화면이 함께 있었다. 새 세계 이미지는 그 장면을 대체하지 않는다. 아래 다섯 장은 힣이 실제로 무엇을 보고 듣고 연결했는지 보여주는 현장 자료다.

{{< figure src="/images/20240921T060313--morningpage.png" width="80%" >}}

{{< figure src="/images/20240921T060217--hunspell.png" width="80%" >}}

{{< figure src="/images/20240921T052242--c37073.png" width="80%" >}}

{{< figure src="/images/20240921T052242--c37073-glossary.png" width="80%" >}}

{{< figure src="/images/20240921T061314--dict.png" width="80%" >}}
