...
description: "한글 개발자 문서를 DevDocs와 이맥스에서 검색·활용하는 방법을 실험하며 구축한 작업 기록."
date: 2023-10-11T10:26:00+09:00
lastmod: 2024-12-01T06:30:00+09:00
tags: ["emacs", "hangul", "manual"]
categories: ["Noname"]
draft: false
---
...
## <span class="org-todo done DONT">DONT</span> Python -- devdocs (ko) branch {#python-devdocs--ko--branch}
...
### <span class="org-todo done DONT">DONT</span> 빌드 방법 {#빌드-방법}
...
### <span class="org-todo done DONT">DONT</span> Emacs devdocs and devdocs-browser {#emacs-devdocs-and-devdocs-browser}
...
{{< figure src="/images/20231025_063842_screenshot.png" caption="<span class=\"figure-number\">Figure 4: </span>zeal" width="100%" >}}


#### <span class="org-todo done DONT">DONT</span> devdocs 로 변환 할 수 있는가? {#devdocs-로-변환-할-수-있는가}
...
## Python 3.11 한글 문서 지원 {#python-3-dot-11-한글-문서-지원}

<span class="timestamp-wrapper"><span class="timestamp">[2024-01-14 Sun 17:21]</span></span>

{{< figure src="/images/20240114_172137_screenshot.png" caption="<span class=\"figure-number\">Figure 5: </span>python 3.11 hangul" width="100%" >}}
