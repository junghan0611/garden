...
description: "코드 포매터와 린터의 역할을 구분하며 Apheleia를 개발 흐름 속에 어떻게 배치할지 살핀 자료."
...
## <span class="org-todo done DONT">DONT</span> `format-all` {#format-all}
...
## <span class="org-todo done DONT">DONT</span> In Spacemacs {#in-spacemacs}
