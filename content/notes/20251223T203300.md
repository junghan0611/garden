---
title: "#이맥스 #TMUX #Zellij #BEADS #클로드코드 #멀티에이전트 #오케스트레이션"
description: "Emacs를 프론트엔드로, Zellij를 백엔드로 둔 Claude Code 멀티에이전트 오케스트레이션 노트이다."
date: 2025-12-23T20:33:00+09:00
lastmod: 2025-12-23T20:33:00+09:00
tags: ["claudecode", "emacs", "llmlog", "orchestration", "zellij"]
draft: false
---
...
-   <span class="timestamp-wrapper"><span class="timestamp">[2025-12-28 Sun 16:59]</span></span> 여러 옵션을 테스트하며 다시 핵심 질문이 무엇인가 되세겨 본다.
-   <span class="timestamp-wrapper"><span class="timestamp">[2025-12-23 Tue 20:33]</span></span> 요구사항 정리 후 문서 작성 부탁


## 이맥스 멀티 오케스트레이션 {#이맥스-멀티-오케스트레이션}

<span class="timestamp-wrapper"><span class="timestamp">[2025-12-23 Tue 20:33]</span></span>
...
### 왜 Zellij인가? {#왜-zellij인가}


#### tmux vs Zellij 비교 {#tmux-vs-zellij-비교}
...
#### Zellij Plugin API 핵심 기능 {#zellij-plugin-api-핵심-기능}
...
### Claude Code의 중요성 :CLAUDE_CODE: {#claude-code의-중요성-claude-code}


#### v2.0.74 (2025-12-19) 주요 기능 {#v2-dot-0-dot-74--2025-12-19--주요-기능}
...
### AWS CAO 컨셉 채용 {#aws-cao-컨셉-채용}


#### CLI Agent Orchestrator (CAO) 핵심 패턴 {#cli-agent-orchestrator--cao--핵심-패턴}
...
#### claude_code_agent_farm 패턴 {#claude-code-agent-farm-패턴}
...
#### Emacs 최소 구현 (~50줄) {#emacs-최소-구현--50줄}
...
### bd 태스크 관리 통합 :BD_INTEGRATION: {#bd-태스크-관리-통합-bd-integration}


#### 컨셉: bd + Orchestrator {#컨셉-bd-plus-orchestrator}
...
#### Emacs-bd-Orchestrator 워크플로우 {#emacs-bd-orchestrator-워크플로우}
...
#### Phase 1: 기반 구축 (1-2주) {#phase-1-기반-구축--1-2주}
...
#### Phase 2: 통합 (2-3주) {#phase-2-통합--2-3주}
...
#### Phase 3: 고급 기능 (4주+) {#phase-3-고급-기능--4주-plus}
