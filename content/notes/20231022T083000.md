---
title: "@힣: #메타노트 #분류체계 흔적 업데이트 - 동적블록 - 지도 - 디노트 태크 영어 키워드 한글 시맨틱"
description: "디지털가든의 메타노트, 태그, 영어 키워드 전략을 정리하며 분류체계 규칙을 세워 가는 역사 노트."
date: 2023-10-22T08:30:00+09:00
lastmod: 2026-07-09T15:03:00+09:00
tags: ["autholog", "bib", "category", "classification", "denote", "digitalgarden", "folksonomy", "howtouse", "korean", "pkm", "rule", "system", "tag", "taxonomy"]
categories: ["Noname"]
draft: false
---
...
-   <span class="timestamp-wrapper"><span class="timestamp">[2025-11-07 Fri 09:27]</span></span> [#임시]({{< relref "/notes/20251107T082600.md" >}}) 이 문서에 자동화 작업 진행 중 입니다.
...
-   [임시]({{< relref "/notes/20250423T122956.md" >}})
...
단어로 애매한 것들이나 전문용어, 약어 등에 활용 된다. 이에 더해 폭소노미로도 영어는 유용하다.([#LLM: #용어 텍사노미 폭소노미 - 분류 체계 개념 #지식]({{< relref "/notes/20241206T164930.md" >}})). [@힣: #노트테이킹 #유니코드 #기호: 파일명 § ⓕ † ‡ № ¶ ↔ → ∉ ⊢ © ¬ ¢ ¤ µ ¥ £ ¡ ¿]({{< relref "/notes/20241225T052744.md" >}})를 활용한다. 용어 사용의 체계와 통일성 중요하다. [#모음: #애매 #모호 #용어 #사전 #단어 #어휘]({{< relref "/notes/20241215T121847.md" >}}) 단어 사용
