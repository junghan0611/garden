...
description: "국내외 블로그·글쓰기 서비스의 특징과 멤버십 모델을 워크플로우 관점에서 비교하려는 모음 기록."
...
## <span class="org-todo done DONT">DONT</span> <SPAN CLASS="ORG-HASHTAG">#요즘IT</SPAN> {#요즘it}
...
## [#750words: #글쓰기 #서비스]({{< relref "/notes/20230904T144600.md" >}}) {#750words-글쓰기-서비스}
