...
tags: ["bib", "collection", "cheatsheet", "clitools", "manual", "knowing", "tips", "information", "materials", "github", "programmer", "productivity", "daily"]
categories: ["Noname"]
draft: false
---
...
{{< figure src="/images/20250616T145920-secretbook-repo-title.png" >}}
...
#### Build your own DNS Servers {#build-your-own-dns-servers}
...
#### Build your own Certificate Authority {#build-your-own-certificate-authority}
...
#### Build your own System/Virtual Machine {#build-your-own-system-virtual-machine}
...
#### DNS Servers list (privacy) {#dns-servers-list--privacy}

| **IP**                        | **URL**                                                                                 |
|-------------------------------|-----------------------------------------------------------------------------------------|
| **<kbd>84.200.69.80</kbd>**   | [dns.watch](https://dns.watch/)                                                         |
| **<kbd>94.247.43.254</kbd>**  | [opennic.org](https://www.opennic.org/)                                                 |
| **<kbd>64.6.64.6</kbd>**      | [verisign.com](https://www.verisign.com/en_US/security-services/public-dns/index.xhtml) |
| **<kbd>89.233.43.71</kbd>**   | [censurfridns.dk](https://blog.uncensoreddns.org/)                                      |
| **<kbd>1.1.1.1</kbd>**        | [cloudflare.com](https://1.1.1.1/)                                                      |
| **<kbd>94.130.110.185</kbd>** | [dnsprivacy.at](https://dnsprivacy.at/)                                                 |


#### TOP Browser extensions {#top-browser-extensions}

| **Extension name**                | **Description**                                                               |
|-----------------------------------|-------------------------------------------------------------------------------|
| **<kbd>IPvFoo</kbd>**             | Display the server IP address and HTTPS information across all page elements. |
| **<kbd>FoxyProxy</kbd>**          | Simplifies configuring browsers to access proxy-servers.                      |
| **<kbd>HTTPS Everywhere</kbd>**   | Automatically use HTTPS security on many sites.                               |
| **<kbd>uMatrix</kbd>**            | Point &amp; click to forbid/allow any class of requests made by your browser. |
| **<kbd>uBlock Origin</kbd>**      | An efficient blocker: easy on memory and CPU footprint.                       |
| **<kbd>Session Buddy</kbd>**      | Manage browser tabs and bookmarks with ease.                                  |
| **<kbd>SuperSorter</kbd>**        | Sort bookmarks recursively, delete duplicates, merge folders, and more.       |
| **<kbd>Clear Cache</kbd>**        | Clear your cache and browsing data.                                           |
| **<kbd>d3coder</kbd>**            | Encoding/Decoding plugin for various types of encoding.                       |
| **<kbd>Web Developer</kbd>**      | Adds a toolbar button with various web developer tools.                       |
| **<kbd>ThreatPinch Lookup</kbd>** | Add threat intelligence hover tool tips.                                      |


#### TOP Burp extensions {#top-burp-extensions}

| **Extension name**                            | **Description**                                                                 |
|-----------------------------------------------|---------------------------------------------------------------------------------|
| **<kbd>Active Scan++</kbd>**                  | Extends Burp's active and passive scanning capabilities.                        |
| **<kbd>Autorize</kbd>**                       | Automatically detects authorization enforcement.                                |
| **<kbd>AuthMatrix</kbd>**                     | A simple matrix grid to define the desired levels of access privilege.          |
| **<kbd>Logger++</kbd>**                       | Logs requests and responses for all Burp tools in a sortable table.             |
| **<kbd>Bypass WAF</kbd>**                     | Adds headers useful for bypassing some WAF devices.                             |
| **<kbd>JSON Beautifier</kbd>**                | Beautifies JSON content in the HTTP message viewer.                             |
| **<kbd>JSON Web Tokens</kbd>**                | Enables Burp to decode and manipulate JSON web tokens.                          |
| **<kbd>CSP Auditor</kbd>**                    | Displays CSP headers for responses, and passively reports CSP weaknesses.       |
| **<kbd>CSP-Bypass</kbd>**                     | Passively scans for CSP headers that contain known bypasses.                    |
| **<kbd>Hackvertor</kbd>**                     | Converts data using a tag-based configuration to apply various encoding.        |
| **<kbd>HTML5 Auditor</kbd>**                  | Scans for usage of risky HTML5 features.                                        |
| **<kbd>Software Vulnerability Scanner</kbd>** | Vulnerability scanner based on vulners.com audit API.                           |
| **<kbd>Turbo Intruder</kbd>**                 | Is a powerful bruteforcing tool.                                                |
| **<kbd>Upload Scanner</kbd>**                 | Upload a number of different file types, laced with different forms of payload. |


#### Hack Mozilla Firefox address bar {#hack-mozilla-firefox-address-bar}
...
#### Chrome hidden commands {#chrome-hidden-commands}
...
#### Bypass WAFs by Shortening IP Address (by [0xInfection](https://twitter.com/0xInfection)) {#bypass-wafs-by-shortening-ip-address--by-0xinfection}
...
#### Hashing, encryption and encoding (by [Michal Špaček](https://twitter.com/spazef0rze)) {#hashing-encryption-and-encoding--by-michal-špaček}
...
### Tool: [terminal](https://en.wikipedia.org/wiki/Linux_console) {#tool-terminal}
...
#### Sterilize bash history {#sterilize-bash-history}
...
#### Delete all files in a folder that don't match a certain file extension {#delete-all-files-in-a-folder-that-don-t-match-a-certain-file-extension}
...
#### Run command(s) after exit session {#run-command--s--after-exit-session}
...
#### Simple Bash filewatching {#simple-bash-filewatching}
...
### Tool: [busybox](https://www.busybox.net/) {#tool-busybox}


#### Static HTTP web server {#static-http-web-server}
...
### Tool: [mount](https://en.wikipedia.org/wiki/Mount_(Unix)) {#tool-mount}


#### Mount a temporary ram partition {#mount-a-temporary-ram-partition}
...
#### Remount a filesystem as read/write {#remount-a-filesystem-as-read-write}
...
### Tool: [fuser](https://en.wikipedia.org/wiki/Fuser_(Unix)) {#tool-fuser}


#### Show which processes use the files/directories {#show-which-processes-use-the-files-directories}
...
#### Kills a process that is locking a file {#kills-a-process-that-is-locking-a-file}
...
#### Kills a process that is locking a file with specific signal {#kills-a-process-that-is-locking-a-file-with-specific-signal}
...
#### Show what PID is listening on specific port {#show-what-pid-is-listening-on-specific-port}
...
#### Show all processes using the named filesystems or block device {#show-all-processes-using-the-named-filesystems-or-block-device}
...
### Tool: [lsof](https://en.wikipedia.org/wiki/Lsof) {#tool-lsof}


#### Show process that use internet connection at the moment {#show-process-that-use-internet-connection-at-the-moment}
...
#### Show process that use specific port number {#show-process-that-use-specific-port-number}
...
#### Lists all listening ports together with the PID of the associated process {#lists-all-listening-ports-together-with-the-pid-of-the-associated-process}
...
#### List all open ports and their owning executables {#list-all-open-ports-and-their-owning-executables}
...
#### Show all open ports {#show-all-open-ports}
...
#### Show open ports (LISTEN) {#show-open-ports--listen}
...
#### List all files opened by a particular command {#list-all-files-opened-by-a-particular-command}
...
#### View user activity per directory {#view-user-activity-per-directory}
...
#### Show current working directory of a process {#show-current-working-directory-of-a-process}
...
### Tool: [ps](https://en.wikipedia.org/wiki/Ps_(Unix)) {#tool-ps}


#### Show a 4-way scrollable process tree with full details {#show-a-4-way-scrollable-process-tree-with-full-details}
...
#### Processes per user counter {#processes-per-user-counter}
...
#### Show all processes by name with main header {#show-all-processes-by-name-with-main-header}
...
### Tool: [find](https://en.wikipedia.org/wiki/Find_(Unix)) {#tool-find}


#### Find files that have been modified on your system in the past 60 minutes {#find-files-that-have-been-modified-on-your-system-in-the-past-60-minutes}
...
#### Find all files larger than 20M {#find-all-files-larger-than-20m}
...
#### Find duplicate files (based on MD5 hash) {#find-duplicate-files--based-on-md5-hash}
...
#### Change permission only for files {#change-permission-only-for-files}
...
#### Change permission only for directories {#change-permission-only-for-directories}
...
#### Find files and directories for specific user/group {#find-files-and-directories-for-specific-user-group}
...
#### Find files and directories for all without specific user/group {#find-files-and-directories-for-all-without-specific-user-group}
...
#### Looking for files/directories that only have certain permission {#looking-for-files-directories-that-only-have-certain-permission}
...
#### Delete older files than 60 days {#delete-older-files-than-60-days}
...
#### Recursively remove all empty sub-directories from a directory {#recursively-remove-all-empty-sub-directories-from-a-directory}
...
#### How to find all hard links to a file {#how-to-find-all-hard-links-to-a-file}
...
#### Recursively find the latest modified files {#recursively-find-the-latest-modified-files}
...
#### Recursively find/replace of a string with sed {#recursively-find-replace-of-a-string-with-sed}
...
#### Recursively find/replace of a string in directories and file names {#recursively-find-replace-of-a-string-in-directories-and-file-names}
...
#### Recursively find suid executables {#recursively-find-suid-executables}
...
### Tool: [top](https://en.wikipedia.org/wiki/Top_(software)) {#tool-top}


#### Use top to monitor only all processes with the specific string {#use-top-to-monitor-only-all-processes-with-the-specific-string}
...
### Tool: [vmstat](https://en.wikipedia.org/wiki/Vmstat) {#tool-vmstat}


#### Show current system utilization (fields in kilobytes) {#show-current-system-utilization--fields-in-kilobytes}
...
#### Show current system utilization will get refreshed every 5 seconds {#show-current-system-utilization-will-get-refreshed-every-5-seconds}
...
#### Display report a summary of disk operations {#display-report-a-summary-of-disk-operations}
...
#### Display report of event counters and memory stats {#display-report-of-event-counters-and-memory-stats}
...
#### Display report about kernel objects stored in slab layer cache {#display-report-about-kernel-objects-stored-in-slab-layer-cache}
...
### Tool: [iostat](https://en.wikipedia.org/wiki/Iostat) {#tool-iostat}


#### Show information about the CPU usage, and I/O statistics about all the partitions {#show-information-about-the-cpu-usage-and-i-o-statistics-about-all-the-partitions}
...
#### Show information only about the CPU utilization {#show-information-only-about-the-cpu-utilization}
...
#### Show information only about the disk utilization {#show-information-only-about-the-disk-utilization}
...
#### Show information only about the LVM utilization {#show-information-only-about-the-lvm-utilization}
...
### Tool: [strace](https://en.wikipedia.org/wiki/Strace) {#tool-strace}


#### Track with child processes {#track-with-child-processes}
...
#### Track process with 30 seconds limit {#track-process-with-30-seconds-limit}
...
#### Track processes and redirect output to a file {#track-processes-and-redirect-output-to-a-file}
...
#### Track the open request of a network port (show TCP/UDP) {#track-the-open-request-of-a-network-port--show-tcp-udp}
...
### Tool: [kill](https://en.wikipedia.org/wiki/Kill_(command)) {#tool-kill}


#### Kill a process running on port {#kill-a-process-running-on-port}
...
### Tool: [diff](https://en.wikipedia.org/wiki/Diff) {#tool-diff}


#### Compare two directory trees {#compare-two-directory-trees}
...
### Tool: [vimdiff](http://vimdoc.sourceforge.net/htmldoc/diff.html) {#tool-vimdiff}


#### Highlight the exact differences, based on characters and words {#highlight-the-exact-differences-based-on-characters-and-words}
...
#### Compare two JSON files {#compare-two-json-files}
...
#### Compare Hex dump {#compare-hex-dump}
...
### Tool: [tail](https://en.wikipedia.org/wiki/Tail_(Unix)) {#tool-tail}


#### Annotate tail -f with timestamps {#annotate-tail-f-with-timestamps}
...
#### Analyse an Apache access log for the most common IP addresses {#analyse-an-apache-access-log-for-the-most-common-ip-addresses}
...
### Tool: [tar](https://en.wikipedia.org/wiki/Tar_(computing)) {#tool-tar}
...
#### System backup with exclude specific directories (pigz) {#system-backup-with-exclude-specific-directories--pigz}
...
### Tool: [dump](https://en.wikipedia.org/wiki/Dump_(program)) {#tool-dump}


#### System backup to file {#system-backup-to-file}
...
#### Restore system from lzo file {#restore-system-from-lzo-file}
...
### Tool: [cpulimit](http://cpulimit.sourceforge.net/) {#tool-cpulimit}


#### Limit the cpu usage of a process {#limit-the-cpu-usage-of-a-process}
...
### Tool: [pwdx](https://www.cyberciti.biz/faq/unix-linux-pwdx-command-examples-usage-syntax/) {#tool-pwdx}
...
### Tool: [taskset](https://www.cyberciti.biz/faq/taskset-cpu-affinity-command/) {#tool-taskset}


#### Start a command on only one CPU core {#start-a-command-on-only-one-cpu-core}
...
### Tool: [tr](https://en.wikipedia.org/wiki/Tr_(Unix)) {#tool-tr}


#### Show directories in the PATH, one per line {#show-directories-in-the-path-one-per-line}
...
### Tool: [chmod](https://en.wikipedia.org/wiki/Chmod) {#tool-chmod}


#### Remove executable bit from all files in the current directory {#remove-executable-bit-from-all-files-in-the-current-directory}
...
#### Restore permission for /bin/chmod {#restore-permission-for-bin-chmod}
...
### Tool: [who](https://en.wikipedia.org/wiki/Who_(Unix)) {#tool-who}


#### Find last reboot time {#find-last-reboot-time}
...
### Tool: [last](https://www.howtoforge.com/linux-last-command/) {#tool-last}


#### Was the last reboot a panic? {#was-the-last-reboot-a-panic}
...
### Tool: [screen](https://en.wikipedia.org/wiki/GNU_Screen) {#tool-screen}
...
#### Attach to an existing screen session {#attach-to-an-existing-screen-session}
...
### Tool: [script](https://en.wikipedia.org/wiki/Script_(Unix)) {#tool-script}


#### Record and replay terminal session {#record-and-replay-terminal-session}
...
### Tool: [du](https://en.wikipedia.org/wiki/GNU_Screen) {#tool-du}


#### Show 20 biggest directories with 'K M G' {#show-20-biggest-directories-with-k-m-g}
...
### Tool: [inotifywait](https://en.wikipedia.org/wiki/GNU_Screen) {#tool-inotifywait}


#### Init tool everytime a file in a directory is modified {#init-tool-everytime-a-file-in-a-directory-is-modified}
...
### Tool: [openssl](https://www.openssl.org/) {#tool-openssl}


#### Testing connection to the remote host {#testing-connection-to-the-remote-host}
...
#### Testing connection to the remote host (debug mode) {#testing-connection-to-the-remote-host--debug-mode}
...
#### Testing connection to the remote host (with SNI support) {#testing-connection-to-the-remote-host--with-sni-support}
...
#### Testing connection to the remote host with specific ssl version {#testing-connection-to-the-remote-host-with-specific-ssl-version}
...
#### Testing connection to the remote host with specific ssl cipher {#testing-connection-to-the-remote-host-with-specific-ssl-cipher}
...
#### Generate private key and CSR (ECC) {#generate-private-key-and-csr--ecc}
...
### Tool: [secure-delete](https://wiki.archlinux.org/index.php/Securely_wipe_disk) {#tool-secure-delete}


#### Secure delete with shred {#secure-delete-with-shred}
...
#### Secure delete with scrub {#secure-delete-with-scrub}
...
#### Secure delete with badblocks {#secure-delete-with-badblocks}
...
#### Secure delete with secure-delete {#secure-delete-with-secure-delete}
...
### Tool: [dd](https://en.wikipedia.org/wiki/Dd_(Unix)) {#tool-dd}


#### Show dd status every so often {#show-dd-status-every-so-often}
...
#### Redirect output to a file with dd {#redirect-output-to-a-file-with-dd}
...
### Tool: [gpg](https://www.gnupg.org/) {#tool-gpg}
...
#### List all of the packets in an encrypted file {#list-all-of-the-packets-in-an-encrypted-file}
...
### Tool: [system-other](https://github.com/trimstray/the-book-of-secret-knowledge#tool-system-other) {#tool-system-other}


#### Reboot system from init {#reboot-system-from-init}
...
#### Init system from single user mode {#init-system-from-single-user-mode}
...
#### Show actual pathname of the executed command {#show-actual-pathname-of-the-executed-command}
...
### Tool: [curl](https://curl.haxx.se) {#tool-curl}
...
#### Find your external IP address (external services) {#find-your-external-ip-address--external-services}
...
#### Repeat URL request {#repeat-url-request}
...
#### Check DNS and HTTP trace with headers for specific domains {#check-dns-and-http-trace-with-headers-for-specific-domains}
...
### Tool: [httpie](https://httpie.org/) {#tool-httpie}
...
### Tool: [ssh](https://www.openssh.com/) {#tool-ssh}
...
#### SSH connection through host in the middle {#ssh-connection-through-host-in-the-middle}
...
#### Run command over SSH on remote host {#run-command-over-ssh-on-remote-host}
...
#### Get all fingerprints {#get-all-fingerprints}
...
#### SSH authentication with user password {#ssh-authentication-with-user-password}
...
#### SSH authentication with publickey {#ssh-authentication-with-publickey}
...
#### Simple recording SSH session {#simple-recording-ssh-session}
...
#### Using Keychain for SSH logins {#using-keychain-for-ssh-logins}
...
#### SSH login without processing any login scripts {#ssh-login-without-processing-any-login-scripts}
...
### Tool: [linux-dev](https://www.tldp.org/LDP/abs/html/devref1.html) {#tool-linux-dev}


#### Testing remote connection to port {#testing-remote-connection-to-port}
...
#### Read and write to TCP or UDP sockets with common bash tools {#read-and-write-to-tcp-or-udp-sockets-with-common-bash-tools}
...
### Tool: [tcpdump](http://www.tcpdump.org/) {#tool-tcpdump}


#### Filter incoming (on interface) traffic (specific ip:port) {#filter-incoming--on-interface--traffic--specific-ip-port}
...
#### Filter incoming (on interface) traffic (specific ip:port) and write to a file {#filter-incoming--on-interface--traffic--specific-ip-port--and-write-to-a-file}
...
#### Capture all ICMP packets {#capture-all-icmp-packets}
...
#### Check protocol used (TCP or UDP) for service {#check-protocol-used--tcp-or-udp--for-service}
...
#### Display ASCII text (to parse the output using grep or other) {#display-ascii-text--to-parse-the-output-using-grep-or-other}
...
#### Grab everything between two keywords {#grab-everything-between-two-keywords}
...
#### Grab user and pass ever plain http {#grab-user-and-pass-ever-plain-http}
...
#### Rotate capture files {#rotate-capture-files}
...
#### Top hosts by packets {#top-hosts-by-packets}
...
#### Excludes any RFC 1918 private address {#excludes-any-rfc-1918-private-address}
...
### Tool: [tcpick](http://tcpick.sourceforge.net/) {#tool-tcpick}


#### Analyse packets in real-time {#analyse-packets-in-real-time}
...
### Tool: [ngrep](http://ngrep.sourceforge.net/usage.html) {#tool-ngrep}
...
### Tool: [hping3](http://www.hping.org/) {#tool-hping3}
...
### Tool: [nmap](https://nmap.org/) {#tool-nmap}


#### Ping scans the network {#ping-scans-the-network}
...
#### Show only open ports {#show-only-open-ports}
...
#### Full TCP port scan using with service version detection {#full-tcp-port-scan-using-with-service-version-detection}
...
#### Nmap scan and pass output to Nikto {#nmap-scan-and-pass-output-to-nikto}
...
#### Recon specific ip:service with Nmap NSE scripts stack {#recon-specific-ip-service-with-nmap-nse-scripts-stack}
...
### Tool: [netcat](http://netcat.sourceforge.net/) {#tool-netcat}
...
#### Transfer data file (archive) {#transfer-data-file--archive}
...
#### Launch remote shell {#launch-remote-shell}
...
#### Simple minimal HTTP Server {#simple-minimal-http-server}
...
#### Simple HTTP Proxy (single connection) {#simple-http-proxy--single-connection}
...
#### Create a single-use TCP or UDP proxy {#create-a-single-use-tcp-or-udp-proxy}
...
### Tool: [gnutls-cli](https://gnutls.org/manual/html_node/gnutls_002dcli-Invocation.html) {#tool-gnutls-cli}


#### Testing connection to remote host (with SNI support) {#testing-connection-to-remote-host--with-sni-support}
...
#### Testing connection to remote host (without SNI support) {#testing-connection-to-remote-host--without-sni-support}
...
### Tool: [socat](http://www.dest-unreach.org/socat/doc/socat.html) {#tool-socat}
...
#### Redirecting TCP-traffic to a UNIX domain socket under Linux {#redirecting-tcp-traffic-to-a-unix-domain-socket-under-linux}
...
### Tool: [p0f](http://lcamtuf.coredump.cx/p0f3/) {#tool-p0f}


#### Set iface in promiscuous mode and dump traffic to the log file {#set-iface-in-promiscuous-mode-and-dump-traffic-to-the-log-file}
...
### Tool: [netstat](https://en.wikipedia.org/wiki/Netstat) {#tool-netstat}


#### Graph # of connections for each hosts {#graph-of-connections-for-each-hosts}
...
#### Monitor open connections for specific port including listen, count and sort it per IP {#monitor-open-connections-for-specific-port-including-listen-count-and-sort-it-per-ip}
...
#### Grab banners from local IPv4 listening ports {#grab-banners-from-local-ipv4-listening-ports}
...
### Tool: [rsync](https://en.wikipedia.org/wiki/Rsync) {#tool-rsync}


#### Rsync remote data as root using sudo {#rsync-remote-data-as-root-using-sudo}
...
### Tool: [host](https://en.wikipedia.org/wiki/Host_(Unix)) {#tool-host}


#### Resolves the domain name (using external dns server) {#resolves-the-domain-name--using-external-dns-server}
...
#### Checks the domain administrator (SOA record) {#checks-the-domain-administrator--soa-record}
...
### Tool: [dig](https://en.wikipedia.org/wiki/Dig_(command)) {#tool-dig}


#### Resolves the domain name (short output) {#resolves-the-domain-name--short-output}
...
#### Lookup NS record for specific domain {#lookup-ns-record-for-specific-domain}
...
#### Query only answer section {#query-only-answer-section}
...
#### Query ALL DNS Records {#query-all-dns-records}
...
### Tool: [certbot](https://certbot.eff.org/) {#tool-certbot}
...
### Tool: [network-other](https://github.com/trimstray/the-book-of-secret-knowledge#tool-network-other) {#tool-network-other}


#### Get all subnets for specific AS (Autonomous system) {#get-all-subnets-for-specific-as--autonomous-system}
...
#### Resolves domain name from dns.google.com with curl and jq {#resolves-domain-name-from-dns-dot-google-dot-com-with-curl-and-jq}
...
### Tool: [git](https://git-scm.com/) {#tool-git}


#### Log alias for a decent view of your repo {#log-alias-for-a-decent-view-of-your-repo}
...
### Tool: [python](https://www.python.org/) {#tool-python}
...
### Tool: [awk](http://www.grymoire.com/Unix/Awk.html) {#tool-awk}


#### Search for matching lines {#search-for-matching-lines}
...
#### Search non matching lines {#search-non-matching-lines}
...
#### Print matching lines with numbers {#print-matching-lines-with-numbers}
...
#### Print the last column {#print-the-last-column}
...
#### Find all the lines longer than 80 characters {#find-all-the-lines-longer-than-80-characters}
...
#### Print line numbers for only non-blank lines {#print-line-numbers-for-only-non-blank-lines}
...
#### Print the line and the next two (i=5) lines after the line matching regexp {#print-the-line-and-the-next-two--i-5--lines-after-the-line-matching-regexp}
...
#### Print the lines starting at the line matching 'server {' until the line matching '}' {#print-the-lines-starting-at-the-line-matching-server-until-the-line-matching}
...
#### Print multiple columns with separators {#print-multiple-columns-with-separators}
...
#### Delete trailing white space (spaces, tabs) {#delete-trailing-white-space--spaces-tabs}
...
#### Delete leading white space {#delete-leading-white-space}
...
#### Remove duplicate consecutive lines {#remove-duplicate-consecutive-lines}
...
#### Remove duplicate entries in a file without sorting {#remove-duplicate-entries-in-a-file-without-sorting}
...
#### Exclude multiple columns {#exclude-multiple-columns}
...
#### Substitute foo for bar on lines matching regexp {#substitute-foo-for-bar-on-lines-matching-regexp}
...
#### Add some characters at the beginning of matching lines {#add-some-characters-at-the-beginning-of-matching-lines}
...
#### Get the last hour of Apache logs {#get-the-last-hour-of-apache-logs}
...
### Tool: [sed](http://www.grymoire.com/Unix/Sed.html) {#tool-sed}


#### Print a specific line from a file {#print-a-specific-line-from-a-file}
...
#### Remove a specific line from a file {#remove-a-specific-line-from-a-file}
...
#### Remove a range of lines from a file {#remove-a-range-of-lines-from-a-file}
...
#### Replace newline(s) with a space {#replace-newline--s--with-a-space}
...
#### Delete string +N next lines {#delete-string-plus-n-next-lines}
...
### Tool: [grep](http://www.grymoire.com/Unix/Grep.html) {#tool-grep}


#### Search for a "pattern" inside all files in the current directory {#search-for-a-pattern-inside-all-files-in-the-current-directory}
...
#### Show only for multiple patterns {#show-only-for-multiple-patterns}
...
#### Except multiple patterns {#except-multiple-patterns}
...
#### Show data from file without comments {#show-data-from-file-without-comments}
...
#### Show data from file without comments and new lines {#show-data-from-file-without-comments-and-new-lines}
...
#### Show strings with a dash/hyphen {#show-strings-with-a-dash-hyphen}
...
#### Remove blank lines from a file and save output to new file {#remove-blank-lines-from-a-file-and-save-output-to-new-file}
...
### Tool: [perl](https://www.perl.org/) {#tool-perl}


#### Search and replace (in place) {#search-and-replace--in-place}
...
#### Edit of `*.conf`  files changing all foo to bar (and backup original) {#edit-of-dot-conf-files-changing-all-foo-to-bar--and-backup-original}
...
#### Prints the first 20 lines from `*.conf`  files {#prints-the-first-20-lines-from-dot-conf-files}
...
#### Search lines 10 to 20 {#search-lines-10-to-20}
...
#### Delete first 10 lines (and backup original) {#delete-first-10-lines--and-backup-original}
...
#### Delete all but lines between foo and bar (and backup original) {#delete-all-but-lines-between-foo-and-bar--and-backup-original}
...
#### Reduce multiple blank lines to a single line {#reduce-multiple-blank-lines-to-a-single-line}
...
#### Convert tabs to spaces (1t = 2sp) {#convert-tabs-to-spaces--1t-2sp}
...
#### Read input from a file and report number of lines and characters {#read-input-from-a-file-and-report-number-of-lines-and-characters}
...
6.  <kbd>export TERM=xterm; export SHELL=bash</kbd>
