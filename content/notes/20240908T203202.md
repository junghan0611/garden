...
description: "스크린샷 파일 이름을 Denote 형식으로 일괄변경하는 스크립트 아이디어를 남긴 기록. 실제 활용 흐름을 담았다."
...
### <span class="timestamp-wrapper"><span class="timestamp">[2024-09-08 Sun 20:32]</span></span> 아직 완성 못함 {#아직-완성-못함}


### <span class="timestamp-wrapper"><span class="timestamp">[2024-09-15 Sun 23:40]</span></span> 리스프로 완성 {#리스프로-완성}
...
## <span class="org-hashtag">#코드</span> {#코드}
