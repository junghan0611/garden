---
title: "#콕 #이맥스 #에디터 연동"
description: "강의 예제를 따라가며 Coq를 이맥스 에디터와 연동하고 자동완성까지 확인한 학습 기록. 실제 활용 흐름을 담았다."
...
## <span class="org-hashtag">#chatgpt</span> 스니펫 좀 보자. 자연수를 어떻게 입력하는가? 위와 관계 없이 바로 물어보자. {#chatgpt-스니펫-좀-보자-dot-자연수를-어떻게-입력하는가-위와-관계-없이-바로-물어보자-dot}
