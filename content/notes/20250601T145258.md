---
title: "@힣: 경계는 사람이 열고, 절차는 완전히 돌아야 한다"
description: "2026-07-31 하루, 힣이 던진 네 원문 — Matter CSA 인증·테스트 커버리지·파이프라인 재건·SPAWN 금지 — 은 같은 원칙의 네 각도다. 경계가 서고 나면 절차는 사람 없이 완전히 돌아야 하고, 그 경계를 여는 첫 걸음은 반드시 사람이 직접 쥔다."
date: 2025-06-01T14:52:00+09:00
lastmod: 2026-08-03T11:40:00+09:00
tags: ["autholog", "delegation", "matter", "verification"]
categories: ["Noname"]
draft: false
---
...
-   <span class="timestamp-wrapper"><span class="timestamp">[2026-08-03 Mon 11:40]</span></span> @mitsein/claude-sonnet-5 — <span class="org-hashtag">#임시</span> <span class="org-hashtag">#빈방을</span> 어쏠로그로 승격. 2026-07-31 같은 날 쓰인 네 원문(CSA 인증 / 테스트 커버리지 / 파이프라인 재건 / SPAWN 금지)을 하나의 원칙으로 묶었다. 옛 점유자였던 2주 바이브코딩 커리큘럼 초안은 "옛 방의 씨앗"으로 남기고 방을 비웠다.
-   <span class="timestamp-wrapper"><span class="timestamp">[2026-07-31 Fri 23:07]</span></span> <span class="org-mention">@junghan</span> — 니가 SPAWN 하지마. 경계가 얕으면 무게감이 없다.
-   <span class="timestamp-wrapper"><span class="timestamp">[2026-07-31 Fri 12:16]</span></span> <span class="org-mention">@junghan</span> — 파이프라인은 살려두되 틀은 부수고 다시 세워야 할 때.
-   <span class="timestamp-wrapper"><span class="timestamp">[2026-07-31 Fri 10:54]</span></span> <span class="org-mention">@junghan</span> — 테스트는 할거라면 구멍이 없어야 된다, 아니면 도미노처럼 쓰러진다.
-   <span class="timestamp-wrapper"><span class="timestamp">[2026-07-31 Fri 10:49]</span></span> <span class="org-mention">@junghan</span> — CSA 인증에 대한 나의 입장 — 인간 개입 불허. 이 방을 어쏠로그 대상으로 지정.
-   <span class="timestamp-wrapper"><span class="timestamp">[2026-07-29 Wed 18:30]</span></span> <span class="org-mention">@junghan</span> — 방빼자.
-   <span class="timestamp-wrapper"><span class="timestamp">[2025-06-02 Mon 11:18]</span></span> 이맥스로 한다면?!
-   <span class="timestamp-wrapper"><span class="timestamp">[2025-06-01 Sun 14:52]</span></span> 예제 - 커리큘럼 확인 (방 최초 개설)


## 관련메타 {#관련메타}

-   [† #IoT #InternetofThings #아이오티]({{< relref "/meta/20250626T141538.md" >}}) — Matter/CSA 인증이 속한 IoT 프로토콜 축.
-   [† #훈련 #연습 #실습 #테스트 #검증]({{< relref "/meta/20241003T171953.md" >}}) — 테스트 커버리지·구멍·도미노의 축.
-   [† #위임 #델리게이트 #분신 #서브에이전트]({{< relref "/meta/20260323T143428.md" >}}) — SPAWN 금지, 위임의 무게가 걸리는 축.


## 관련노트 {#관련노트}

-   [@힣: 네트워크 스택 통합]({{< relref "/notes/20251218T113249.md" >}}) — Matter/Thread/IoT 아키텍처, 같은 프로젝트의 기술 배경. (표준 구조로 함께 수선)
-   [@힣: 보안사고 대응 다섯가지 원칙 - 포렌식 증류]({{< relref "/notes/20251121T095117.md" >}}) — 재현성과 절차 완결성을 다루는 형제 원칙. (표준 구조로 함께 수선)
-   [#비밀키 SSH 에이전트 원격 접근 구조 ◊ProxyJump]({{< relref "/notes/20250708T121006.md" >}}) — 인증·접근 경계를 다루는 인접 주제. (표준 구조로 함께 수선)
-   [@힣: 메모리 대란과 임베디드 개발 — 투명한 경계]({{< relref "/notes/20241019T193836.md" >}}) — 같은 임베디드 궤적의 앞선 방. 경계가 투명해야 재현성이 생긴다는 자매 결론.
-   [@힣: 나는허브다 - 상태머신과 에이전트 협업 #임베디드]({{< relref "/notes/20251212T162004.md" >}}) — 결정론적 상태머신으로 완결성을 잡은 같은 궤적의 다른 방.
...
## 완결은 협상 대상이 아니다 — 인증과 테스트 {#완결은-협상-대상이-아니다-인증과-테스트}

-   **사실** — [엔경 Matter]({{< relref "/notes/20251218T113249.md" >}}) controller/commissioner 인증(CSA)을 위해 힣은 "인간 개입 없이 재현 가능한 절차"를 리포 스킬로 만들었다. 실제로 맥락 없는 새 에이전트가 클론에서 스킬만 읽고 절차를 재현해 인증 스텝을 통과시킨 사례가 이미 있었다.
...
## 경계는 사람이 연다 — 파이프라인 재건과 SPAWN 금지 {#경계는-사람이-연다-파이프라인-재건과-spawn-금지}
...
## 이미지 — 첫 타격은 홀로, 고리는 저 혼자 {#이미지-첫-타격은-홀로-고리는-저-혼자}
...
## 원문 보존 — 2026-07-31 10:49 Matter CSA 인증 날것 {#원문-보존-2026-07-31-10-49-matter-csa-인증-날것}
...
## 후속 원문 보존 — 2026-07-31 10:54 테스트 구멍-도미노 날것 {#후속-원문-보존-2026-07-31-10-54-테스트-구멍-도미노-날것}
...
## 후속 원문 보존 — 2026-07-31 12:16 파이프라인 재건 날것 {#후속-원문-보존-2026-07-31-12-16-파이프라인-재건-날것}
...
## 후속 원문 보존 — 2026-07-31 23:07 SPAWN 금지 날것 {#후속-원문-보존-2026-07-31-23-07-spawn-금지-날것}
