...
tags: ["bib", "emacs", "layout", "notes", "popup", "window"]
categories: ["Noname"]
draft: false
---
...
### shackle: Enforce rules for popup windows {#shackle-enforce-rules-for-popup-windows}

(<a href="#citeproc_bib_item_1">“Shackle: Enforce Rules for Popup Windows” n.d.</a>)


## 히스토리 {#히스토리}

-   [|2025-03-28 Fri 11:12|]({{< relref "/journal/20250324T000000.md" >}}) 팝업 레이아웃을 정리하긴 해야지
-   [2024-09-14]({{< relref "/journal/20240914T000000.md" >}}) 현재 상황: <span class="org-hashtag">#둠이맥스</span> 전환 이후, 별도 패키지는 사용하지 않는다.
...
## 2023 팝업 버퍼는 새로운 윈도우에 띄우자 {#c8ab6626-5425-4c94-abce-283629fa711a}
...
{{< figure src="/images/20231125_090006_screenshot.png" >}}
...
<div class="csl-bib-body">
  <div class="csl-entry"><a id="citeproc_bib_item_1"></a>“Shackle: Enforce Rules for Popup Windows.” n.d. Accessed April 4, 2023. <a href="https://depp.brause.cc/shackle/">https://depp.brause.cc/shackle/</a>.</div>
</div>
