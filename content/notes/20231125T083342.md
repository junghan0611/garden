...
(<a href="#citeproc_bib_item_1"><i>Shackle: Enforce Rules for Popup Windows</i>, n.d.</a>)


## 히스토리 {#히스토리}

-   [|2025-03-28 Fri 11:12|]({{< relref "/journal/20250324T000000.md" >}}) 팝업 레이아웃을 정리하긴 해야지
-   [2024-09-14]({{< relref "/journal/20240914T000000.md" >}}) 현재 상황: #둠이맥스 전환 이후, 별도 패키지는 사용하지 않는다.
...
<style>.csl-entry{text-indent: -1.5em; margin-left: 1.5em;}</style><div class="csl-bib-body">
  <div class="csl-entry"><a id="citeproc_bib_item_1"></a><i>Shackle: Enforce rules for popup windows</i>. (n.d.). Retrieved April 4, 2023, from <a href="https://depp.brause.cc/shackle/">https://depp.brause.cc/shackle/</a></div>
</div>
