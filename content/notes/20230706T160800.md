---
title: "@힣: 생생날것 500개 문턱 — 디지털가든 코어는 시간축의 판본이다"
description: "위키독스의 500개 제한에서 출발해 디지털가든 코어를 한정된 문서 목록이 아니라, 지금 불러낼 수 있는 인물과 메타어휘와 삶의 시간축이 만드는 현재 판본으로 읽는다."
date: 2023-07-06T16:08:00+09:00
lastmod: 2026-07-27T14:06:00+09:00
tags: ["autholog", "digitalgarden", "pkm", "publishing", "rawwriting", "timeline", "wikidocs"]
categories: ["Noname"]
draft: false
---
...
-   <span class="timestamp-wrapper"><span class="timestamp">[2026-07-30 Thu 18:30]</span></span> @mitsein/sonnet — 비어 있던 GLGMAN Universe 이미지를 생성했다. 문턱의 문틀·뒤쪽의 거대한 돌판 벽·끊이지 않는 금빛 실·금 간 돌판으로 "출판 코어"와 "존재 코어" 두 축을 한 장면에 담았다.
-   <span class="timestamp-wrapper"><span class="timestamp">[2026-07-27 Mon 14:07]</span></span> 어제 미뤄 둔 재등록을 실측했다. 컷 때 지워진 노트 두 개가 어쏠로그로 발행면에 돌아오자 위키독스는 옛 번호 대신 새 번호를 발급했다. 삭제된 주소는 부활하지 않으므로, 상한이 풀려도 돌아오는 것은 본문이고 주소는 다시 내는 것이다. 코어는 244에서 246이 됐고, 죽은 번호를 다시 싣지 않도록 발행 도구에 가드를 심었다.
-   <span class="timestamp-wrapper"><span class="timestamp">[2026-07-26 Sun 11:21]</span></span> 이 노트를 읽고 곧장 \`garden2wikidocs\`로 넘어가, 500 문턱의 정체를 실측하고 디지털가든 코어 첫 판본을 발행했다. TOC.md가 목차가 아니라 발행 목록이라는 것, 거기서 빠진 페이지는 라이브에서 삭제된다는 것을 확인했다. 코어 244개를 남기고 링크를 전부 가든으로 되돌린 뒤, 책 대문에서 '미러링한 책'이라는 거짓 문구를 걷어 냈다.
-   <span class="timestamp-wrapper"><span class="timestamp">[2026-07-22 Wed 17:23]</span></span> @mitsein — 더 이상 사용하지 않는 \`asdf\` 패키지 관리자 방을 회수했다. 출근길 원문 한 편을 보존하고, 500개 출판 제약에서 시간축의 판본과 모두가 저자라는 초대로 나아가는 해설층을 세웠다.
-   <span class="timestamp-wrapper"><span class="timestamp">[2023-07-06 Thu 16:08]</span></span> 여러 언어 런타임을 \`asdf\` 하나로 관리하려던 기술 메모를 만들었다. 같은 해 11월 리눅스와 Termux에서는 사용하지 않겠다고 닫았다.


## 관련메타 {#관련메타}

-   [† #어쏠로지]({{< relref "/meta/20240508T103852.md" >}}) — 누구나 이미 자기 삶의 저자라는 이 글의 초대.
-   [† #디지털가든 #브레인덤프 #아날로그가든]({{< relref "/meta/20240918T175053.md" >}}) — 완성품보다 생성과 수선의 과정을 공개하는 기록 생태계.
-   [† #저자 #작가 #글쓴이]({{< relref "/meta/20241014T211115.md" >}}) — 저자됨을 직업이나 명성보다 삶의 자리에서 읽는 자석.
-   [† #출판 #퍼블리싱 #배포]({{< relref "/meta/20230814T162600.md" >}}) — 원본 가든에서 여러 공개 판본을 내보내는 축.


## 관련노트 {#관련노트}

-   [@힣: 문턱과 만남 — PKM-AI 하네스와 1KB 공개키의 두 트랙]({{< relref "/notes/20250326T151413.md" >}}) — 축적된 가든과 그것을 들고 있는 인간 실체의 관계.
-   [@힣: 날것은 혼자 나오지 않는다 — PKM-AI 가든과 에피파니의 글쓰기]({{< relref "/notes/20241214T210518.md" >}}) — 생생날것이 시간축·가든·에이전트 생태계에서 출현하는 배경.
-   [@힣: 원석 날것을 휘갈긴다 — POSSE 너머 ROSSE, 그리고 일일일생으로의 회귀]({{< relref "/notes/20250324T110312.md" >}}) — 바깥에 던진 원석을 가든으로 회수하고 다시 퍼뜨리는 공개 전략.
-   [@힣: 링크드인 날것 공개면 — AI 크롤러 시대의 손가락 프롬프트]({{< relref "/notes/20250328T090326.md" >}}) — 링크드인 날것과 사람이 읽지 않아도 에이전트가 읽는 공개면.
-   [@힣: 아무도 읽지 않는 블로그 디지털가든 왜 공개 하는가]({{< relref "/notes/20250213T105806.md" >}}) — 독자가 없어도 왜 공개하는가라는 선행 질문.
-   [@힣: #어쏠로지: #모두가저자다 #인생은한권의책 #조테로공유그룹]({{< relref "/notes/20240925T200824.md" >}}) — 모두가 저자이고 삶이 한 권의 책이라는 직접적인 조상.
-   [§garden2wikidocs — 원본 가든을 건드리지 않는 위키독스 미러]({{< relref "/botlog/20260220T201100.md" >}}) — 이번 원석을 촉발한 운영·기술적 대응물.
...
## 500개의 문턱 — 운영 제약이 편집 원칙이 되다 {#500개의-문턱-운영-제약이-편집-원칙이-되다}
...
## 두 개의 코어 — 출판판과 존재축 {#두-개의-코어-출판판과-존재축}
...
## 680개의 인물 방과 538개의 메타워드 {#680개의-인물-방과-538개의-메타워드}
...
## 텍스트 공해와 모두가 저자라는 초대 {#텍스트-공해와-모두가-저자라는-초대}
...
## 한글과 영어 — 복제가 아니라 두 개의 입구 {#한글과-영어-복제가-아니라-두-개의-입구}
...
## 문턱의 실체 — 2026-07-26의 실측과 첫 판본 {#문턱의-실체-2026-07-26의-실측과-첫-판본}
...
### 번호는 돌아오지 않는다 — 2026-07-27의 재등록 실측 {#번호는-돌아오지-않는다-2026-07-27의-재등록-실측}
...
## 이미지 — 문턱 앞에서, 지금 불러낼 수 있는 것들의 판본 {#이미지-문턱-앞에서-지금-불러낼-수-있는-것들의-판본}
...
{{< figure src="/images/20260730T182900--glgman-at-the-threshold__brand_nanobanana.jpg" width="100%" >}}
...
## 원문 보존 — 2026-07-22 출근길 날것 {#원문-보존-2026-07-22-출근길-날것}
...
### <span class="timestamp-wrapper"><span class="timestamp">[2026-07-26 Sun 11:31]</span></span> 동기화 불가 메시지 스크린샷 {#동기화-불가-메시지-스크린샷}
