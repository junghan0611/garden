...
(<i>Asdf-Vm/Asdf Package Manager</i>, 2014/2025)
...
<style>.csl-entry{text-indent: -1.5em; margin-left: 1.5em;}</style><div class="csl-bib-body">
  <div class="csl-entry"><i>Asdf-vm/asdf package manager</i>. (2025). [Computer software]. asdf version manager. <a href="https://github.com/asdf-vm/asdf">https://github.com/asdf-vm/asdf</a> (2014)</div>
</div>
