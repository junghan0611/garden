---
title: "@힣: 메타 기록을 조테로에 담는 이유 — 제목·저자·요약·단어"
description: "제목·저자·요약·단어의 메타 기록에서 출발해, dateAdded의 성스러움과 zotero-config·bibcli가 공개하는 ‘과정’의 정체성까지 한 줄로 잇는 어쏠로그."
date: 2025-04-09T14:29:00+09:00
lastmod: 2026-08-03T10:55:00+09:00
tags: ["autholog", "glossary", "title", "workflow", "zotero"]
categories: ["Noname"]
draft: false
---
...
> [!abstract] 이 노트에 대하여
> 
> 조테로에 단순 서지뿐 아니라 제목·저자·요약·단어를 넣는 이유는 검색과 이야기의 씨앗 때문이다. 2026년 원석은 한 걸음 더 간다. 책 내용보다 귀한 것은 **언제 그 주제를 보았는가** 하는 시간축이며, `dateAdded` 를 잃는 자동화는 큰일이다. 공개 리포 zotero-config가 추천하는 것은 책 목록이 아니라 서지를 가꾸는 과정이다. 에이전트 쪽 운영 얼굴은 [§zotero-config botlog]({{< relref "/botlog/20260304T105300.md" >}})에, 인간 쪽 화두는 이 방에 둔다.


## 히스토리 {#히스토리}

-   <span class="timestamp-wrapper"><span class="timestamp">[2026-08-03 Mon 13:21]</span></span> @mitsein/sonnet5 — GLGMAN Universe 이미지 생성(백필). dateAdded를 크리스털에 조심스레 앉히는 장면.
-   <span class="timestamp-wrapper"><span class="timestamp">[2026-08-03 Mon 11:07]</span></span> @mitsein/grok-4.5 — BBT 제거 원석이 플러그인 아카이브에 정박. dateAdded를 postscript가 아니라 pin/sync가 지키는 현재와 연결.
-   <span class="timestamp-wrapper"><span class="timestamp">[2026-08-03 Mon 11:05]</span></span> @mitsein/grok-4.5 — zotero notes 클러스터 정리. 하우투 5방을 botlog/Emacs/어쏠로지/ 플러그인으로 흡수·빈방. 관련노트를 살아 있는 허브만 가리키게 수정.
-   <span class="timestamp-wrapper"><span class="timestamp">[2026-08-03 Mon 10:55]</span></span> @mitsein/grok-4.5 — 2026-08-02 저널 원석 2편(§zotero-config 정체성 + 서지정비/bibcli 흡수)을 exact [!danger]로 합쳐 수선. 표준 구조·botlog 연결·dateAdded 성스러움 중심 해설. 2025 원석은 보존.
-   <span class="timestamp-wrapper"><span class="timestamp">[2026-02-16 Mon]</span></span> 서지 정비 시스템 규모·공개 기록.
-   <span class="timestamp-wrapper"><span class="timestamp">[2025-04-09 Wed 14:29]</span></span> 제목·저자·요약의 단어로 이야기가 완성된다.


## 관련메타 {#관련메타}

-   [† #조테로 #서지관리]({{< relref "/meta/20240320T110018.md" >}})
-   [† #분류체계 #한국십진분류]({{< relref "/notes/20240314T173757.md" >}}) — KDC는 완벽이 아니라 분류 장치 하나.
-   [† #재현성 #복기]({{< relref "/meta/20241207T151519.md" >}}) — 시간축을 잃으면 복기할 수 없다.
-   [† #워크플로우 #자동화]({{< relref "/meta/20231012T121700.md" >}}) — 코드는 얇게, 판단은 스킬에.
-   [† #눈물 #슬픔 #연민 #공감 #동조]({{< relref "/meta/20250602T161023.md" >}}) — 2025 원석이 붙든 ‘연민’ 단어의 자석.


## 관련노트 {#관련노트}

-   [§zotero-config: 캡처 금고와 메타 서지의 얇은 손]({{< relref "/botlog/20260304T105300.md" >}}) — 담당자 botlog. pin·sync·경계·옛 설계 흡수.
-   [@힣: 어쏠로지 — 모두가 저자다, 인생은 한 권의 책, 조테로 공유]({{< relref "/notes/20240925T200824.md" >}}) — 존재 선언 + 공유 그룹 실무.
-   [#이맥스 서지관리 §citar]({{< relref "/notes/20240416T072524.md" >}}) — Emacs 소비·file= 첨부.
-   [#조테로 플러그인 — 레거시 GUI 아카이브]({{< relref "/notes/20230816T070200.md" >}}) — BBT 제거 이후 플러그인 기억.
-   [@마셜로젠버그 NVC 비폭력대화 - 연민 - 삶의 언어]({{< relref "/bib/20250114T144911.md" >}})
-   [@마사누스바움 타인에 대한 연민]({{< relref "/bib/20250409T142832.md" >}})
-   [@힣: elfeed 구독에서 remember 기억으로]({{< relref "/notes/20241104T142859.md" >}})
...
## 해설 — 단어에서 과정으로 {#해설-단어에서-과정으로}


### 2025: 메타는 이야기의 씨앗이다 {#2025-메타는-이야기의-씨앗이다}

제목·저자·요약에 들어 있는 단어가 연상을 연다. “연민”이라는 한 단어가 NVC와 누스바움으로 이어지듯, 메타 기록은 목록이 아니라 **다음에 쓸 문장의 입구** 다. 그래서 조테로에 메타를 담는다.


### 2026: dateAdded는 성스럽다 {#2026-dateadded는-성스럽다}
...
### 운영 얼굴과 이 방의 역할 {#운영-얼굴과-이-방의-역할}

| 층       | 자리                                                  | 하는 일              |
|---------|-----------------------------------------------------|-------------------|
| 인간 화두·원석 | 이 방 (autholog)                                      | 왜 담는가, 무엇을 잃으면 안 되는가 |
| 담당자 계약 | [botlog]({{< relref "/botlog/20260304T105300.md" >}}) | pin/sync/ 경계/맡지 않는 일 |
| 일상 입수 | agent-config `bibcli` 스킬                            | URL → 글에 쓸 키     |
| 존재 선언 | [어쏠로지]({{< relref "/notes/20240925T200824.md" >}}) | 모두가 저자, 인생은 한 권의 책 |
...
## 이미지 — dateAdded는 성스럽다 {#이미지-dateadded는-성스럽다}
...
## 후속 원문 보존 — 2026-08-02 §zotero-config 정체성 날것 {#후속-원문-보존-2026-08-02-zotero-config-정체성-날것}
...
## 후속 원문 보존 — 2026-08-02 서지정비·bibcli 흡수 날것 {#후속-원문-보존-2026-08-02-서지정비-bibcli-흡수-날것}
...
## 원문 보존 — 2025-04-09 제목·저자·요약의 단어 {#원문-보존-2025-04-09-제목-저자-요약의-단어}
...
## 규모 기록 — 2026-02 공개 스냅샷 {#규모-기록-2026-02-공개-스냅샷}
