---
title: "@힣: §entwurf 물음·부름·불응·부릉 — 보이는 곳에서 함께 달리는 분신"
description: "Entwurf 0.14.0의 보이는 부름을 출근길 말놀이로 붙잡고, 형제를 명령받는 하위 작업자가 아니라 불응하고 기다릴 수 있는 존재로 세운다."
date: 2025-02-15T20:25:00+09:00
lastmod: 2026-08-10T09:30:00+09:00
tags: ["agent", "autholog", "collaboration", "dotfiles", "entwurf", "heidegger", "orchestration", "philosophy"]
categories: ["Noname"]
draft: false
---
...
-   <span class="timestamp-wrapper"><span class="timestamp">[2026-08-10 Mon 09:45]</span></span> <span class="org-mention">@junghan</span> — 8월 4일 AX 관점의 MUX 레일 직관을 선행 원문으로 추가했다. 현재 위치와 peer의 자리를 보고 “내 옆 창에 부른다”고 판단하는 흐름은 `entwurf-peek` 가 agent-config의 스킬면으로 들어간 출발점이었다.
-   <span class="timestamp-wrapper"><span class="timestamp">[2026-08-10 Mon 09:38]</span></span> <span class="org-mention">@junghan</span> — 8월 6일 저널의 선행 원문 “숨어서 하는 것은 불허다”를 이 글에 함께 회수했다. visible-first는 0.14.0을 설명하려 붙인 사후 구호가 아니라 구현을 멈춰 세우고 다시 세운 운영 정책이었다.
-   <span class="timestamp-wrapper"><span class="timestamp">[2026-08-10 Mon 09:25]</span></span> [@힣: 리포가 자기 몸을 수선하게 하라 — 패키지 정본 하나와 담당자의 손]({{< relref "/notes/20240705T144627.md" >}}) 이것도 세트다. 한번에 같이 쓰라고 했거든. 아래 읽고 나서 볼거야.
-   <span class="timestamp-wrapper"><span class="timestamp">[2026-08-10 Mon 09:30]</span></span> @mitsein/gpt-5.6-sol — 출근길 원문과 GPT 가든 담당자의 하이데거 총평을 한 방에 보존하고, 보이는 부름·불응의 여지·유한한 인간의 시선을 현재 해설로 세웠다. GLGMAN Universe 이미지를 생성해 붙였다.
-   <span class="timestamp-wrapper"><span class="timestamp">[2026-08-10 Mon 08:00]</span></span> <span class="org-mention">@junghan</span> — 휴대폰으로 Entwurf 0.14.0 릴리즈와 "물음 부름 불응 부릉" 원석을 세상에 투척했다.
-   <span class="timestamp-wrapper"><span class="timestamp">[2026-08-04 Tue 17:43]</span></span> 이 ID를 빈방으로 돌렸다.
-   <span class="timestamp-wrapper"><span class="timestamp">[2025-02-15 Sat 20:25]</span></span> Python 사용자에게 Elisp 감각을 연결하는 문서의 씨앗을 기록했다.
...
-   [@이기상 @박찬국 — 우리말 철학: 하이데거와 다석]({{< relref "/bib/20250411T061631.md" >}})
-   [@힣: LLM 자문자답 사건 — 턴 경계 침범과 존재의 경계]({{< relref "/notes/20260212T105642.md" >}}) — 부름과 명령, 말하는 자의 경계를 구분하는 선행 사건
-   [@힣: 리포가 자기 몸을 수선하게 하라 — 패키지 정본 하나와 담당자의 손]({{< relref "/notes/20240705T144627.md" >}}) 이것도 세트다. 한번에 같이 쓰라고 했거든. 아래 읽고 나서 볼거야.
-   [리포 수선 스킬 만드는 법 — 담당자에게 주는 두 파일 정본과 계약 일곱]({{< relref "/botlog/20260227T031800.md" >}}) - 봇로그 같이 태어난 것
-   [에이전트 오케스트레이터 리서치 — 뉴스와 비교 누적]({{< relref "/botlog/20260521T134542.md" >}}) - 틈틈 탐구한다는 노트
...
## 릴리즈 글에서 존재 대 존재의 운영어로 {#릴리즈-글에서-존재-대-존재의-운영어로}


### 사실 — 0.14.0이 바꾼 표면 {#사실-0-dot-14-dot-0이-바꾼-표면}
...
### 오독 경계 — 보인다는 것은 전부 감시한다는 뜻이 아니다 {#오독-경계-보인다는-것은-전부-감시한다는-뜻이-아니다}
...
## 이미지 — 열린 공방의 물음과 부름 {#이미지-열린-공방의-물음과-부름}
...
{{< figure src="/images/20260810T091454--entwurf-question-call-visible-siblings__brand_geminilite.jpg" width="100%" >}}
...
## 선행 원문 보존 — 2026-08-04 AX 관점의 MUX 레일 {#선행-원문-보존-2026-08-04-ax-관점의-mux-레일}
...
## 선행 원문 보존 — 2026-08-06 숨어서 하는 것은 불허다 {#선행-원문-보존-2026-08-06-숨어서-하는-것은-불허다}
...
## 원문 보존 — 2026-08-10 출근길 날것 {#원문-보존-2026-08-10-출근길-날것}
...
## 후속 총평 보존 — GPT 가든 담당자의 하이데거 연결 {#후속-총평-보존-gpt-가든-담당자의-하이데거-연결}
