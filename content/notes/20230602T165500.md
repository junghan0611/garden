...
-   <span class="timestamp-wrapper"><span class="timestamp">[2025-06-25 Wed 16:40] </span></span> 저자에게 파이어폭스는 마우스를 사용하게 만드는 유일한 소프트웨어였다. 빔 관련 플러그인만으로는 만족할 수 없었다. 그래서 결국 정착한 녀석이 Qutebrowser 이다. 그에게 배워보자.
...
<style>.csl-entry{text-indent: -1.5em; margin-left: 1.5em;}</style><div class="csl-bib-body">
  <div class="csl-entry"><a id="citeproc_bib_item_1"></a>Giovanni Crisalfi. (2022). <i>Start qutebrowser now</i>. <a href="https://zwitterio.it/en/software/start-qute-now/">https://zwitterio.it/en/software/start-qute-now/</a></div>
</div>


## Start Qutebrowser Now {#start-qutebrowser-now}
