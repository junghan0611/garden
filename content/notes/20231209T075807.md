...
(<a href="#citeproc_bib_item_2"><i>Org Mode - Organize Your Life in Plain Text!</i>, n.d.</a>)
...
(<a href="#citeproc_bib_item_3">Tasshin, 2017</a>) <span class="timestamp-wrapper"><span class="timestamp">[2023-10-11 Wed 14:39]</span></span>
...
{{< figure src="/home/junghan/org/notes/20231011_143926_screenshot.png" width="100%" >}}

이 부분 간단 명료하다.

{{< figure src="/home/junghan/org/notes/20231011_144308_screenshot.png" width="100%" >}}

project view

{{< figure src="/home/junghan/org/notes/20231011_150527_screenshot.png" width="100%" >}}
...
-   Repeating tasks Must do every week (+1w), Good to do every day (++1d)
    ...
    {{< figure src="/home/junghan/org/notes/20231023_112517_screenshot.png" caption="<span class=\"figure-number\">Figure 4: </span>agenda repeat" width="100%" >}}
...
{{< figure src="/home/junghan/org/notes/20231022_092503_screenshot.png" caption="<span class=\"figure-number\">Figure 5: </span>focus is everything" width="100%" >}}
...
-   Column View
    ...
    -   'e' edit
        ...
        {{< figure src="/home/junghan/org/notes/20231023_110000_screenshot.png" caption="<span class=\"figure-number\">Figure 6: </span>column view" width="100%" >}}
...
{{< figure src="/home/junghan/org/notes/20240906_062832_screenshot.png" caption="<span class=\"figure-number\">Figure 7: </span>test" width="100%" >}}
...
<style>.csl-entry{text-indent: -1.5em; margin-left: 1.5em;}</style><div class="csl-bib-body">
  ...
  <div class="csl-entry"><a id="citeproc_bib_item_2"></a><i>Org mode - organize your life in plain text!</i> (n.d.). Retrieved June 2, 2025, from <a href="https://doc.norang.ca/org-mode.html">https://doc.norang.ca/org-mode.html</a></div>
  <div class="csl-entry"><a id="citeproc_bib_item_3"></a>Tasshin. (2017, December 15). <i>Implementing a second brain in emacs and org-mode - tasshin</i>. <a href="https://tasshin.com/blog/implementing-a-second-brain-in-emacs-and-org-mode/">https://tasshin.com/blog/implementing-a-second-brain-in-emacs-and-org-mode/</a></div>
</div>
