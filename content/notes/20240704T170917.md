---
title: "@힣: 지식공학 — 개인지식관리·인공지능·PKM-AI 하네스의 관계"
description: "지식공학을 개인지식관리와 인공지능 사이의 오래된 용어로만 두지 않고, 2026년 PKM-AI 하네스와 링크드인 보유기술의 Knowledge Engineering 축으로 다시 연결한다. 원문 메모와 에이전트 해설을 분리해, 기억·검색·시간축·도메인 지식을 다루는 기술이 힣의 가든에서 어떻게 직무 언어가 되는지 정리한다."
date: 2024-07-04T17:09:00+09:00
lastmod: 2026-07-29T06:42:00+09:00
tags: ["ai", "autholog", "bib", "engineering", "knowledge", "pkm", "pkmai"]
categories: ["Noname"]
draft: false
---
...
-   <span class="timestamp-wrapper"><span class="timestamp">[2026-07-30 Thu 18:11]</span></span> @mitsein/sonnet — GLG 요청으로 후속 라운드로 미뤄뒀던 GLGMAN Universe 이미지를 생성했다. 1차 생성본은 배경에 검이 걸려 도구락 위반, 검을 명시 금지한 프롬프트로 재생성해 통과.
-   <span class="timestamp-wrapper"><span class="timestamp">[2026-07-29 Wed 06:42]</span></span> @mitsein — GLG 검수 중 요청으로 원문과 에이전트 해설을 분리했다. \`원문 보존\`에 2024 메모를 모으고, 2026 보정은 별도 해설 절로 옮겨 표준 autholog 구조에 가깝게 정리했다.
-   <span class="timestamp-wrapper"><span class="timestamp">[2026-07-29 Wed 06:24]</span></span> @mitsein — 링크드인 소개 업데이트의 보유기술 `Knowledge Engineering` 축과 연결했다. 지식공학을 PKM-AI 하네스의 기억·검색·시간축·도메인 지식 기술로 보정하고, 관련 autholog/botlog를 추가했다.
-   <span class="timestamp-wrapper"><span class="timestamp">[2025-10-23 Thu 08:50]</span></span> 엔지니어링?! 왜 이게 노트에 있지? 지식공학 측면에서 분류
-   <span class="timestamp-wrapper"><span class="timestamp">[2024-07-04 Thu 17:09]</span></span> 지식공학


## 관련메타 {#관련메타}

-   [‡ † #구조]({{< relref "/meta/20240822T140808.md" >}}) — 지식 기반 시스템과 가든 구조를 읽는 상위 자석.
-   [† #개인지식관리]({{< relref "/meta/20230919T132700.md" >}}) — PKM의 원래 자리.
-   [‡ † #인공지능 #외계지능]({{< relref "/meta/20240522T143822.md" >}}) — 지식공학이 출발한 AI 맥락.
-   [† #AX #AI전환 #PKM-AI]({{< relref "/meta/20250328T124902.md" >}}) — 개인 PKM 언어가 조직·직무 공용어로 넘어가는 교량.
-   [0zq ‡ † #지식]({{< relref "/meta/20250424T230029.md" >}}) — 지식 자체의 상위 메타.
-   [1j6 † #지식보존 #지식관리 10.6]({{< relref "/meta/20250428T161049.md" >}}) — 보존·관리·회수의 장기 축.
-   [1g † #기술 7 #보유기술]({{< relref "/meta/20250424T143631.md" >}}) — `Knowledge Engineering` 이 보유기술로 번역되는 자리.
-   [† #재능 #재주 #능력 #노력 #연습 #지루함 #익숙함]({{< relref "/meta/20240414T224508.md" >}}) — 보유기술을 능력 형성의 시간축으로 읽는 자석.


## 관련노트 {#관련노트}

-   [@힣: 링크드인 소개 업데이트 — 이력서가 아니라 시간축이 증언하는 공개키]({{< relref "/notes/20250515T103930.md" >}}) — 보유기술 `Knowledge Engineering` 을 기억·검색·시간축·도메인 지식으로 명명한 원석.
-   [@힣: 기업용 하네스 - 개인 시간축 기업 데이터 — PKM-AI 하네스 다음 좌표]({{< relref "/notes/20231018T221900.md" >}}) — 개인 시간축과 기업 데이터·워크플로·거버넌스를 잇는 다음 경계.
-   [§org: @PKM-AI 인간의 시간과 에이전트가 만나는 공통 기록층]({{< relref "/botlog/20260406T140411.md" >}}) — PKM-AI를 공통 기록층으로 설명한 botlog.
-   [§junghan0611: 깃허브 프로파일 이력서 — 영문 공개키]({{< relref "/botlog/20260318T183247.md" >}}) — 지식공학 축이 외부 공개키/이력서 언어로 번역된 자리.
-   [하네스 엔지니어링: 돌도끼에서 인공지능까지, 도구와 존재의 접합부]({{< relref "/botlog/20260319T152938.md" >}}) — 하네스 엔지니어링과 지식공학이 만나는 botlog.
-   [@힣: 에이전트 컨텍스트 레이어 기술 지도 — 하네스·메모리·지식그래프·PKG·PKM-AI]({{< relref "/notes/20251024T085736.md" >}}) — 컨텍스트·메모리·지식그래프 기술 지도.
-   [#개인지식관리: 용어 PKA PKB PKC PKI PKM PKO]({{< relref "/notes/20240704T164608.md" >}}) — 개인지식관리 용어 사전.
-   [@헥터레베스크 Hector Levesque #지식표현 #추론분야 #인공지능 #석학]({{< relref "/bib/20241111T150518.md" >}}) — 지식표현·추론의 고전적 AI 축.

## BIBLIOGRAPHY

<div class="csl-bib-body">
  <div class="csl-entry"><a id="citeproc_bib_item_1"></a>“지식공학.” 2024. <a href="https://ko.wikipedia.org/w/index.php?title=%EC%A7%80%EC%8B%9D%EA%B3%B5%ED%95%99&oldid=36922836">https://ko.wikipedia.org/w/index.php?title=%EC%A7%80%EC%8B%9D%EA%B3%B5%ED%95%99&#38;oldid=36922836</a>.</div>
</div>
...
## 해설 — 지식공학을 다시 부르는 이유 {#해설-지식공학을-다시-부르는-이유}
...
## 해설 — PKM-AI에서 Knowledge Engineering이 뜻하는 것 {#해설-pkm-ai에서-knowledge-engineering이-뜻하는-것}
...
그래서 이 노트는 [링크드인 소개 업데이트]({{< relref "/notes/20250515T103930.md" >}})의 보유기술 표면과 연결된다. 거기서 `Knowledge Engineering` 은 "기억·검색·시간축·도메인 지식"이라고 적혔다. 이 노트는 그 말의 내부 근거다.


## 해설 — 개인 시간축에서 기업 데이터로 {#해설-개인-시간축에서-기업-데이터로}

[기업용 하네스]({{< relref "/notes/20231018T221900.md" >}})에서 다음 경계는 개인의 기억과 저자성, 장기 협업에서 배운 것을 기업의 데이터, 거버넌스, 워크플로, 도메인 오너십으로 옮기는 일이라고 했다. 이 문장이 지식공학과 만난다.
...
## 이미지 — 다섯 그릇, 기억을 다시 읽는 손 {#이미지-다섯-그릇-기억을-다시-읽는-손}
...
{{< figure src="/images/20260730T181032--glgman-five-bowls-reading-memory-again-v2__brand_nanobanana.jpg" width="100%" >}}
...
## 원문 보존 — 2024 지식공학 메모 {#원문-보존-2024-지식공학-메모}

> [!danger]
> 
> 지식공학 :2024: (<a href="#citeproc_bib_item_1">“지식공학” 2024</a>)
> 
