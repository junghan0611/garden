...
[#워크플로우]({{< relref "/meta/20231012T121700.md" >}}) 에서 가져옴 <span class="timestamp-wrapper"><span class="timestamp">[2024-12-12 Thu 15:28]</span></span>
...
### <span class="org-todo done DONT">DONT</span> PARA 세부 그룹 태그 구성 {#para-세부-그룹-태그-구성}
...
### <span class="org-todo done DONT">DONT</span> 목표 : 진행 상황 점검 {#목표-진행-상황-점검}
...
### <span class="org-todo done DONT">DONT</span> org-roam todo helper {#org-roam-todo-helper}
...
- <span class="org-todo done DONE">DONE</span>  rogue-layer
...
- <span class="org-todo done DONE">DONE</span>  대분류로 묶어라.
...
- <span class="org-todo done DONE">DONE</span>  대분류 아래로 내용을 일단 다 복붙하라

    <span class="timestamp-wrapper"><span class="timestamp">[2023-04-19 Wed 17:38]</span></span>


### Emacs Workflow and Samples {#emacs-workflow-and-samples}
...
{{< figure src="/images/20231017_125606_screenshot.png" width="100%" >}}
...
-   [#워크플로우 (2023-10-12)]({{< relref "/meta/20231012T121700.md" >}})
