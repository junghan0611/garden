...
[2024-10-03]({{< relref "/journal/20241003T000000.md" >}}) 디스코드에서 스레드를 보면. 이런 스타일로 기록을 남기는 방법이다. 이미 내가 하는 방법이 이런 것 아닌가? 디지털 노트를 남기는 것이되 그냥 기록 쌓는 스타일 그러니까. 이게 어디냐 주소? 이거야. (“Discord - \#Doomemacs \#Org-Mode Improved Latex Preview Development” n.d.)
