...
<style>.csl-entry{text-indent: -1.5em; margin-left: 1.5em;}</style><div class="csl-bib-body">
  <div class="csl-entry"><a id="citeproc_bib_item_1"></a><i>How to install and configure vnc on ubuntu 20.04 | digitalocean</i>. (n.d.). Retrieved July 7, 2025, from <a href="https://www.digitalocean.com/community/tutorials/how-to-install-and-configure-vnc-on-ubuntu-20-04">https://www.digitalocean.com/community/tutorials/how-to-install-and-configure-vnc-on-ubuntu-20-04</a></div>
  <div class="csl-entry"><a id="citeproc_bib_item_2"></a><i>Xfce4 desktop 설치 우분투 서버 22.04 - 리모트 vnc xrdp 연결</i>. (n.d.). Retrieved July 4, 2025, from <a href="https://www.perplexity.ai/search/xfce4-desktop-seolci-ubuntu-se-Oe8G6nHdRLORJiYBcCZUMQ">https://www.perplexity.ai/search/xfce4-desktop-seolci-ubuntu-se-Oe8G6nHdRLORJiYBcCZUMQ</a></div>
</div>


## Xfce4 Desktop 설치 우분투 서버 22.04 - 리모트 Vnc Xrdp 연결 {#xfce4-desktop-설치-우분투-서버-22-dot-04-리모트-vnc-xrdp-연결}

(<a href="#citeproc_bib_item_2"><i>Xfce4 Desktop 설치 우분투 서버 22.04 - 리모트 Vnc Xrdp 연결</i>, n.d.</a>)
...
(<a href="#citeproc_bib_item_1"><i>How to Install and Configure Vnc on Ubuntu 20.04 | Digitalocean</i>, n.d.</a>)
