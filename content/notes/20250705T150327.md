---
title: "#Xfce4 Desktop 설치 우분투 서버 - 리모트 VNC 연결"
description: "Xfce4 Desktop 설치 우분투 서버 22.04 - 리모트 Vnc Xrdp 연결"
date: 2025-07-05T15:03:00+09:00
lastmod: 2025-07-05T15:03:00+09:00
tags: ["vnc", "remote", "desktop", "linux", "bib"]
categories: ["Noname"]
draft: false
---
...
-   <span class="timestamp-wrapper"><span class="timestamp">[2025-07-05 Sat 15:03]</span></span>
...
<div class="csl-bib-body">
  <div class="csl-entry"><a id="citeproc_bib_item_1"></a>“How to Install and Configure VNC on Ubuntu 20.04.” n.d. Accessed July 7, 2025. <a href="https://www.digitalocean.com/community/tutorials/how-to-install-and-configure-vnc-on-ubuntu-20-04">https://www.digitalocean.com/community/tutorials/how-to-install-and-configure-vnc-on-ubuntu-20-04</a>.</div>
  <div class="csl-entry"><a id="citeproc_bib_item_2"></a>“Xfce4 Desktop 설치 우분투 서버 22.04 - 리모트 Vnc Xrdp 연결.” n.d. Accessed July 4, 2025. <a href="https://www.perplexity.ai/search/xfce4-desktop-seolci-ubuntu-se-Oe8G6nHdRLORJiYBcCZUMQ">https://www.perplexity.ai/search/xfce4-desktop-seolci-ubuntu-se-Oe8G6nHdRLORJiYBcCZUMQ</a>.</div>
</div>


## Xfce4 Desktop 설치 우분투 서버 22.04 - 리모트 Vnc Xrdp 연결 {#xfce4-desktop-설치-우분투-서버-22-dot-04-리모트-vnc-xrdp-연결}

(<a href="#citeproc_bib_item_2">“Xfce4 Desktop 설치 우분투 서버 22.04 - 리모트 Vnc Xrdp 연결” n.d.</a>)
...
### [|2025-07-07 Mon 20:30|]({{< relref "/journal/20250707T000000.md#2025-07-07-mon" >}}) {#2025-07-07-mon-20-30--relref-journal-20250707t000000-dot-md-2025-07-07-mon}


#### @user vnc server가 동작하지 않는 이유는? {#user-vnc-server가-동작하지-않는-이유는}

```text
Downloads          Videos     netplan         ssh-gpu3.sh
hejdev@hejdev-s3:~$ sudo systemctl status vncserver@1
[sudo] password for hejdev:
...
Jul 07 11:29:58 hejdev-s3 systemd[1]: Starting Start TightVNC server at startup...
Jul 07 11:29:58 hejdev-s3 systemd[1104]: vncserver@1.service: Failed to determine >
Jul 07 11:29:58 hejdev-s3 systemd[1104]: vncserver@1.service: Failed at step USER >
Jul 07 11:29:58 hejdev-s3 systemd[1111]: vncserver@1.service: Failed to determine >
Jul 07 11:29:58 hejdev-s3 systemd[1111]: vncserver@1.service: Failed at step USER >
Jul 07 11:29:58 hejdev-s3 systemd[1]: vncserver@1.service: Control process exited,>
Jul 07 11:29:58 hejdev-s3 systemd[1]: vncserver@1.service: Failed with result 'exi>
Jul 07 11:29:58 hejdev-s3 systemd[1]: Failed to start Start TightVNC server at sta>
lines 1-15/15 (END)
...
1.  서비스 파일 확인 /etc/systemd/system/vncserver@.service 파일에서 User=hejdev 같은 설정이 맞는지 확인하세요. 예시:
    ```nil
    [Service]
    Type=forking
    User=hejdev
    PAMName=login
    PIDFile=/home/hejdev/.vnc/%H:%i.pid
    ExecStartPre=-/usr/bin/vncserver -kill :%i > /dev/null 2>&1
    ExecStart=/usr/bin/vncserver -depth 24 -geometry 1280x800 :%i
    ExecStop=/usr/bin/vncserver -kill :%i
    ```

2.  유저 존재 확인 hejdev 계정이 실제로 존재하는지 확인하세요.
    ```nil
    id hejdev
    ```

3.  홈 디렉토리 권한 /home/hejdev 디렉토리와 .vnc 폴더의 소유권 및 권한이 맞는지 확인하세요.
    ```nil
    ls -ld /home/hejdev
    ls -ld /home/hejdev/.vnc
    ```
...
## How to Install and Configure VNC on Ubuntu 20.04 | DigitalOcean {#how-to-install-and-configure-vnc-on-ubuntu-20-dot-04-digitalocean}

(<a href="#citeproc_bib_item_1">“How to Install and Configure VNC on Ubuntu 20.04” n.d.</a>)
...
### [Introduction](https://www.digitalocean.com/community/tutorials/how-to-install-and-configure-vnc-on-ubuntu-20-04#introduction) {#introduction}
...
### [Prerequisites](https://www.digitalocean.com/community/tutorials/how-to-install-and-configure-vnc-on-ubuntu-20-04#prerequisites) {#prerequisites}
...
### [Step 1 — Installing the Desktop Environment and VNC Server](https://www.digitalocean.com/community/tutorials/how-to-install-and-configure-vnc-on-ubuntu-20-04#step-1-installing-the-desktop-environment-and-vnc-server) {#step-1-installing-the-desktop-environment-and-vnc-server}
...
### [Step 3 — Connecting to the VNC Desktop Securely](https://www.digitalocean.com/community/tutorials/how-to-install-and-configure-vnc-on-ubuntu-20-04#step-3-connecting-to-the-vnc-desktop-securely) {#step-3-connecting-to-the-vnc-desktop-securely}
...
{{< figure src="https://assets.digitalocean.com/articles/vnc_2004/vnc_putty_topbar_arrow.png" >}}
...
{{< figure src="https://assets.digitalocean.com/articles/vnc_2004/vnc_putty_reconf_local.png" >}}
...
{{< figure src="https://assets.digitalocean.com/articles/vnc_2004/vnc_xfce.png" >}}

You can access files in your home directory with the file manager or from the command line, as seen here:

{{< figure src="https://assets.digitalocean.com/articles/vnc_2004/vnc_files.png" >}}
...
### [Step 4 — Running VNC as a System Service](https://www.digitalocean.com/community/tutorials/how-to-install-and-configure-vnc-on-ubuntu-20-04#step-4-running-vnc-as-a-system-service) {#step-4-running-vnc-as-a-system-service}
