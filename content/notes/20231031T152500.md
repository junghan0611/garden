...
동반 패키지 `zk-org-link.el=은 =zk=라는 사용자 지정 조직 링크 유형을 제공해 링크 스타일이 =[[201812101245]]` 대신 =[BROKEN LINK: zk:201812101245]=로 지정됩니다. 조직 링크를 사용하면 예상대로 노트를 따라갈 수 있을 뿐 아니라 =org-export=를 통해 다양한 형식으로 내보내고, =org-store-link=를 통해 저장하고, =org-insert-link=로 완성할 수도 있습니다.
