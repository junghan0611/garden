---
title: "#한글: #소리내어읽기 #이맥스 #텍스트음성변환 #한국어 ¤piper ¤espeak ¤EdgeTTS"
description: "한국어 TTS를 이맥스와 리눅스에서 시험하며 Piper, EdgeTTS, eSpeak의 가능성과 한계를 정리한 노트."
date: 2023-11-20T06:52:00+09:00
lastmod: 2026-04-13T16:45:00+09:00
tags: ["edgetts", "emacs", "espeak", "hangul", "korean", "piper", "tts"]
categories: ["Noname"]
draft: false
---
...
-   [† #TTS #Text-to-speech]({{< relref "/meta/20250713T112650.md" >}})


## 히스토리 {#히스토리}

-   <span class="timestamp-wrapper"><span class="timestamp">[2026-04-13 Mon 16:46]</span></span> @pi — Search Console query data로 이 노트가 다시 surfaced 되었고, Piper/eSpeak/EdgeTTS 중심으로 description과 retrieval tags를 보강했다.
-   <span class="timestamp-wrapper"><span class="timestamp">[2025-07-13 Sun 11:29]</span></span> [#전자책: #뷰어 #TTS ¤Readest ¤Foliate ¤ReadEra ¤calibredb]({{< relref "/notes/20240901T112730.md" >}}) 리디스트가 리눅스에서 책 읽어주는 것 보고 반했다. 이건 되야할 일이야.


## Read Aloud: A Text to Speech Voice Reader {#read-aloud-a-text-to-speech-voice-reader}
...
### <span class="org-todo done DONT">DONT</span> espeak-ng {#espeak-ng}
...
### <span class="org-todo done DONT">DONT</span> Speech Dispatcher ; speechd - <span class="org-hashtag">#리눅스</span> 관리자 {#speech-dispatcher-speechd-리눅스-관리자}
...
### <span class="org-todo todo TODO">TODO</span> piper : 한국어 지원 안됨 {#piper-한국어-지원-안됨}
...
#### Pied - <span class="org-hashtag">#flatpak</span> 패키지로 piper 관리 {#pied-flatpak-패키지로-piper-관리}
...
#### <span class="org-todo done DONT">DONT</span> piper korean {#piper-korean}
...
### <span class="org-todo done DONT">DONT</span> vosk {#vosk}
...
### [|2025-07-13 Sun 11:26|]({{< relref "/journal/20250707T000000.md#2025-07-13-sun" >}}) {#2025-07-13-sun-11-26-2025-07-13-sun}


#### @user EdgeTTS 이외에 한국어 TTS를 더 소개해줘. 활용할 수 있어야 돼. {#user-edgetts-이외에-한국어-tts를-더-소개해줘-dot-활용할-수-있어야-돼-dot}
...
## <span class="timestamp-wrapper"><span class="timestamp">[2026-04-13 Mon]</span></span> Search Console 기반 메타유희 보강 {#search-console-기반-메타유희-보강}
