...
-   <span class="timestamp-wrapper"><span class="timestamp">[2025-06-24 Tue 07:11] </span></span> 잘봐라. 한글 입력기 날려라 kime를 쓰던가해 [#LLM: 새 노트북 하모니카 레골리스 이맥스 설치 및 닷파일 통합]({{< relref "/20250624T063959.md" >}})
...
## [#우분투 #업그레이드 #하모니카 8.0]({{< relref "/notes/20231004T141600.md" >}}) {#우분투-업그레이드-하모니카-8-dot-0--relref-notes-20231004t141600-dot-md}


## <span class="timestamp-wrapper"><span class="timestamp">[2024-02-20 Tue 17:16] </span></span> 재작성 필요 {#재작성-필요}

[†#타일링윈도우매니저]({{< relref "/meta/20240220T170557.md" >}}) 시리즈 중 하나.
...
## <span class="org-todo done DONT">DONT</span> nimf vs kime {#nimf-vs-kime}
...
## <span class="org-todo done DONE">DONE</span> [@힣: #재배포시스템 #롤백 가능한 공개 닷파일 - 운영체제 한글 도구 #모든것]({{< relref "/notes/20241224T113356.md" >}}) {#힣-재배포시스템-롤백-가능한-공개-닷파일-운영체제-한글-도구-모든것--relref-notes-20241224t113356-dot-md}
