---
title: "#하모니카 #리눅스 #설치법"
description: "하모니카 리눅스에 입력기, 레골리스, 이맥스를 얹는 설치 흐름과 주의점을 남긴 실전 기록."
...
-   <span class="timestamp-wrapper"><span class="timestamp">[2025-06-24 Tue 07:11]</span></span> 잘봐라. 한글 입력기 날려라 kime를 쓰던가해 [#LLM: 새 노트북 하모니카 레골리스 이맥스 설치 및 닷파일 통합]
...
## [#우분투 #업그레이드 #하모니카 8.0]({{< relref "/notes/20231004T141600.md" >}}) {#우분투-업그레이드-하모니카-8-dot-0}
...
## <span class="org-todo done DONE">DONE</span> [@힣: #재배포시스템 #롤백 가능한 공개 닷파일 - 운영체제 한글 도구 #모든것]({{< relref "/notes/20241224T113356.md" >}}) {#힣-재배포시스템-롤백-가능한-공개-닷파일-운영체제-한글-도구-모든것}
