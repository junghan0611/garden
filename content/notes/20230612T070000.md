---
title: "#버전관리: 컨벤셔널커밋 시멘틱버저닝 체인지로그 ¤git-cliff"
date: 2023-06-12T07:00:00+09:00
lastmod: 2025-07-18T00:00:00+09:00
tags: ["bib", "changelog", "conventionalcommit", "style", "version"]
categories: ["Noname"]
draft: false
date: 2023-06-12
---
...
<style>.csl-entry{text-indent: -1.5em; margin-left: 1.5em;}</style><div class="csl-bib-body">
  <div class="csl-entry"><a id="citeproc_bib_item_1"></a><i>Keep a Changelog 체인지로그 스펙</i>. (n.d.). Retrieved January 20, 2025, from <a href="https://keepachangelog.com/ko/1.0.0/">https://keepachangelog.com/ko/1.0.0/</a></div>
  <div class="csl-entry"><a id="citeproc_bib_item_2"></a><i>Orhun/git-cliff: A highly customizable changelog generator that follows conventional commit specifications</i>. (2023). [Computer software]. <a href="https://github.com/orhun/git-cliff">https://github.com/orhun/git-cliff</a></div>
  <div class="csl-entry"><a id="citeproc_bib_item_3"></a>Preston-Werner, T. (n.d.). <i>Semantic Versioning 시멘틱 버저닝</i>. Semantic Versioning. Retrieved January 20, 2025, from <a href="https://semver.org/lang/ko/">https://semver.org/lang/ko/</a></div>
  <div class="csl-entry"><a id="citeproc_bib_item_4"></a>Zhang, E. (2025). <i>Eki3z/git-cliff.el</i> [Computer software]. <a href="https://github.com/eki3z/git-cliff.el">https://github.com/eki3z/git-cliff.el</a> (2023)</div>
  <div class="csl-entry">NO_ITEM_DATA:commitlint/config-conventional</div>
</div>


## Keep a Changelog 체인지로그 스펙 {#keep-a-changelog-체인지로그-스펙}

(<a href="#citeproc_bib_item_1"><i>Keep a Changelog 체인지로그 스펙</i>, n.d.</a>)

-   동료가 git 로그를 changelogs에 덤프하게 내버려 두지 마세요.


## Semantic Versioning 시멘틱 버저닝 {#semantic-versioning-시멘틱-버저닝}

(<a href="#citeproc_bib_item_3">Preston-Werner, n.d.</a>)
...
-   <span class="timestamp-wrapper"><span class="timestamp">[2023-06-12 Mon 07:00] </span></span> 어떻게 커밋 메시지를 관리할 것이며 변경사항을 자동화 할 것인가? 그것도
...
### orhun/git-cliff: A highly customizable Changelog Generator that follows Conventional Commit specifications {#orhun-git-cliff-a-highly-customizable-changelog-generator-that-follows-conventional-commit-specifications}

(<a href="#citeproc_bib_item_2"><i>Orhun/Git-Cliff: A Highly Customizable Changelog Generator That Follows Conventional Commit Specifications</i>, 2023</a>)


### eki3z/git-cliff.el {#eki3z-git-cliff-dot-el}

(<a href="#citeproc_bib_item_4">Zhang, 2023/2025</a>)
