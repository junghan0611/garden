...
<style>.csl-entry{text-indent: -1.5em; margin-left: 1.5em;}</style><div class="csl-bib-body">
  <div class="csl-entry"><i>Keep a Changelog 체인지로그 스펙</i>. (n.d.). Retrieved January 20, 2025, from <a href="https://keepachangelog.com/ko/1.0.0/">https://keepachangelog.com/ko/1.0.0/</a></div>
  <div class="csl-entry"><i>Orhun/git-cliff: A highly customizable changelog generator that follows conventional commit specifications</i>. (2023). [Computer software]. <a href="https://github.com/orhun/git-cliff">https://github.com/orhun/git-cliff</a></div>
  <div class="csl-entry">Preston-Werner, T. (n.d.). <i>Semantic Versioning 시멘틱 버저닝</i>. Semantic Versioning. Retrieved January 20, 2025, from <a href="https://semver.org/lang/ko/">https://semver.org/lang/ko/</a></div>
  <div class="csl-entry">Zhang, E. (2025). <i>Eki3z/git-cliff.el</i> [Computer software]. <a href="https://github.com/eki3z/git-cliff.el">https://github.com/eki3z/git-cliff.el</a> (2023)</div>
...
(<i>Keep a Changelog 체인지로그 스펙</i>, n.d.)
...
(<i>Orhun/Git-Cliff: A Highly Customizable Changelog Generator That Follows Conventional Commit Specifications</i>, 2023)
