---
title: "@힣: elfeed 구독에서 remember 기억으로"
description: "elfeed로 유튜브·RSS를 구독하는 것과 remember로 그 안에서 기억할 것을 남기는 것은 다른 일이다. 요약의 마크다운이 org 문서를 해치지 않도록 코드와 프롬프트 양쪽을 손본 뒤, remember를 annotation 저장소로 더 적극적으로 쓰기로 한 1단계."
date: 2024-11-04T14:28:00+09:00
lastmod: 2026-08-03T11:08:00+09:00
tags: ["annotation", "autholog", "remember", "rss", "youtube"]
categories: ["Noname"]
draft: false
---
...
-   <span class="timestamp-wrapper"><span class="timestamp">[2026-08-03 Mon 11:08]</span></span> @mitsein/claude-sonnet-5 — 어쏠로그로 표준 수선. 2024-11 elfeed-tube 원문을 첫 원문 보존으로 감싸고, 2026-08-02 remember annotation 원문을 후속 원문 보존으로 이어붙였다. 관련메타·관련노트를 새로 연결하고 GLGMAN 이미지를 생성했다.
-   <span class="timestamp-wrapper"><span class="timestamp">[2026-08-02 Sun 09:00]</span></span> <span class="org-mention">@junghan</span> — elfeed-config.el의 `+elfeed--org-safe-summary` 로 요약 마크다운 안전화 코드를 적용 완료.
-   <span class="timestamp-wrapper"><span class="timestamp">[2026-08-02 Sun 06:24]</span></span> <span class="org-mention">@junghan</span> — remember ELFEED annotation 로직 개선이 필요함을 적고, 이 방을 어쏠로그 대상으로 지정.
-   <span class="timestamp-wrapper"><span class="timestamp">[2024-11-04 Mon 14:28]</span></span> <span class="org-mention">@junghan</span> — elfeed-tube로 유튜브 구독을 elfeed 안에 들이는 흐름을 처음 메모.


## 관련메타 {#관련메타}

-   [† #뉴스피드 #RSS]({{< relref "/meta/20230927T120800.md" >}}) — elfeed가 속한 뉴스피드/구독 기술의 축.
-   [† #지피텔]({{< relref "/meta/20250404T125106.md" >}}) — 요약·annotation 프롬프트가 gptel과 맞물리는 축.
-   [† #기억 #상상 #추억 #회상 #꿈 #자각몽 #다락방]({{< relref "/meta/20250424T230851.md" >}}) — remember라는 이름 자체가 겨눈 "기억하기"라는 더 큰 물음.


## 관련노트 {#관련노트}

-   [remember]({{< relref "/notes/20231020T210500.md" >}}) — 이 원문이 목표로 삼은 형태(target shape)가 실제로 쌓이는 다락방 트렁크 기억 저장소.
-   [Elfeed] — 구독 자체의 원본 목록 파일.
-   [@다니엘멘들러 @minad #이맥스 #구루]({{< relref "/bib/20241223T092335.md" >}}) — elfeed의 새 메인테이너, vertico/consult 생태계와 함께 elfeed 개선을 이끌고 있다.
-   [@karthink 이맥스 구루 지피텔 레이텍 아티스트]({{< relref "/bib/20250110T104339.md" >}}) — elfeed summary가 기대는 gptel의 저자.
-   [@힣: §doomemacs-config 간결 실용 심플 텍스트 도구 #닷파일: #이맥스 #스타터키트]({{< relref "/notes/20240915T235008.md" >}}) — `+elfeed--org-safe-summary` 를 포함한 커스텀 elfeed 로직이 실제로 사는 곳.
-   [#하이포테시스: #인터넷 #링크 #인용 #북마크 한 곳에서 #관리]({{< relref "/notes/20240921T234537.md" >}}) — 다른 도구(Hypothesis)로 같은 문제(웹에서 읽은 것을 한 곳에서 주석 달기)를 풀려 했던 이웃 시도.
-   [@힣: 메타 기록을 조테로에 담는 이유 — 제목·저자·요약·단어]({{< relref "/notes/20250409T142940.md" >}}) — 조테로로 메타 서지를 담는 것과 remember로 맥락(annotation)을 담는 것의 역할 분담.
...
## 요약이 org를 해치지 않게 — 코드로 지킨 경계 {#요약이-org를-해치지-않게-코드로-지킨-경계}
...
## remember를 조테로 옆에 놓는 이유 {#remember를-조테로-옆에-놓는-이유}
...
## 이미지 — 얼음 화면에서 호박색 잉크로 {#이미지-얼음-화면에서-호박색-잉크로}
...
## 원문 보존 — 2024-11-04 elfeed-tube 흐름 날것 {#원문-보존-2024-11-04-elfeed-tube-흐름-날것}

> [!danger]
> 
> 굉장히 중요한 시나리오다.
> 
> [#뉴스피드구독]({{< relref "/meta/20230927T120800.md" >}}) - elfeed
> 
> 방법은 간단하다.
> 
...
## 후속 원문 보존 — 2026-08-02 remember annotation 날것 {#후속-원문-보존-2026-08-02-remember-annotation-날것}
