---
title: "family-config: AI 기반 가족 생활 관리 시스템"
description: "family-config를 AI 기반 가족 생활 관리 시스템으로 바라보는 노트이다. 실제 활용 흐름을 담았다."
date: 2025-10-30T01:11:00+09:00
lastmod: 2025-10-30T01:11:00+09:00
tags: ["agent", "family", "mcp"]
draft: false
---
...
-   <span class="timestamp-wrapper"><span class="timestamp">[2026-07-17 Fri 21:58]</span></span> 이 노트는 수선이 필요하겠다. [§butlercli 집사 - 생활 운영 루프 수리 구입 자동차 세차 청소 캘린더 추적]({{< relref "/botlog/20260518T094818.md" >}}) 여기 쪽으로 옮겨야돼


## family-config: AI 기반 가족 생활 관리 시스템 {#family-config-ai-기반-가족-생활-관리-시스템}
...
### 핵심 개념: Actionable Intelligence {#핵심-개념-actionable-intelligence}
...
### 시간과정신의방 (Time and Mind Room) {#시간과정신의방--time-and-mind-room}
...
### Actionable Item 예시 {#actionable-item-예시}
