---
title: "#이맥스 #폰트: 스케일 크기 조절 - 유니코드 이모지"
description: "이맥스에서 폰트 스케일과 유니코드, 이모지 크기를 맞추는 방법을 기록한 노트이다. 실제 활용 흐름을 담았다."
date: 2024-12-26T00:11:00+09:00
lastmod: 2025-05-12T00:00:00+09:00
tags: ["emacs", "fonts", "scale"]
categories: ["Noname"]
draft: false
---
...
-   <span class="timestamp-wrapper"><span class="timestamp">[2025-06-22 Sun 15:51]</span></span> 이 로직 사용하고 있지? 디테일한 방법이야.
-   <span class="timestamp-wrapper"><span class="timestamp">[2024-12-25 Wed 05:56]</span></span> 생성
-   [@힣: 최적 #폰트 탐구 #요구사항 터미널 콜아웃 웹 한글 가변폭 고정폭 유니코드 심볼 합자]({{< relref "/notes/20221004T130700.md" >}})


## 2024 이맥스 폰트 스케일 특히 이모지 유니코드 수학 기호 등 {#2024-이맥스-폰트-스케일-특히-이모지-유니코드-수학-기호-등}
