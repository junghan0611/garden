---
title: "#MS윈도우즈 #이맥스 설치 및 활용"
description: "윈도우 환경에서 이맥스를 설치하고 활용하는 흐름을 자료와 테스트 기록 중심으로 모은 노트."
date: 2023-09-21T15:43:00+09:00
lastmod: 2025-04-13T00:00:00+09:00
tags: ["bib", "emacs", "ews", "howtouse", "install", "mswindows"]
categories: ["Noname"]
draft: false
---
...
<div class="csl-bib-body">
  <div class="csl-entry"><a id="citeproc_bib_item_1"></a><i>Installing Doom Emacs on Windows #Emacs #Doomemacs #Keybinds - Youtube</i>. 2025. <a href="https://www.youtube.com/watch?v=IAZU6sC46YU">https://www.youtube.com/watch?v=IAZU6sC46YU</a>.</div>
  <div class="csl-entry"><a id="citeproc_bib_item_2"></a><i>Properly Installing Emacs on Windows #Emacs #Windows #Coding #Programming</i>. 2025. <a href="https://www.youtube.com/watch?v=9lE45khK3qU">https://www.youtube.com/watch?v=9lE45khK3qU</a>.</div>
</div>

[#MS윈도우즈]({{< relref "/meta/20250107T151412.md" >}})에서 [#이맥스 - #텍스트에디터]({{< relref "/meta/20230521T215600.md" >}})를 사용한다면


## 히스토리 {#히스토리}

-   <span class="timestamp-wrapper"><span class="timestamp">[2025-04-13 Sun 16:25]</span></span> 레퍼런스 추가
-   2023-09-22 테스트 겸 설치
-   2024-06-06 테스트톱에 설치하려고 문서 확인 --&gt; 수정 필요! 완전 쉽고 개선된 방법
-   2025-01-07 파일 나눔


## [스쿱 활용해서 패키지 설치]({{< relref "/notes/20250107T150402.md" >}}) {#스쿱-활용해서-패키지-설치}
...
<span class="timestamp-wrapper"><span class="timestamp">[2025-01-07 Tue 15:25]</span></span> 일부 가져옴직하다.
...
{{< figure src="/images/20230921_161220_screenshot.png" >}}
...
### <span class="org-todo done DONT">DONT</span> Spacemacs Installation Guide {#spacemacs-installation-guide}
...
### Installing Doom Emacs on Windows <span class="org-hashtag">#emacs</span> <span class="org-hashtag">#doomemacs</span> <span class="org-hashtag">#keybinds</span> - YouTube {#installing-doom-emacs-on-windows-emacs-doomemacs-keybinds-youtube}

(<a href="#citeproc_bib_item_1"><i>Installing Doom Emacs on Windows #Emacs #Doomemacs #Keybinds - Youtube</i> 2025</a>) 2025


### Properly Installing Emacs on Windows <span class="org-hashtag">#emacs</span> <span class="org-hashtag">#windows</span> <span class="org-hashtag">#coding</span> <span class="org-hashtag">#programming</span> {#properly-installing-emacs-on-windows-emacs-windows-coding-programming}

(<a href="#citeproc_bib_item_2"><i>Properly Installing Emacs on Windows #Emacs #Windows #Coding #Programming</i> 2025</a>) 2025
