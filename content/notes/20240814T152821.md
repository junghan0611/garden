---
title: "#호스팅 #호스팅케이알 #넷리파이 - 서브도메인"
description: "호스팅케이알과 넷리파이에서 서브도메인을 연결하는 DNS 설정 흐름을 정리한 기록. 실제 활용 흐름을 담았다."
date: 2024-08-14T15:28:00+09:00
lastmod: 2025-03-26T00:00:00+09:00
tags: ["bib", "dns", "hostingkr", "netlify", "notes", "subdomain"]
categories: ["Noname"]
draft: false
---
...
<div class="csl-bib-body">
  <div class="csl-entry"><a id="citeproc_bib_item_1"></a>“Git Hosting.” n.d. Accessed July 2, 2024. <a href="https://depp.brause.cc/">https://depp.brause.cc/</a>.</div>
</div>


## 관련노트 {#관련노트}

-   [notes/ #호스팅: DNS 레코드 - type cname value - 넷리파이 '2025-04-04 #2025-04-04]({{< relref "/notes/20250404T095327.md" >}})
-   [office/ 사내 네트워크 dns 설정 '2025-09-09]


## 히스토리 {#히스토리}

<span class="timestamp-wrapper"><span class="timestamp">[2025-04-04 Fri 09:59]</span></span>

-   <https://junghanacs.com/>
-   <https://notes.junghanacs.com/>


## 2024 뉴 도메인 연결 작업 {#2024-뉴-도메인-연결-작업}


### <span class="org-todo todo TODO">TODO</span> 도메인 / 서브도메인 연결 {#도메인-서브도메인-연결}
...
### github 연동 둘다 배포를 넷리파이로 바꿈. {#github-연동-둘다-배포를-넷리파이로-바꿈-dot}

<span class="timestamp-wrapper"><span class="timestamp">[2024-11-25 Mon 12:46]</span></span>
...
<span class="timestamp-wrapper"><span class="timestamp">[2024-11-25 Mon 12:51]</span></span>
...
### 호스팅케이알 - 타사 서비스 사용 설정 {#호스팅케이알-타사-서비스-사용-설정}

<span class="timestamp-wrapper"><span class="timestamp">[2024-11-25 Mon 12:57]</span></span>


### 동작 확인 잘 된다. {#동작-확인-잘-된다-dot}

<span class="timestamp-wrapper"><span class="timestamp">[2024-11-25 Mon 12:59]</span></span>
...
### <span class="org-todo done DONT">DONT</span> notes -- 호스팅케이알 DNS 서비스를 사용하는 경우 {#notes-호스팅케이알-dns-서비스를-사용하는-경우}


## <span class="org-hashtag">#관련링크</span> {#관련링크}

<span class="timestamp-wrapper"><span class="timestamp">[2024-11-25 Mon 19:46]</span></span>
...
(<a href="#citeproc_bib_item_1">“Git Hosting” n.d.</a>)
