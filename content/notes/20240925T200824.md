---
title: "@힣: 어쏠로지 — 모두가 저자다, 인생은 한 권의 책, 조테로 공유"
description: "모두가 저자이고 인생은 한 권의 책이라는 감각을 모닝페이지·어쏠로지·조테로 공유 그룹으로 풀어낸 2024년 원석. 서지 과정의 존재 선언 이웃."
date: 2024-09-25T20:08:00+09:00
lastmod: 2026-08-04T13:40:00+09:00
tags: ["autholog", "authology", "books", "morningpage", "rawwriting", "writing", "zotero"]
categories: ["Noname"]
draft: false
---
...
> [!abstract] 이 노트에 대하여
> 
> 2024년 9월 25일 새벽에서 축구장까지 이어진 모닝페이지다. 어쏠로지(Authology) — 모두가 저자이고, 인생은 한 권의 책이며, 조테로 공유 그룹에 Book 목록을 열어 둔 이유. 분류·번역자·십진분류가 귀한 정보라는 감각은 이후 [메타 기록을 조테로에 담는 이유]({{< relref "/notes/20250409T142940.md" >}})와 [§zotero-config]({{< relref "/botlog/20260304T105300.md" >}})의 과정 공개로 이어진다. 모가댓·에머슨·개개인성은 같은 새벽의 이웃 단어들이다.


## 히스토리 {#히스토리}

-   <span class="timestamp-wrapper"><span class="timestamp">[2026-08-04 Tue 13:40]</span></span> @mitsein/sonnet5 — 캐머런 bib 노트(20241214T045836)와 상호 링크. 『나를 위해 쓸 권리』 GPT 대화 반영.
-   <span class="timestamp-wrapper"><span class="timestamp">[2026-08-03 Mon 13:21]</span></span> @mitsein/sonnet5 — GLGMAN Universe 이미지 생성. 2024 스크린샷 두 장은 그대로 두고 아래에 세계관 이미지를 더함.
-   <span class="timestamp-wrapper"><span class="timestamp">[2026-08-03 Mon 10:59]</span></span> @mitsein/grok-4.5 — 공유그룹 하우투 흡수 확인. zotero 클러스터 정리와 맞춤.
-   <span class="timestamp-wrapper"><span class="timestamp">[2026-08-03 Mon 11:05]</span></span> @mitsein/grok-4.5 — 공유 그룹 하우투(20250409T144319) 흡수.
-   <span class="timestamp-wrapper"><span class="timestamp">[2026-08-03 Mon 10:55]</span></span> @mitsein/grok-4.5 — 표준 구조 수선. 2024 모닝페이지 본문을 원문 보존으로 두고, 해설·관련메타/ 노트·한 줄을 세움. 서지 autholog·botlog와 연결.
-   <span class="timestamp-wrapper"><span class="timestamp">[2024-09-25 Wed 20:08]</span></span> 모닝페이지 작성 (새벽 키워드 → 축구장에서 마무리).
-   <span class="timestamp-wrapper"><span class="timestamp">[2024-09-25 Wed 19:32]</span></span> “모닝에 끝냈어야 하는데” — 현장 메모.


## 관련메타 {#관련메타}

-   [† #조테로 #서지관리]({{< relref "/meta/20240320T110018.md" >}})
-   [† #어쏠로그]({{< relref "/meta/20241206T090648.md" >}}) — 날것을 가든으로 회수하는 형식의 이웃 이름.
-   [† #저자 #작가 #글쓴이]({{< relref "/meta/20241014T211115.md" >}})
-   [† #존재]({{< relref "/meta/20250424T153114.md" >}})
-   [† #명상 #마음챙김 #알아차림 #자각 #알아봄]({{< relref "/meta/20230817T122900.md" >}})


## 관련노트 {#관련노트}

-   [@줄리아캐머런 #아티스트웨이 #모닝페이지]({{< relref "/bib/20241214T045836.md" >}}) — 캐머런의 '쓸 권리'와 이 노트가 스스로 거리를 두는 지점.
-   [@힣: 메타 기록을 조테로에 담는 이유 — 제목·저자·요약·단어, 그리고 dateAdded]({{< relref "/notes/20250409T142940.md" >}}) — 서지 메타와 시간축의 화두.
-   [§zotero-config: 캡처 금고와 메타 서지의 얇은 손]({{< relref "/botlog/20260304T105300.md" >}}) — 과정 공개의 담당자 얼굴.
-   [#어쏠로지]({{< relref "/meta/20240508T103852.md" >}}) — 독자 생활 청산, 저자로 거듭나라.
-   [조테로 온라인 공유그룹·공유라이브러리]({{< relref "/notes/20250409T144319.md" >}})
-   [#스레드]({{< relref "/meta/20240922T095350.md" >}}) — 원문 링크 자리.
...
Book만 담았다. 무슨 책인지는 별로 중요하지 않다. 분류 체계·번역자·십진분류가 희귀 정보다. 쓰기 위한 서지이며, bib 한 장이 이맥스·옵시디언·로그시크를 가로지른다. 2026년의 과정 공개([dateAdded 성스러움]({{< relref "/notes/20250409T142940.md" >}}), [얇은 손]({{< relref "/botlog/20260304T105300.md" >}}))는 이 새벽 감각의 연장이다.


### 인생은 한 권의 책 {#인생은-한-권의-책}
...
## 이미지 — 2024 모닝 키워드·조테로 삼면 {#이미지-2024-모닝-키워드-조테로-삼면}
...
### GLGMAN Universe — 모두가 저자다 {#glgman-universe-모두가-저자다}
...
## 공유 그룹 실무 (from 20250409T144319) {#공유-그룹-실무--from-20250409t144319}
...
{{< figure src="/images/20250409T144511--screenshot.png" >}}

이 하우투의 존재 이유는 [위 해설](#해설-어쏠로지와-공개-서재)과 같다. 추천 목록이 아니라 분류와 과정이 있는 서재 공개.


## 원문 보존 — 2024-09-25 모닝페이지 날것 {#원문-보존-2024-09-25-모닝페이지-날것}

<span class="timestamp-wrapper"><span class="timestamp">[2024-09-25 Wed 20:36]</span></span> 아래 원문은 날것임

> [!danger]
> 
> [#어쏠로지]({{< relref "/meta/20240508T103852.md" >}}) 독자 생활 청산. 저자로 거듭나라. 인생은 한권의 책. 삶으로 쓰리라. 1권만.
...
### <span class="org-hashtag">#모닝페이지</span> 에 대한 생각 {#모닝페이지-에-대한-생각}
...
### <span class="org-hashtag">#조테로공유그룹</span> 도서 목록 공유한다. {#조테로공유그룹-도서-목록-공유한다-dot}
...
### <span class="org-hashtag">#모두가저자다</span> <span class="org-hashtag">#어쏠로지</span> {#모두가저자다-어쏠로지}
...
### <span class="org-hashtag">#개개인성</span> <span class="org-hashtag">#지식도구</span> <span class="org-hashtag">#인공지능</span> {#개개인성-지식도구-인공지능}

<span class="org-hashtag">#개개인성</span> 에 주목하는 시대가 도래 했다 (<a href="#citeproc_bib_item_3">토드 로즈 2018</a>). 부족한 부분은 지식 도구로 시스템을 갖추고 인공지능 도움을 받으면 된다. 서지 정보도 마찬가지다. 정리하면 된다. 학자만 쓰는 게 아니다. 고요히 생각해보라. 모두가 저자이고 학자이다. 지금 무엇이 필요한가? 그게 없다면 요게 있다. 정말 아무 것도 없는데요?라고 말한다면 지금 누가 그 말을 하고 있는가? 경험하는 그 자신으로 살라.


### <span class="org-hashtag">#정보의통제권</span> 거친 표현이다. {#정보의통제권-거친-표현이다-dot}
...
### <span class="org-hashtag">#인생은한권의책</span> {#인생은한권의책}
...
### <span class="org-hashtag">#모가댓</span> {#모가댓}
...
### <span class="org-hashtag">#진짜</span> 두려운 일은 {#진짜-두려운-일은}
...
### 참고 — Mo Gawdat on AI 2024 {#참고-mo-gawdat-on-ai-2024}

(<a href="#citeproc_bib_item_5"><i>Mo Gawdat on Ai: The Future of Ai and How It Will Shape Our World</i> 2024</a>)
...
<div class="csl-bib-body">
  ...
  <div class="csl-entry"><a id="citeproc_bib_item_5"></a><i>Mo Gawdat on Ai: The Future of Ai and How It Will Shape Our World</i>. 2024. <a href="https://www.youtube.com/watch?v=HhcNrnNJY54">https://www.youtube.com/watch?v=HhcNrnNJY54</a>.</div>
