---
title: "#디노트: 디레드 활용법"
description: "Denote와 Dired를 함께 써서 노트 작업과 가상 디렉토리 흐름을 다루는 방법을 모은 노트."
date: 2023-11-13T16:23:00+09:00
lastmod: 2025-02-24T00:00:00+09:00
tags: ["denote", "dired", "howtouse", "notes", "signature"]
categories: ["Noname"]
draft: false
---
...
## 디노트 디레드 시그니처 {#디노트-디레드-시그니처}

[텍스트 마스터 인덱스 목차]({{< relref "/notes/20240119T030240.md" >}}) 에 반영해야 한다.
...
-   [제텔카스텐 (2021) 숀케 아렌스]({{< relref "/bib/20240516T124151.md" >}}) 의 실습편
...
### <span class="org-todo done DONT">DONT</span> `Signature buffer` via virtual dired {#signature-buffer-via-virtual-dired}
...
## <span class="org-todo done DONE">DONE</span> dired에서 다 할 수 있어. 카테고리 정규식 쿼리 변경 방법 {#dired에서-다-할-수-있어-dot-카테고리-정규식-쿼리-변경-방법}

<span class="timestamp-wrapper"><span class="timestamp">[2025-04-01 Tue 10:10]</span></span>
...
### Query replacing regexp HUGO_CATEGORIES with hugo_categories. {#query-replacing-regexp-hugo-categories-with-hugo-categories-dot}
