---
title: "† #이블 #모달"
description: "이맥스에서 이블과 모달 편집을 중심으로 빔식 조작, 키바인딩, 확장 레이어의 맥락을 엮는다."
date: 2024-09-27T14:33:00+09:00
lastmod: 2025-03-21T00:00:00+09:00
tags: ["bib", "editing", "emacs", "evil", "extensible", "layer", "meta", "modal", "vim"]
categories: ["MetaWord"]
draft: false
---
...
(<a href="#citeproc_bib_item_1">“Emacs-Evil/Evil” 2025</a>) The extensible vi layer for Emacs.
...
<div class="csl-bib-body">
  <div class="csl-entry"><a id="citeproc_bib_item_1"></a>“Emacs-Evil/Evil.” 2025. <a href="https://github.com/emacs-evil/evil">https://github.com/emacs-evil/evil</a>.</div>
</div>
...
## 핵심교본 [#둠이맥스: #이블 #편집 #튜토리얼]({{< relref "/notes/20240131T152328.md" >}}) {#핵심교본-둠이맥스-이블-편집-튜토리얼}

바꾸지 말고 기본 설정으로 커버하면 좋다.


## '\*' '#' <span class="org-hashtag">#심볼</span> Symbol Transient State {#심볼-symbol-transient-state}
...
## [SpaceVim 설치하며 -- VSpaceCode and Spacemacs 비교]({{< relref "/notes/20250321T064938.md" >}}) {#spacevim-설치하며-vspacecode-and-spacemacs-비교}
...
## <span class="timestamp-wrapper"><span class="timestamp">[2023-12-14 Thu 09:32]</span></span> vip vis 등 모르는 세계가 있음을 알다. {#vip-vis-등-모르는-세계가-있음을-알다-dot}
