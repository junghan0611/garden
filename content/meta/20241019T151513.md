...
### <span class="org-todo todo TODO">TODO</span> GPTEL with Upstage {#gptel-with-upstage}
...
### [이광근 (2016) SICP: 컴퓨터 프로그램의 구조와 해석 : 마법사::솔라 번역 결과]({{< relref "/meta/20230909T005700.md" >}}) {#이광근--2016--sicp-컴퓨터-프로그램의-구조와-해석-마법사-솔라-번역-결과--relref-meta-20230909t005700-dot-md}


## Related-Notes {#related-notes}

-   [#국산]({{< relref "/meta/20241019T164859.md" >}})
